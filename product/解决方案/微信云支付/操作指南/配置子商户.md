## 添加子商户
- 服务商需先在[**微信支付商户平台**](http://pay.weixin.qq.com)，完成微信支付子商户申请，然后在[**云支付**](http://console.tcecqpoc.fsphere.cn/cpay)添加微信支付子商户
...
| 参数类型 | 参数说明 | 查看 |
|---------|---------|---------|
| 子商户商户号 | 微信支付商户平台上的微信支付商户号，子商户在申请微信支付后，由微信支付分配的商户收款账号。 | [**查看**](http://pay.weixin.qq.com/index.php/core/account/info) |
