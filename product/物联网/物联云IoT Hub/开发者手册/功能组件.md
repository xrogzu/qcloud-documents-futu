...
![img](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/a853b52c3dd9f2bbedef3023e81f3fa2/3-2.png)

一个云平台账号下，最多可以创建 2000 个产品，每个产品下最多创建 200000 个设备。一个设备只能隶属于一个产品。产品名和设备名在同一云账号下唯一。
...
![img](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/24e01a9e0f2c534dcacec016c4bf2b13/3-3.png)
...
![img](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/7bf7a659ce098b28a700037ff09e123d/3-4.png)![img](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/d895eaad6f25bf78c8ac2bb2ae8d81d7/3-5.png)
...
- **设备与云服务互通**
  对于用户需要对设备数据进行进一步处理的场景（如持久化存储、大数据分析），云平台一方面提供相应的产品（如云数据库、大数据分析套件），另外也即将支持物联网通信平台和这些云产品之间的直接打通。
...
具体请进入 [控制台](http://console.tcecqpoc.fsphere.cn/iotcloud) 体验，或者参考 [控制台使用手册](/document/product/634/11916)。
...
| 类别     | 列表                                       |
| ------ | ---------------------------------------- |
| 产品相关   | [CreateProduct](http://tcecqpoc.fsphere.cn/document/product/634/12051)、[ListProducts](http://tcecqpoc.fsphere.cn/document/product/634/12054)、[DeleteProduct](http://tcecqpoc.fsphere.cn/document/product/634/14068)     |
| 设备相关   | [CreateDevice](http://tcecqpoc.fsphere.cn/document/product/634/12050)、[ListDevices](http://tcecqpoc.fsphere.cn/document/product/634/12053)、[CreateMultiDevice](http://tcecqpoc.fsphere.cn/document/product/634/12276)、[DeleteDevice](http://tcecqpoc.fsphere.cn/document/product/634/12277) 、[GetCreateMultiDevTask](http://tcecqpoc.fsphere.cn/document/product/634/14069) 、[GetMultiDevices](http://tcecqpoc.fsphere.cn/document/product/634/14070)    |
| 设备影子相关 | [UpdateDeviceShadow](http://tcecqpoc.fsphere.cn/document/product/634/12055)、[GetDeviceShadow](http://tcecqpoc.fsphere.cn/document/product/634/12052)|
| 发布消息相关 | [Publish](http://tcecqpoc.fsphere.cn/document/product/634/12278)|

基于 Python 的云 API 的例子参见 [这里](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/archive/c6b492abe009de1c47b91b8bfd93c7d2/iotcloud_RestAPI_python.zip)。
...
物联网通信平台支持通过 [CAM](http://tcecqpoc.fsphere.cn/product/cam) 安全地访问、使用和管理云账号的资源。通过对子账号与协作者的身份管理和策略管理，来实现物联网通信资源的隔离与协作。
