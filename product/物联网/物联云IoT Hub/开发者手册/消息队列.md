...
**CMQ** <br>
CMQ 目前支持队列模型，队列模型拉取消息的相关接口和说明请见 CMQ 文档 [http://tcecqpoc.fsphere.cn/document/api/406/5839](http://tcecqpoc.fsphere.cn/document/api/406/5839 "CMQ 消息相关接口")

**CKafka**   
CKafka 拉取消息的相关接口请见 CKafka 使用文档 [http://tcecqpoc.fsphere.cn/document/product/597/10112](http://tcecqpoc.fsphere.cn/document/product/597/10112 "CKafka使用入门")
