...
### 1.4 发布目标温度配置
调用 restAPI 接口 [UpdateDeviceShadow](http://tcecqpoc.fsphere.cn/document/product/634/12055) 模拟家电管理后台发布目标温度配置，
...
### 2.4 查询获取设备信息
调用 restAPI 接口 [GetDeviceShadow](http://tcecqpoc.fsphere.cn/document/product/634/12052) 可获取到 shadow 的状态数据，用于 app 展示设备能耗状态，
