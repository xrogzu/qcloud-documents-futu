...
![](http://imgcache.tce.fsphere.cn/static/mc.qcloudimg.com/static/img/62bb50fc5fa0f490be49b918cccd261e/image.png)
**对比不同属性人群的用户行为**
通过用户属性设定不同的用户群，对比他们完成的效果，如设定参照组 1 和 2，两组人群使用不同的下单流程，再对比最终单击下单的次数、用户数区别。
![](http://imgcache.tce.fsphere.cn/static/mc.qcloudimg.com/static/img/f13b7cf19b89de685fef8e00daeb91e4/image.png)