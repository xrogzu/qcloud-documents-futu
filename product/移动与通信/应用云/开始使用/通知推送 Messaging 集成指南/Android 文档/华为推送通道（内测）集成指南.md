...
![获取华为密钥](http://imgcache.tce.fsphere.cn/image/docs.developer.qq.com/xg/assets/huaweikey.jpeg)
## 1.2. 配置SHA256证书指纹

[配置示例]
![配置示例](http://imgcache.tce.fsphere.cn/image/docs.developer.qq.com/xg/assets/huaweisha.jpg)
