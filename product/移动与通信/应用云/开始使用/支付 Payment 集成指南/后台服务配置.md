...
**地址**：``` http://api.openmidas.com/v1/r/$appid$/unified_order ```
...
```
POST http://api.openmidas.com/v1/r/TC100008/unified_order?amount=1&channel=wechat&currency_type=CNY&original_amount=1&out_trade_no=open_1519638186904&product_detail=你懂得&product_id=product_test&product_name=金元宝&sign=ZyF0PZ0IzuyZtND6QPD78Cb59qEHd/VCugJ90ID8S+p9umy6M/6wbLDbhIEV+xwQEqGjMomHa/L+AgNtfT5xLQ==&ts=1519609386&user_id=rickenwang HTTP/1.1
User-Agent: Fiddler
...
**地址**：http://api.openmidas.com/v1/r/$appid$/query_order
...
**地址**：http://api.openmidas.com/v1/r/$appid$/close_order
...
**地址**：http://api.openmidas.com/v1/r/$appid$/refund
...
**地址**：http://api.openmidas.com/v1/r/$appid$/query_refund
