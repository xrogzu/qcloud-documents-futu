登录云平台 [短信 SMS 控制台](http://console.tcecqpoc.fsphere.cn/sms)，单击应用名称，进入应用管理页面，单击【统计分析】，单击您需要查看的短信类目，如国内文本短信，可以看到云平台短信服务提供了数据总览、短信记录、模版查询、失败分析和回执分析的功能。另外，海外文本短信的统计分析中还给出了国家（地区）统计。详细说明如下：
