...
此功能需要联系 [sms helper](http://tcecqpoc.fsphere.cn/document/product/382/3773) 开通。
...
| type | 是   | number | 拉取类型，Enum{0: [短信下发状态](http://tcecqpoc.fsphere.cn/document/product/382/5807), 1: [短信回复](http://tcecqpoc.fsphere.cn/document/product/382/5809)}                       |
**注**：
