...
2. [sendisms](http://tce.fsphere.cn/document/product/382/8716) 接口，"tel" 字段为国际电话号码通用格式，如："+8613788888888"
3. 第一个申请的国内短信签名会作为默认签名，如果有已经申请通过的签名，当实际发送的签名没有申请或者申请未审批时会被替换为副签，若需要返回签名错误（1012）请联系 [qcloudsms helper](http://tce.fsphere.cn/document/product/382/3773)。
