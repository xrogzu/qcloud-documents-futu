## 接口描述
### 功能描述
短信下发给用户后，云平台短信服务可以通过回调业务 url 的方式，通知业务方短信下发的状态。
...
| errmsg            | 是   | string | 用户接收短信状态码错误信息，参考 [状态回执错误码](http://tcecqpoc.fsphere.cn/document/product/382/3771#2-.E7.8A.B6.E6.80.81.E5.9B.9E.E6.89.A7.E9.94.99.E8.AF.AF.E7.A0.81)  |
