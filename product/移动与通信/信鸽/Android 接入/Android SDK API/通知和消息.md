...
同时，XGPushBaseReceiver 还提供其它相关的接口，如通知被展示、被点击的结果反馈、注册/反注册结果反馈等，请参考 “[XGPushBaseReceiver](http://tcecqpoc.fsphere.cn/document/product/548/13950#xgpushbasereceiver-.E5.B9.BF.E6.92.AD.E7.B1.BB)” 章节或 demo 中的 MessageReceiver 类。
