...
## 获取小米推送秘钥
根据 [小米开放平台](http://dev.mi.com/console/appservice/push.html) 指引开通小米开发者账号，然后注册应用并获取小米推送的秘钥。将获取的小米推送密钥和您信鸽的 access id 通过邮件 dtsupport@tencent.com 发送给我们，或者添加 QQ：2631775454 。目前需要信鸽的后台手动将信鸽的 access ID 和小米的推送密钥进行绑定。

**认证小米开发者：**
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/0dad64af035fb3cce34c5e6ea64cbedf/image.jpg)
**获取小米推送密钥：**
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/228ad72acdf1c1be765077df231080ab/image.jpg)
