...
为了帮助您快速上手使用物联云Hub API,这里给出[IoTConsole工具](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/archive/e5f12635efac664beac5b2461e940d97/IoTConsole_API-1.0.0.zip)，并提供使用示例。
...
## 5.错误码
### 1）公共错误码
详见云平台API[公共错误码](http://tcecqpoc.fsphere.cn/document/product/213/6982)。
