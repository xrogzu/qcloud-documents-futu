...
![](http://imgcache.tcecqpoc.fsphere.cn/image/mccdn.qcloud.com/static/img/09cf6994a8f5522f79a43ac46e1086d7/image.png)
#### 4.1.2 已设置账号昵称
如果账号设置昵称，单聊消息展示格式为“昵称：推送文本内容”，群组消息展示格式为昵称(群名称)：推送文本内容。
![](http://imgcache.tcecqpoc.fsphere.cn/image/mccdn.qcloud.com/static/img/c739cd153546cf62dc82d877becda9ae/image.png)
...
```
![](http://imgcache.tcecqpoc.fsphere.cn/image/mccdn.qcloud.com/static/img/4cef00f3e38038e32f5e1529a1b8b018/image.png)
...
Apple Push Notification Service(APNS)[苹果推送开发文档](http://developer.apple.com/library/ios/documentation/NetworkingInternet/Conceptual/RemoteNotificationsPG/Chapters/Introduction.html#//apple_ref/doc/uid/TP40008194-CH1-SW1)。
