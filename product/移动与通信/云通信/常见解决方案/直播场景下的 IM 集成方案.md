...
![](http://imgcache.tcecqpoc.fsphere.cn/image/mccdn.qcloud.com/static/img/9de5ecdca24d44477b0e925156cc3588/image.png)
...
云通信直播聊天室的相关 Demo 在应用商店上架名为“随心播”，该 App 是基于云通信以及云平台另一款产品“[互动直播](http://tcecqpoc.fsphere.cn/product/ilvb.html)”开发而成。点击下载 [ Android 版 Demo（应用宝）](http://sj.qq.com/myapp/detail.htm?apkName=com.tencent.qcloud.suixinbo)，或者扫描以下二维码。
...
为了确保 H5 Demo 的简洁，我们仅在 Demo 中集成了 IM 相关功能，并未包含视频功能。点击体验 [ H5 Demo](http://imgcache.tcecqpoc.fsphere.cn/image/avc.qcloud.com/demo/webim/biggroup/mobile/index.html)，或者扫描以下二维码。
...
云通信后台会对用户进出聊天室的消息进行频率控制，详细请参阅 [消息优先级与频率控制](http://tcecqpoc.fsphere.cn/doc/product/269/%E7%BE%A4%E7%BB%84%E6%B6%88%E6%81%AF%E7%BB%BC%E8%BF%B0#7.5-.E6.B6.88.E6.81.AF.E4.BC.98.E5.85.88.E7.BA.A7.E4.B8.8E.E9.A2.91.E7.8E.87.E6.8E.A7.E5.88.B6)。
...
### 获取观看直播的人数
AVChatRoom 的人数统计并不是实时的，有 1 分钟左右的时延。App 管理后台通过 REST API 接口获取当前群人数，详细请参阅 [获取群组资料](http://tcecqpoc.fsphere.cn/doc/product/269/1616)（回包中的 `MemberNum` 字段）。
...
通过 REST API 发送自定义消息，详细请参阅 [REST API：在群组中发送普通消息](/doc/product/269/在群组中发送普通消息#2.7-.E8.AF.B7.E6.B1.82.E5.8C.85.E7.A4.BA.E4.BE.8B)。

>**注意：**
>- 如果需要使用云通信的脏字过滤功能，请注意自定义消息的结构设计，详细请参阅 [敏感词（脏字）过滤](/doc/product/269/4104#5.7-.E6.95.8F.E6.84.9F.E8.AF.8D.EF.BC.88.E8.84.8F.E5.AD.97.EF.BC.89.E8.BF.87.E6.BB.A4)。
...
基于上述考虑，云通信会对单个 AVChatRoom 中的消息进行频率控制。详细请参阅 [消息优先级与频率控制](/doc/product/269/群组消息综述#7.5-.E6.B6.88.E6.81.AF.E4.BC.98.E5.85.88.E7.BA.A7.E4.B8.8E.E9.A2.91.E7.8E.87.E6.8E.A7.E5.88.B6)。
...
* [Android 对群成员进行禁言](/doc/product/269/群组管理（Android%20SDK）#5.8-.E5.AF.B9.E7.BE.A4.E6.88.90.E5.91.98.E8.BF.9B.E8.A1.8C.E7.A6.81.E8.A8.80)
...
除此之外，使用独立模式的 App 还可以在通过 REST API 导入账号的同时设置用户资料，详细请参阅 [REST API：独立模式账号同步](/doc/product/269/独立模式账号同步接口)。

### 客户端压力测试
如果要对客户端在 AVChatRoom 下的消息收发性能进行测试，详细请参阅 [压测工具](/doc/product/269/4287#3-.E7.BE.A4.E5.86.85.E5.8F.91.E9.80.81.E6.B6.88.E6.81.AF.E5.8E.8B.E5.8A.9B.E6.B5.8B.E8.AF.95.E8.84.9A.E6.9C.AC.E4.BD.BF.E7.94.A8.E8.AF.B4.E6.98.8E)。
...
>- WEB SDK 需使用 [直播聊天室](http://tcecqpoc.fsphere.cn/doc/product/269/4105) 专用接口，[通用](http://tcecqpoc.fsphere.cn/doc/product/269/4196) 接口无法支持 AVChatRoom。
