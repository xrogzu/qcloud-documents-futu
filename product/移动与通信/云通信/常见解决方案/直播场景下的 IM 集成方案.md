...
云通信直播聊天室的相关 Demo 在应用商店上架名为“随心播”，该 App 是基于云通信以及云平台另一款产品“[互动直播](/product/ilvb.html)”开发而成。点击下载 [ Android 版 Demo（应用宝）](http://sj.qq.com/myapp/detail.htm?apkName=com.tencent.qcloud.suixinbo)，或者扫描以下二维码。
...
云通信后台会对用户进出聊天室的消息进行频率控制，详细请参阅 [消息优先级与频率控制](/doc/product/269/%E7%BE%A4%E7%BB%84%E6%B6%88%E6%81%AF%E7%BB%BC%E8%BF%B0#7.5-.E6.B6.88.E6.81.AF.E4.BC.98.E5.85.88.E7.BA.A7.E4.B8.8E.E9.A2.91.E7.8E.87.E6.8E.A7.E5.88.B6)。
...
### 获取观看直播的人数
AVChatRoom 的人数统计并不是实时的，有 1 分钟左右的时延。App 管理后台通过 REST API 接口获取当前群人数，详细请参阅 [获取群组资料](/doc/product/269/1616)（回包中的 `MemberNum` 字段）。
...
>- WEB SDK 需使用 [直播聊天室](/doc/product/269/4105) 专用接口，[通用](/doc/product/269/4196) 接口无法支持 AVChatRoom。
