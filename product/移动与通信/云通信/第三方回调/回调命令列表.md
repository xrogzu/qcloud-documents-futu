...
<table style="width:100%;" >
		<tbody>
			...
			<tr>
				<td> 添加好友之前回调 </td>
				<td> 
					<a href="/document/product/269/11748">Sns.CallbackPrevFriendAdd</a>
				</td>
			</tr>
			<tr>
				<td> 添加好友之后回调 </td>
				<td> 
					<a href="/document/product/269/1657">Sns.CallbackFriendAdd</a>
				</td>
			</tr>
			<tr>
				<td> 添加好友回应之前回调 </td>
				<td> 
					<a href="/document/product/269/11747">Sns.CallbackPrevFriendResponse</a>
				</td>
			</tr>
			<tr>
				<td> 删除好友之后回调 </td>
				<td> 
					<a href="/document/product/269/1659">Sns.CallbackFriendDelete</a>
				</td>
			</tr>
			<tr>
				<td> 添加黑名单之后回调 </td>
				<td> 
					<a href="/document/product/269/1660">Sns.CallbackBlackListAdd</a>
				</td>
			</tr>
			<tr>
				<td> 删除黑名单之后回调 </td>
				<td> 
					<a href="/document/product/269/1661">Sns.CallbackBlackListDelete</a>
				</td>
			</tr>
		</tbody>
	</table>
