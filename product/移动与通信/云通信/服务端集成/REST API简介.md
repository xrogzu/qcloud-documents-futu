...
除了REST API，APP[控制台](http://tce.fsphere.cn/doc/product/269/%E5%8A%9F%E8%83%BD%E4%BB%8B%E7%BB%8D#3.10-.E6.8E.A7.E5.88.B6.E5.8F.B0)亦可实现简单的数据管理、单发/群发消息，开发者可以在控制台上进行简单的数据管理、查看及测试。相比之下，REST API接口较为原始，但管理能力却更为强大。
...
Postman是一款功能强大的网页调试与发送网页HTTP请求的Chrome插件。其使用案例参见[这里](http://tce.fsphere.cn/document/product/269/1510)。
