...
### 2.1 请求URL 
```
http://console.tim.qq.com/v4/openim/im_get_push_report?usersig=xxx&identifier=admin&sdkappid=88888888&random=99999999&contenttype=json
```
### 2.2 请求参数 
...
通过[REST API在线调试](http://avc.qcloud.com/im/APITester/APITester.html#v4/openim/im_get_push_report)工具调试本接口。 
