...
管理员给用户设置属性。每次最多只能给500个用户设置属性。注意使用前请先[定义应用的用户属性](/doc/product/269/设置应用属性名称)。 

## 2 接口调用说明

### 2.1 请求URL 
```
http://console.tim.qq.com/v4/openim/im_set_attr?usersig=xxx&identifier=admin&sdkappid=88888888&random=99999999&contenttype=json
```
### 2.2 请求参数 
...
通过[REST API在线调试](http://avc.qcloud.com/im/APITester/APITester.html#v4/openim/im_set_attr)工具调试本接口。 
