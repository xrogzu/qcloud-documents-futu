...
| 91000 |服务内部错误，请重试。| 
| 90992 |服务内部错误，请重试；如果所有请求都返回该错误码，且APP配置了[第三方回调](http://tcecqpoc.fsphere.cn/document/product/269/1522)，请检查APP服务器是否正常向云平台后台服务器返回回调结果。| 
| 20002 |签名验证失败。| 
...
通过[REST API在线调试工具](https://avc.tce.fsphere.cn/im/APITester/APITester.html#v4/openim/sendmsg)调试本接口。 
