...
### 2.2 请求URL 
```
http://console.tim.qq.com/v4/group_open_http_svc/import_group?usersig=xxx&identifier=admin&sdkappid=88888888&random=99999999&contenttype=json 
```
### 2.3 请求参数 
...
通过[REST API在线调试工具](http://avc.tce.fsphere.cn/im/APITester/APITester.html#v4/group_open_http_svc/import_group_info)调试本接口。 
...
REST API：设置成员未读计数（[v4/group_open_http_svc/set_unread_msg_num](http://tcecqpoc.fsphere.cn/doc/product/269/%E8%AE%BE%E7%BD%AE%E6%88%90%E5%91%98%E6%9C%AA%E8%AF%BB%E6%B6%88%E6%81%AF%E8%AE%A1%E6%95%B0)）。 
