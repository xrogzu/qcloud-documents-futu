...
### 2.2 请求URL 
```
http://console.tim.qq.com/v4/group_open_http_svc/delete_group_member?usersig=xxx&identifier=admin&sdkappid=88888888&random=99999999&contenttype=json
```
### 2.3 请求参数 
...
通过[REST API在线调试工具](http://avc.tce.fsphere.cn/im/APITester/APITester.html#v4/group_open_http_svc/delete_group_member)调试本接口。 
