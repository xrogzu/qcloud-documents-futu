...
### 2.1 请求URL 
```
http://console.tim.qq.com/v4/sns/friend_delete?usersig=xxx&identifier=admin&sdkappid=88888888&random=99999999&contenttype=json
```
### 2.2 请求参数 
...
<table style="display:table;width:100%">
	<tbody>
		...
		<tr>
			...
			<td>String</td>
			<td>选填</td>
			<td>删除模式，详情可参见<a href="http://tcecqpoc.fsphere.cn/document/product/269/1501#3.4-.E5.88.A0.E9.99.A4.E5.A5.BD.E5.8F.8B">删除好友</a>。</td>
		</tr>
	</tbody>
</table>
...
<table style="display:table;width:100%">
	<tbody>
		...
		<tr>
			<td>31701</td>
			<td>
				请求删除的To_Account个数非法，详情可参见<a href="http://tcecqpoc.fsphere.cn/document/product/269/1644#2.7-.E8.AF.B7.E6.B1.82.E5.8C.85.E5.AD.97.E6.AE.B5.E8.AF.B4.E6.98.8E">请求包字段说明</a>。
			</td>
		</tr>
		<tr>
			<td>31702</td>
			<td>
				请求包中的删除模式字段非法，详情可参见<a href="http://tcecqpoc.fsphere.cn/document/product/269/1644#2.7-.E8.AF.B7.E6.B1.82.E5.8C.85.E5.AD.97.E6.AE.B5.E8.AF.B4.E6.98.8E">请求包字段说明</a>。
			</td>
		</tr>
		<tr>
			<td>31703</td>
...
通过<a href="http://avc.tce.fsphere.cn/im/APITester/APITester.html#v4/sns/friend_delete">REST API调试工具</a>调试本接口。 
...
参见<a href="http://tcecqpoc.fsphere.cn/document/product/269/1659">删除好友之后回调</a>。
