...
### 2.1 请求URL 
```
http://console.tim.qq.com/v4/sns/black_list_add?usersig=xxx&identifier=admin&sdkappid=88888888&random=99999999&contenttype=json
```
### 2.2 请求参数 
...
<table style="display:table;width:100%">
	<tbody>
		...
		<tr>
			<td>31301</td>
			<td>
				请求添加为黑名单的To_Account个数非法，详情可参见<a href="http://tcecqpoc.fsphere.cn/document/product/269/3718#2.7-.E8.AF.B7.E6.B1.82.E5.8C.85.E5.AD.97.E6.AE.B5.E8.AF.B4.E6.98.8E">请求包字段说明</a>。
			</td>
		</tr>
		<tr>
			<td>31302</td>
...
通过<a href="http://avc.tce.fsphere.cn/im/APITester/APITester.html#v4/sns/black_list_add">REST API调试工具</a>调试本接口。 

## 4 可能触发的回调 

参见<a href="http://tcecqpoc.fsphere.cn/document/product/269/1660">添加黑名单之后回调</a>。
...
REST API：<a href="http://tcecqpoc.fsphere.cn/document/product/269/3725">校验黑名单</a> 