...
<table style="display:table;width:100%">
	<tbody>
		...
		<tr>
			<td>30801</td>
			<td>
				请求包参数错误，请检查请求包的合法性，详情可参见<a href="http://tce.fsphere.cn/document/product/269/1501#3.1-.E6.A0.87.E9.85.8D.E5.A5.BD.E5.8F.8B.E5.AD.97.E6.AE.B5">标配好友字段</a>。</td>
		</tr>
		<tr>
			<td>30802</td>
...
通过<a href="https://avc.tce.fsphere.cn/im/APITester/APITester.html#v4/sns/friend_import">REST API调试工具</a>调试本接口。 
