...
### 2.1 请求URL 
```
http://console.tim.qq.com/v4/sns/friend_delete_all?usersig=xxx&identifier=admin&sdkappid=88888888&random=99999999&contenttype=json
```
### 2.2 请求参数 
...
通过<a href="http://avc.tce.fsphere.cn/im/APITester/APITester.html#v4/sns/friend_delete_all">REST API调试工具</a>调试本接口。 
