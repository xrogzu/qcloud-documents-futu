...
```
http://console.tim.qq.com/v4/im_open_login_svc/kick?usersig=xxx&identifier=admin&sdkappid=88888888&random=99999999&contenttype=json
```
...
通过[REST API在线调试](http://avc.qcloud.com/im/APITester/APITester.html#v4/im_open_login_svc/kick)工具调试本接口。
