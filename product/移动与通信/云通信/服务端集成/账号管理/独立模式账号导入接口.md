...
本接口适用于将应用自有帐号信息导入云平台。该接口的功能是在腾讯内部创建一个内部ID，使没有登录云平台的应用自有帐号能够使用云平台服务。
...
```
http://console.tim.qq.com/v4/im_open_login_svc/account_import?usersig=xxx&identifier=admin&sdkappid=88888888&random=99999999&contenttype=json
```
...
通过[REST API在线调试](http://avc.qcloud.com/im/APITester/APITester.html#v4/im_open_login_svc/account_import)工具调试本接口。
