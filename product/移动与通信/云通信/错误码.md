...
<table style="display:table;width:100%">
		<tbody>
			...
			<tr>
				...
				<td>
					服务端集成Rest API接口必须使用管理员才能成功发起请求，配置管理员可参见<a href="http://tcecqpoc.fsphere.cn/doc/product/269/%E8%AE%BE%E7%BD%AEAPP%E7%AE%A1%E7%90%86%E5%91%98">设置APP管理员</a>。<br />
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				...
				<td>
					服务内部错误，请重试；如果所有请求都返回该错误码，且APP配置了<a href="http://tcecqpoc.fsphere.cn/doc/product/269/%E7%AC%AC%E4%B8%89%E6%96%B9%E5%9B%9E%E8%B0%83%E7%AE%80%E4%BB%8B">第三方回调</a>，请检查APP服务器是否正常向云平台后台服务器返回回调结果。<br />
				</td>
			</tr>
			<tr>
                <td>
...
<table style="display:table;width:100%">
		<tbody>
			...
			<tr>
				<td>40601</td>
				<td>
					string/bytes类型的资料字段的长度超门限，详情可参见<a href="http://tcecqpoc.fsphere.cn/doc/product/269/%E8%B5%84%E6%96%99%E7%B3%BB%E7%BB%9F#2-.E8.B5.84.E6.96.99.E5.AD.97.E6.AE.B5">资料字段</a>。<br />
				</td>
			</tr>
			<tr>
				<td>40602</td>
			...
			<tr>
				<td>40605</td>
				<td>
					标配资料字段的值非法，标配资料字段的合理取值范围可参见：<a href="http://tcecqpoc.fsphere.cn/doc/product/269/1500#3-.E6.A0.87.E9.85.8D.E8.B5.84.E6.96.99.E5.AD.97.E6.AE.B5">标配资料字段</a>。<br />
				</td>
			</tr>
			<tr>
				<td>40606</td>
...
<table style="display:table;width:100%">
		<tbody>
			...
			<tr>
				...
				<td>
					分组个数达到系统上限，详情可参见<a href="http://tcecqpoc.fsphere.cn/document/product/269/1501#3.1-.E6.A0.87.E9.85.8D.E5.A5.BD.E5.8F.8B.E5.AD.97.E6.AE.B5">标配好友字段</a>，调用方可以捕捉该错误给用户一个合理的提示。<br />
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				...
				<td>
					加好友回应参数长度错误，详情可参见<a href="http://tcecqpoc.fsphere.cn/document/product/269/1501#3.1-.E6.A0.87.E9.85.8D.E5.A5.BD.E5.8F.8B.E5.AD.97.E6.AE.B5">标配好友字段</a>，可能的错误有：<br />
					1、好友备注的长度非法；<br />
					2、分组名称的长度非法。<br />
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					加好友回应From_Account的分组个数已达系统上限，详情可参见<a href="http://tcecqpoc.fsphere.cn/document/product/269/1501#3.1-.E6.A0.87.E9.85.8D.E5.A5.BD.E5.8F.8B.E5.AD.97.E6.AE.B5">标配好友字段</a>，调用方可以捕捉该错误给用户一个合理的提示。<br />
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				...
				<td>
					好友数据更新分组个数已达系统上限，详情可参见<a href="http://tcecqpoc.fsphere.cn/document/product/269/1501#3.1-.E6.A0.87.E9.85.8D.E5.A5.BD.E5.8F.8B.E5.AD.97.E6.AE.B5">标配好友字段</a>，调用方可以捕捉该错误给用户一个合理的提示。<br />
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					好友导入参数错误，详情可参见<a href="http://tcecqpoc.fsphere.cn/document/product/269/1501#3.1-.E6.A0.87.E9.85.8D.E5.A5.BD.E5.8F.8B.E5.AD.97.E6.AE.B5">标配好友字段</a>及<a href="http://tcecqpoc.fsphere.cn/document/product/269/1501#3.2-.E8.87.AA.E5.AE.9A.E4.B9.89.E5.A5.BD.E5.8F.8B.E5.AD.97.E6.AE.B5">自定义好友字段</a>，可能的错误有：<br />
					1、好友备注的长度非法；<br />
					2、分组名称的长度非法；<br />
					3、加好友附言的长度非法；<br />
					4、加好友来源字符串非法；<br />
			...
			<tr>
				...
				<td>
					好友导入分组个数已达系统上限，详情可参见<a href="http://tcecqpoc.fsphere.cn/document/product/269/1501#3.1-.E6.A0.87.E9.85.8D.E5.A5.BD.E5.8F.8B.E5.AD.97.E6.AE.B5">标配好友字段</a>，调用方可以捕捉该错误给用户一个合理的提示。<br />
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				...
				<td>
					请求添加的分组名长度非法，详情可参见<a href="http://tcecqpoc.fsphere.cn/document/product/269/1501#3.1-.E6.A0.87.E9.85.8D.E5.A5.BD.E5.8F.8B.E5.AD.97.E6.AE.B5">标配好友字段</a>。<br />
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				...
				<td>
					分组ID非法，详情可参见<a href="http://tcecqpoc.fsphere.cn/document/product/269/1501#3.1-.E6.A0.87.E9.85.8D.E5.A5.BD.E5.8F.8B.E5.AD.97.E6.AE.B5">标配好友字段</a>。<br />
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					分组个数已达系统上限，详情可参见<a href="http://tcecqpoc.fsphere.cn/document/product/269/1501#3.1-.E6.A0.87.E9.85.8D.E5.A5.BD.E5.8F.8B.E5.AD.97.E6.AE.B5">标配好友字段</a>。<br />
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				...
				<td>
					请求更新的分组名长度非法，详情可参见<a href="http://tcecqpoc.fsphere.cn/document/product/269/1501#3.1-.E6.A0.87.E9.85.8D.E5.A5.BD.E5.8F.8B.E5.AD.97.E6.AE.B5">标配好友字段</a>。<br />
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					新分组名的长度非法，详情可参见<a href="http://tcecqpoc.fsphere.cn/document/product/269/1501#3.1-.E6.A0.87.E9.85.8D.E5.A5.BD.E5.8F.8B.E5.AD.97.E6.AE.B5">标配好友字段</a>。<br />
				</td>
			</tr>
			<tr>
				<td>
