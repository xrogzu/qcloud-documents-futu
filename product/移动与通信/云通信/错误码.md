...
<table style="display:table;width:100%">
		<tbody>
			...
			<tr>
				...
				<td>
					服务端集成Rest API接口必须使用管理员才能成功发起请求，配置管理员可参见<a href="http://tce.fsphere.cn/doc/product/269/%E8%AE%BE%E7%BD%AEAPP%E7%AE%A1%E7%90%86%E5%91%98">设置APP管理员</a>。<br />
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				...
				<td>
					服务内部错误，请重试；如果所有请求都返回该错误码，且APP配置了<a href="http://tce.fsphere.cn/doc/product/269/%E7%AC%AC%E4%B8%89%E6%96%B9%E5%9B%9E%E8%B0%83%E7%AE%80%E4%BB%8B">第三方回调</a>，请检查APP服务器是否正常向云平台后台服务器返回回调结果。<br />
				</td>
			</tr>
			<tr>
                <td>
		...
		<tbody>
			...
			<tr>
				...
				<td>
					...
					1、标配资料字段的Tag可参见：<a href="http://tce.fsphere.cn/doc/product/269/1500#3-.E6.A0.87.E9.85.8D.E8.B5.84.E6.96.99.E5.AD.97.E6.AE.B5">标配资料字段</a>；<br />
					2、自定义资料字段的申请可参见：<a href="http://tce.fsphere.cn/document/product/269/1500#.E8.87.AA.E5.AE.9A.E4.B9.89.E8.B5.84.E6.96.99.E5.AD.97.E6.AE.B5.E7.9A.84.E7.94.B3.E8.AF.B7">自定义资料字段的申请</a>；<br />
			...
			<tr>
				<td>40601</td>
				<td>
					string/bytes类型的资料字段的长度超门限，详情可参见<a href="http://tce.fsphere.cn/doc/product/269/%E8%B5%84%E6%96%99%E7%B3%BB%E7%BB%9F#2-.E8.B5.84.E6.96.99.E5.AD.97.E6.AE.B5">资料字段</a>。<br />
				</td>
			</tr>
			<tr>
				<td>40602</td>
			...
			<tr>
				<td>40605</td>
				<td>
					标配资料字段的值非法，标配资料字段的合理取值范围可参见：<a href="http://tce.fsphere.cn/doc/product/269/1500#3-.E6.A0.87.E9.85.8D.E8.B5.84.E6.96.99.E5.AD.97.E6.AE.B5">标配资料字段</a>。<br />
				</td>
			</tr>
			<tr>
				<td>40606</td>
...
<table style="display:table;width:100%">
		<tbody>
			...
			<tr>
				...
				<td>
					加好友来源字段非法，详情可参见<a href="http://tce.fsphere.cn/document/product/269/1501#3.1-.E6.A0.87.E9.85.8D.E5.A5.BD.E5.8F.8B.E5.AD.97.E6.AE.B5">标配好友字段</a>。<br />
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					请求包中字符串类型的参数长度非法，详情可参见<a href="http://tce.fsphere.cn/document/product/269/1501#3.1-.E6.A0.87.E9.85.8D.E5.A5.BD.E5.8F.8B.E5.AD.97.E6.AE.B5">标配好友字段</a>，可能的错误有：<br />
					1、好友备注的长度非法；<br />
					2、分组名称的长度非法；<br />
					3、加好友附言的长度非法。<br />
				</td>
			...
			<tr>
				...
				<td>
					分组个数达到系统上限，详情可参见<a href="http://tce.fsphere.cn/document/product/269/1501#3.1-.E6.A0.87.E9.85.8D.E5.A5.BD.E5.8F.8B.E5.AD.97.E6.AE.B5">标配好友字段</a>，调用方可以捕捉该错误给用户一个合理的提示。<br />
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				...
				<td>
					加好友回应参数长度错误，详情可参见<a href="http://tce.fsphere.cn/document/product/269/1501#3.1-.E6.A0.87.E9.85.8D.E5.A5.BD.E5.8F.8B.E5.AD.97.E6.AE.B5">标配好友字段</a>，可能的错误有：<br />
					1、好友备注的长度非法；<br />
					2、分组名称的长度非法。<br />
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					加好友回应From_Account的分组个数已达系统上限，详情可参见<a href="http://tce.fsphere.cn/document/product/269/1501#3.1-.E6.A0.87.E9.85.8D.E5.A5.BD.E5.8F.8B.E5.AD.97.E6.AE.B5">标配好友字段</a>，调用方可以捕捉该错误给用户一个合理的提示。<br />
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				...
				<td>
					好友数据更新分组个数已达系统上限，详情可参见<a href="http://tce.fsphere.cn/document/product/269/1501#3.1-.E6.A0.87.E9.85.8D.E5.A5.BD.E5.8F.8B.E5.AD.97.E6.AE.B5">标配好友字段</a>，调用方可以捕捉该错误给用户一个合理的提示。<br />
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					好友导入参数错误，详情可参见<a href="http://tce.fsphere.cn/document/product/269/1501#3.1-.E6.A0.87.E9.85.8D.E5.A5.BD.E5.8F.8B.E5.AD.97.E6.AE.B5">标配好友字段</a>及<a href="http://tce.fsphere.cn/document/product/269/1501#3.2-.E8.87.AA.E5.AE.9A.E4.B9.89.E5.A5.BD.E5.8F.8B.E5.AD.97.E6.AE.B5">自定义好友字段</a>，可能的错误有：<br />
					1、好友备注的长度非法；<br />
					2、分组名称的长度非法；<br />
					3、加好友附言的长度非法；<br />
					4、加好友来源字符串非法；<br />
			...
			<tr>
				...
				<td>
					好友导入分组个数已达系统上限，详情可参见<a href="http://tce.fsphere.cn/document/product/269/1501#3.1-.E6.A0.87.E9.85.8D.E5.A5.BD.E5.8F.8B.E5.AD.97.E6.AE.B5">标配好友字段</a>，调用方可以捕捉该错误给用户一个合理的提示。<br />
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				...
				<td>
					请求添加的分组名长度非法，详情可参见<a href="http://tce.fsphere.cn/document/product/269/1501#3.1-.E6.A0.87.E9.85.8D.E5.A5.BD.E5.8F.8B.E5.AD.97.E6.AE.B5">标配好友字段</a>。<br />
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				...
				<td>
					分组ID非法，详情可参见<a href="http://tce.fsphere.cn/document/product/269/1501#3.1-.E6.A0.87.E9.85.8D.E5.A5.BD.E5.8F.8B.E5.AD.97.E6.AE.B5">标配好友字段</a>。<br />
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					分组个数已达系统上限，详情可参见<a href="http://tce.fsphere.cn/document/product/269/1501#3.1-.E6.A0.87.E9.85.8D.E5.A5.BD.E5.8F.8B.E5.AD.97.E6.AE.B5">标配好友字段</a>。<br />
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				...
				<td>
					请求更新的分组名长度非法，详情可参见<a href="http://tce.fsphere.cn/document/product/269/1501#3.1-.E6.A0.87.E9.85.8D.E5.A5.BD.E5.8F.8B.E5.AD.97.E6.AE.B5">标配好友字段</a>。<br />
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					新分组名的长度非法，详情可参见<a href="http://tce.fsphere.cn/document/product/269/1501#3.1-.E6.A0.87.E9.85.8D.E5.A5.BD.E5.8F.8B.E5.AD.97.E6.AE.B5">标配好友字段</a>。<br />
				</td>
			</tr>
			<tr>
				<td>
...
<table style="display:table;width:100%">
		<tbody>
			...
			<tr>
				...
				<td>
					sdkappid 未找到，请确认是否已经在云平台上配置<br />
				</td>
			</tr>
			<tr>
				<td>
...
<tr><td>90024</td><td>推送频率超过限制。默认2次推送间隔不能少于1s。</td><td>否</td></tr>
...
<tr><td>90033</td><td>请求包错误。可能原因如下：1.json格式非法。2.json中某数组字段包含个数超过限制（例如最多只能给500个用户设置属性）。3.json中某字段长度超过字节大小限制（例如用户属性值不能超过50字节）。</td><td>否</td></tr>
<tr><td>90045</td><td>推送功能尚未开通。请到云通信控制台 "应用配置->功能配置->消息推送" 设置开启，并将在50分钟内生效。注：此功能是收费项，具体请参考<a href="/document/product/269/7912">计费规则</a>。</td><td>否</td></tr>
<tr><td>90046</td><td>请求中某账号TAGS已达上限，请检查删除部分TAG再进行添加。</td><td>否</td></tr>
<tr><td>90047</td><td>推送请求超过当日配额。如需要提升配额，请参考文档申请工单。</td><td>否</td></tr>
<tr><td>90048</td><td>请求中含有非法账号。请检查是否有账号未注册。</td><td>否</td></tr>
