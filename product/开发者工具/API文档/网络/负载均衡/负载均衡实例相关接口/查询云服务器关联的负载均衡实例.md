...
<td> unInstanceId
<td> String
<td> 云服务器统一ID，可以调用<a href="/doc/api/229/%E6%9F%A5%E7%9C%8B%E5%AE%9E%E4%BE%8B%E5%88%97%E8%A1%A8" title="DescribeInstances">DescribeInstances</a>接口来查询该字段详情。
<tr>
<td> instanceName
<td> String
<td> 云服务器名称。
...
使用默认参数来查询有哪些负载均衡实例：
```
http://lb.api.qcloud.com/v2/index.php?Action=DescribeLoadBalancersByInstances
&<公共请求参数>
```
输出
```
