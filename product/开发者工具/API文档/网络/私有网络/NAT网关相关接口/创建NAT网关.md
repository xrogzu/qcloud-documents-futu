...
| maxConcurrent | 是 | int | 网关并发连接上限，例如：100、300、1000，单位为万,具体支持数据请参见<a href="/doc/product/215/1682" title="网关说明" >私有网络网关说明</a> |
| bandwidth | 否 | int | 网关最大外网出带宽(单位:Mbps), 默认: 0(无上限), 具体支持数据请参见<a href="/doc/product/215/1682" title="网关说明" >私有网络网关说明</a> |
