...
| maxConcurrent | 是 | int | 网关并发连接上限，可选值为：100w（小型）、300w（中型）、 1000w（大型）|
...
| message | String | 错误信息 |
| billId | string | 订单ID，升级结果可调用<a href="http://tcecqpoc.fsphere.cn/doc/api/245/%e6%9f%a5%e8%af%a2NAT%e7%bd%91%e5%85%b3%e7%9a%84%e7%94%9f%e4%ba%a7%e7%8a%b6%e6%80%81?viewType=preview" title="查询NAT网关的升级状态">查询NAT网关的升级状态</a>查询 |
...
| InvalidNatGatewayId.NotFound | 无效的NAT网关，NAT网关资源不存在。请再次核实您输入的资源信息是否正确，可通过<a href="http://tcecqpoc.fsphere.cn/doc/api/245/%e6%9f%a5%e8%af%a2NAT%e7%bd%91%e5%85%b3?viewType=preview" title="DescribeNatGateway">DescribeNatGateway</a>接口查询NAT网关 |
