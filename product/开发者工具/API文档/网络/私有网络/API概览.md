...
| 创建私有网络和基础网络设备互通 | [AttachClassicLinkVpc](/doc/api/245/2098) | 创建私有网络和基础网络设备互通。 |
| 删除私有网络和基础网络设备互通 | [DetachClassicLinkVpc](/doc/api/245/2097) | 删除私有网络和基础网络设备互通。 |
| 查询私有网络和基础网络设备互通 | [DescribeVpcClassicLink](/doc/api/245/2097) | 查询私有网络和基础网络设备互通。 |
...
| 修改子网名称 | [ModifySubnetAttribute](/document/product/215/1313) | 修改指定子网名称。 |
...
| 修改子网关联的路由表 | [AssociateRouteTable](/document/product/215/1416) | 修改子网关联的路由表。 |
...
| 接口功能 | Action ID |  功能描述 |
|---------|---------|---------|
| 查询VPN网关价格 | [InquiryVpnPrice](/doc/api/245/5104) | 查询VPN网关价格。 |
...
| 续费VPN网关 | [RenewVpn](/doc/api/245/5109) | 续费vpn网关。 |
...
| 接口功能 | Action ID |  功能描述 |
|---------|---------|---------|
| 查询sslVPN | [DescribeSSLVpn](/doc/api/245/5121) | 查询sslVPN。 |
| 查询sslVPN域 | [DescribeSSLVpnDomain](/doc/api/245/5122) | 查询sslVPN域。 |
| 设置sslVPN域 | [SetSSLVpnDomain](/doc/api/245/5123) | 设置sslVPN域。 |
...
| 添加专线网关本端源IP端口转换 | [CreateLocalSourceIPPortTranslationNatRule](/document/product/215/5190) | 添加专线网关本端源IP端口转换。 |
| 删除专线网关本端源IP端口转换 | [DeleteLocalSourceIPPortTranslationNatRule](/document/product/215/5191) | 删除专线网关本端源IP端口转换。 |
| 修改专线网关本端源IP端口转换 | [ModifyLocalSourceIPPortTranslationNatRule](/document/product/215/5192) | 修改专线网关本端源IP端口转换。 |
| 查询专线网关本端源IP端口转换 | [DescribeLocalSourceIPPortTranslationNatRule](/doc/api/245/4836) | 查询专线网关本端源IP端口转换。 |
| 添加专线网关本端目的IP端口转换 | [CreateLocalDestinationIPPortTranslationNatRule](/document/product/215/5195) | 添加专线网关本端目的IP端口转换。 |
| 删除专线网关本端目的IP端口转换 | [DeleteLocalDestinationIPPortTranslationNatRule](/document/product/215/5196) | 删除专线网关本端目的IP端口转换。 |
| 修改专线网关本端目的IP端口转换 | [ModifyLocalDestinationIPPortTranslationNatRule](/doc/api/245/4842) | 修改专线网关本端目的IP端口转换。 |
| 查询专线网关本端目的IP端口转换 | [DescribeLocalDestinationIPPortTranslationNatRule](/doc/api/245/4837) | 查询专线网关本端目的IP端口转换。 |
| 添加专线网关对端IP转换 | [CreatePeerIPTranslationNatRule](/doc/api/245/5190) | 添加专线网关对端IP转换。 |
| 删除专线网关对端IP转换 | [DeletePeerIPTranslationNatRule](/doc/api/245/5191) | 删除专线网关对端IP转换。 |
| 修改专线网关对端IP转换 | [ModifyPeerIPTranslationNatRule](/doc/api/245/5192) | 修改专线网关对端IP转换。 |
| 查询专线网关对端IP转换 | [DescribePeerIPTranslationNatRule](/doc/api/245/5193) | 查询专线网关对端IP转换。 |
...
| 内网IP迁移 | [DetachNetworkInterface](/doc/api/245/5385) | 内网IP迁移。 |
