...
| eniName | 是 | String | 弹性网卡名称，取值：1-25个中文、英文大小写的字母、数字和下划线分隔符，在同一个VPC内名称不能重复。 |
| eniDescription | 否 | String | 弹性网卡描述，25个字符以内。 |
...
| InvalidNetworkInterfaceName | 弹性网卡名称不合法。弹性网卡名称取值范围：1-60个中文、英文大小写的字母、数字和下划线分隔符 |
| InvalidNetworkInterface.InUse | 弹性网卡名称已被VPC下其他弹性网卡使用。同一个VPC内弹性网卡名称不能重复。 |
| NetworkInterfaceLimitExceeded | 创建的弹性网卡数量超过上限。如果需要更多资源，请联系客服申请。更多VPC资源限制信息详见<a href="/doc/product/215/537" title="VPC使用限制">VPC使用限制</a> |
