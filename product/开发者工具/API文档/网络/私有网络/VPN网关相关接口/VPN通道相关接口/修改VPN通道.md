...
| InvalidVpnGw.NotFound | 无效的vpn通道。vpn通道资源不存在，请再次核实您输入的资源信息是否正确，可通过<a href="http://tce.fsphere.cn/document/api/215/5113" title="DescribeVpnConn">DescribeVpnConn</a>接口查询vpn通道。 |
