...
输入
```
  http://cvm.api.qcloud.com/v2/index.php?Action=DescribeUserInfo
  &COMMON_PARAMS
```
...
输入
```
  http://cvm.api.qcloud.com/v2/index.php?Action=PayDeals
...
输入
```
  http://cvm.api.qcloud.com/v2/index.php?Action=DescribeAccountBalance
  &COMMON_PARAMS
```
