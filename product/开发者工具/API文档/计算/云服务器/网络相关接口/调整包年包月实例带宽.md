...
* 只针对包年包月实例和[带宽包](http://tce.fsphere.cn/doc/product/213/%E4%BA%91%E6%9C%8D%E5%8A%A1%E5%99%A8%E7%AE%A1%E7%90%86%E5%B8%B8%E8%A7%81%E9%97%AE%E9%A2%98#1.-.E4.BB.80.E4.B9.88.E6.98.AF.E5.B8.A6.E5.AE.BD.E5.8C.85.E6.A8.A1.E5.BC.8F.EF.BC.9F)用户。按量计费实例调整带宽需要使用 [UpdateInstanceBandwidthHour](http://tce.fsphere.cn/doc/api/229/1345) API。
* 只允许升级带宽，不允许降低带宽值。
...
| endTime| 是| String| 终止时间。格式如：2017-11-30，修改带宽的有效期包含此日期，该时间不能晚于实例过期的时间；实例的到期时间可以使用 [DescribeInstances](http://tce.fsphere.cn/doc/api/229/831) API查询。
