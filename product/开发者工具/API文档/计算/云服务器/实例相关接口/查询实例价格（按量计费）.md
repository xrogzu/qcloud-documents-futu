...
* 仅支持<font color="red">按量计费实例</font>的价格查询，包年包月实例使用 [InquiryInstancePrice](http://tce.fsphere.cn/doc/api/229/1349)。
...
| storageSize| 是| Int| 数据盘大小(GB)。步长为10，0表示不要数据盘。关于数据盘的最大大小请参考[硬盘产品简介](http://tce.fsphere.cn/doc/product/213/498)。|
