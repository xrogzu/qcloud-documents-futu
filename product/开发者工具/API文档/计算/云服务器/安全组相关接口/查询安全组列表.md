...
2)本接口输入instanceId时，根据云服务器实例ID查询云服务器已关联的安全组列表。云服务器实例ID来自[DescribeInstances](http://tcecqpoc.fsphere.cn/doc/api/229/831)输出参数中的unInstanceId。
...
```
  ...
  http://dfw.api.qcloud.com/v2/index.php?Action=DescribeSecurityGroups
  &<公共请求参数>
