1. 您可以通过登录 [github](http://github.com/) Fork github 的 demo 代码：[http://github.com/sodatencent/roll_a_ball](http://github.com/sodatencent/roll_a_ball)。
...
4. 注册账号[点击这里](http://unity3d.com/cn/) ，用于 unity3d 构建。
