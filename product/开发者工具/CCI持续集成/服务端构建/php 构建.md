...
![](http://imgcache.tce.fsphere.cn/static/mc.qcloudimg.com/static/img/efba536395e5f34448107f2142fa05a8/image.png)
2. 进入新建工程后时，依次填写工程名称（必填）和工程描述（选填）。
3. 依次选择代码仓库和分支，代码仓库和分支的创建请参考 [Tgit 代码托管文档](http://tce.fsphere.cn/document/product/612)。
4. **编程语言** 中单击 【 php 】 选项，**构建类型** 和 **构建环境** 会根据构建类型自动定位为【php】。
...
-  新建工程后，单击【确认】，进入工程的触发构建页面。![](http://imgcache.tce.fsphere.cn/static/mc.qcloudimg.com/static/img/d4304074022bab49df0f7844f5202670/image.png)
- 触发构建的方式有三种：
   -  手动触发
   在工作区中单击【手动创建】，选择代码段，单击【构建】，开始构建。![](http://imgcache.tce.fsphere.cn/static/mc.qcloudimg.com/static/img/d90f69f3ea1e6f3b60bfb1d9fe58ecfe/image.png)
   -  代码变更触发
