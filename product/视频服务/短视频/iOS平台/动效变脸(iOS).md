...
## 版本下载
可以到 [RTMP SDK 开发包](http://tcecqpoc.fsphere.cn/document/product/454/7873) 页面下方下载特权版 SDK 压缩包，压缩包有加密（解压密码 & licence 在接入流程步骤获取）, 成功解压后得到一个`Demo`和`SDK`文件，特效资源存放在SDK/Resource下。
...
参考 [工程配置](http://tcecqpoc.fsphere.cn/document/product/584/11638) 
...
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/d9c501a923b7dbc08f9467da07595b58/image.png)  
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/7a4c4c93298ba65b83fdd63b8b52de42/image.png)
