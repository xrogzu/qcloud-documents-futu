...
|:-------:|:-------:| :-------:| :-------:|
| iOS    | Objective-C | [DOWNLOAD](/document/product/454/7873#iOS) | [API 文档](/document/product/454/14730) | 
| Android | java  | [DOWNLOAD](/document/product/454/7873#Android) |  [API 文档](/document/product/454/14642) | 
| IE浏览器  | javascript | [DOWNLOAD](/document/product/454/7873#Windows)  |  [API 文档](/document/product/454/14766) | 
| PC（C++） | C++ | [DOWNLOAD](/document/product/454/7873#Windows)  |  [API 文档](/document/product/454/14745) | 
...
| :-------:| :-------:| :-------: | :-------:|
| serverDomain | 使用云平台 RoomService<br> `http://room.qcloud.com/weapp`<br>`/live_room` | 使用云平台 RoomService<br> `http://room.qcloud.com/weapp`<br>`/live_room` ，需要提前 [配置](#TencentRoom) | [自行部署](#SelfRoom) RoomService<br> `http://[yourcompany]/weapp`<br>`/live_room` |
...
#### step1. 配置RoomService
serverDomain 填写  `http://room.qcloud.com/weapp/live_room` 即可。
...
``` 
http://room.qcloud.com/weapp/live_room 
```
...
#### step1. 下载源码 & 修改配置 & 部署
在 [CODE](/document/product/454/7873#Server) 下载 RoomService 后台源码，源码包分成三个目录，其中 live_room 下的源码是您需要关注的。
...
``` 
http://[www.yourcompany.com]/weapp/live_room 
```
