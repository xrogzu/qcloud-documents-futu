...
## 版本下载
可以到 [RTMP SDK 开发包](/document/product/454/7873) 页面下方下载特权版 SDK 压缩包，压缩包有加密（解压密码 & licence 的获取参考接入流程）, 成功解压后得到一个`Demo`和`SDK`文件，特效资源存放在SDK/Resource下。
...
参考 [工程配置](/document/product/454/7876) 
