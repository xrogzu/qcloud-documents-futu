...
相比于 [ReplayKit](/document/product/454/7883) , Airplay 的优势就是不要求目标 App 的支持，因为它可以在任何情况下获取到当前屏幕的内容，不管是一款游戏，还是系统界面。
...
> 如果您是初次使用直播SDK，可参考 [iOS端集成](/document/product/454/7876) 
>
...
> 推流事件部分参考 [推流事件监听](/document/product/454/7879#1.-.E4.BA.8B.E4.BB.B6.E7.9B.91.E5.90.AC)
...
这种推流模式可参考[游戏录屏（ReplayKit）](/document/product/454/7883)。
...
录屏画面变化波动比摄像头要大，相同分辨率和帧率下，达到同样的清晰度往往需要更高的码率，关于码率的选择请参考[如何实现好的画质](/document/product/454/7955)。
