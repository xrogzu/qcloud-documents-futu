...
**&lt;live-room&gt;** 并非微信小程序原生提供的标签，而是一个自定义组件，所以您需要额外的代码来支持这个标签。点击 [小程序源码](/document/product/454/7873#XiaoChengXu) 下载源码包，您可以在 `wxlite` 文件夹下获取到所需文件。
...
参考 [DOC](/document/product/454/14606#Server) 可以了解上面的这些参数应该怎么填写。
...
## 其它平台
**&lt;live-room&gt;** 也有 Windows、iOS、Android 等平台下的对等实现，您可以参考下表中的资料。同时， 阅读 [设计文档](/document/product/454/14617)，您可以了解该解决方案的内部设计原理。

| 所属平台 | SDK下载 | 文档指引 |
|:-------:|:-------:|:-------:|
| Windows(C++) | [DOWNLOAD](/document/product/454/7873#Windows) | [API](/document/product/454/14745) |
| Windows(C#) | [DOWNLOAD](/document/product/454/7873#Windows) | [API](/document/product/454/15367) |
| IE浏览器 | [DOWNLOAD](/document/product/454/7873#Windows) | [API](/document/product/454/14766) |
| iOS | [DOWNLOAD](/document/product/454/7873#iOS) | [API](/document/product/454/14730) |
| Android | [DOWNLOAD](/document/product/454/7873#Android) | [API](/document/product/454/14642) |
