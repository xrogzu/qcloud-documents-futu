...
模式选择及码率设置请参考 [&lt;live-pusher&gt;](/document/product/454/12518) 标签参数设置部分。

### 推流及播放关键事件如何监听？
推流事件监听请参考 [&lt;live-pusher&gt;](/document/product/454/12518) 标签内部事件部分。
播放事件监听请参考 [&lt;live-player&gt;](/document/product/454/12519) 标签内部事件部分。
