下面是腾讯视频云Android SDK的主要接口列表，分为TXLivePusher和TXLivePlayer两个类，事件回调及常量定义，详细接口请查看[API 接口文档](http://imgcache.tce.fsphere.cn/static/imgcache.qq.com/open/qcloud/video/act/liteav_android_doc/index.html)。
