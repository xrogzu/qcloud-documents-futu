...
## 整体对接
### 步骤一：主播 A 推流
主播 A 从您的业务后台获取推流防盗链地址 streamA，之后可以用 [TXLivePusher](https://cloud.tencent.com/document/product/454/7885) 进行推流。
...
### 步骤二：主播 B 推流
主播 B 从您的业务后台获取推流防盗链地址 streamB，之后可以用 [TXLivePusher](https://cloud.tencent.com/document/product/454/7885) 进行推流。
...
主播 A 此时需要使用 [TXLivePlayer](https://cloud.tencent.com/document/product/454/7886) 播放 streamB 的 **低延时** 地址，<font color='red'>特别注意</font>，这里不能播放普通的 CDN 观看地址。区别在于前者的延迟一般在 500ms 以内，而 CDN 的延迟一般在 2s 以上，CDN 地址只能给普通观众观看，不能用于主播之间的连麦。
...
- **4.2 使用  [TXLivePlayer](https://cloud.tencent.com/document/product/454/7886) 的 PLAY_TYPE_LIVE_RTMP_ACC 播放模式**
...
- 使用  [TXLivePlayer](https://cloud.tencent.com/document/product/454/7886) 播放，并设置为 PLAY_TYPE_LIVE_RTMP_ACC 播放模式。
...
具体使用方案可以参考 [云端混流 API](https://cloud.tencent.com/document/product/454/9859)。
