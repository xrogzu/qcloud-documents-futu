## 1.工程结构
[下载](/document/product/454/7873)小直播代码后，您将看到TCLVBIMDemo.xcworkspace文件，这是小直播的Xcode工程工作区，用于管理小直播的代码工程和依赖的第三方开源类库（位于Pods目录下），如果您需要编译或浏览小直播相关代码，请打开此文件，请勿直接打开小直播的工程文件TCLVBIMDemo.xcodeproj。打开TCLVBIMDemo.xcworkspace后，您将看到如下的工程目录结构：
...
配置完成后，工程就可以在真机上运行，但是如果要真正体验小直播的功能，还需要修改TCConstants.h中的配置，如何配置，请参考[终端集成](/document/product/454/7999#4.-.E7.BB.88.E7.AB.AF.E9.9B.86.E6.88.90.E5.8F.8A.E5.9B.9E.E8.B0.83.E8.AE.BE.E7.BD.AE)
...
- 如果您已经有自己的帐号体系，可以直接替换该模块，并调用TCIMPlatform的guestLogin接口以游客身份使用IM通道，详情请参考[替换帐号](/doc/api/258/6441)
...
### 消息
#### 模块介绍
- 小直播的互动消息功能主要基于[ImSDK](/doc/product/269/1569)的群聊功能实现，需要在IMSDK登录后才能调用
