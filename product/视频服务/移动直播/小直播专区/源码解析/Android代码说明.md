## 1. 工程结构
从 [官网](http://tcecqpoc.fsphere.cn/document/product/454/6991) 下载小直播代码，使用Android Studio打开工程后，您将看到如下的目录结构：
...
### [短视频](http://tcecqpoc.fsphere.cn/document/product/584/9369)（非必选）
UGC 小视频的录制和发布以及编辑功能。
- jar 包
...
-  在集成连麦功能之前，建议先了解下 [连麦的原理](http://tcecqpoc.fsphere.cn/document/product/454/9855) ，再按照 [对接攻略](http://tcecqpoc.fsphere.cn/document/product/454/9858) 来集成。
...
### 短视频录制模块
#### 模块简介
- 小直播提供录制 一分钟的 [短视频](http://tcecqpoc.fsphere.cn/document/product/584/9453) 功能，但 SDK 本身不显示录制时长。
...
### 短视频编辑模块
#### 模块简介
- [视频编辑](http://tcecqpoc.fsphere.cn/document/product/584/9502) 包括视频裁剪加速、美颜滤镜、音乐混音及添加字幕等功能
