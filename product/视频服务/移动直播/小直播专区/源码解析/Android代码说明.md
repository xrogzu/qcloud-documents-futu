## 1. 工程结构
从 [官网](http://tce.fsphere.cn/document/product/454/6991) 下载小直播代码，使用Android Studio打开工程后，您将看到如下的目录结构：
![](http://imgcache.tce.fsphere.cn/image/mc.qcloudimg.com/static/img/5e39b905d134114aeb752f614313123d/image.png)
...
## 2. 库使用说明
### [直播 SDK](http://tce.fsphere.cn/document/product/454/7873)  (必选)
...
### [短视频](http://tce.fsphere.cn/document/product/584/9369)（非必选）
UGC 小视频的录制和发布以及编辑功能。
- jar 包
...
- 如果您已经有自己的帐号体系，可以直接替换该模块，并调用TCLoginMgr的guestLogin接口以游客身份使用IM通道，详情请参考[替换帐号](http://tce.fsphere.cn/doc/api/258/6441)
...
### 互动消息
#### 模块简介
- 小直播的互动消息功能主要基于[ImSDK](http://tce.fsphere.cn/doc/product/269/1561)的群聊功能实现，需要在IMSDK登录后才能调用
...
![](http://imgcache.tce.fsphere.cn/image/mc.qcloudimg.com/static/img/3da33f8c62b9339a365faddd2635faa2/image.png)
...
-  在集成连麦功能之前，建议先了解下 [连麦的原理](http://tce.fsphere.cn/document/product/454/9855) ，再按照 [对接攻略](http://tce.fsphere.cn/document/product/454/9858) 来集成。
...
### 短视频录制模块
#### 模块简介
- 小直播提供录制 一分钟的 [短视频](http://tce.fsphere.cn/document/product/584/9453) 功能，但 SDK 本身不显示录制时长。
...
### 短视频编辑模块
#### 模块简介
- [视频编辑](http://tce.fsphere.cn/document/product/584/9502) 包括视频裁剪加速、美颜滤镜、音乐混音及添加字幕等功能
