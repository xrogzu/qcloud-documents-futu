...
### CAB获取
您可以从云平台官网 [SDK 下载](/document/product/454/7873#Windows) 中获取目前最新的 ActiveX 插件，下载完的 zip 包解压后有以下几个部分：

| 文件名  | 详情                                                         |
| ------- | ------------------------------------------------------------ |
| demo    | demo包含调用sdk/LiteAVAX.cab的html和js源码，可以直接参考如何使用activex插件开发音视频，目前支持的demo有推拉流、双人视频、多人视频、直播模式等，[体验demo](/document/product/454/6555) |
...
### 测试效果
IE 浏览器上运行 demo.html，检测是否插好 USB 摄像头，输入 [推流URL](/document/product/454/7915)，点击 “测试推流” 按钮即可：
