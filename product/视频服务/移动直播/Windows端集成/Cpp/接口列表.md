...
在云平台官网 [下载](http://tce.fsphere.cn/document/product/454/7873#Windows) SDK 开发包，可于SDK\include中可以看到详细的接口注释。
...
| 参数   | 类型           | 说明                                       |
| ---- | ------------ | ---------------------------------------- |
| url  | const char * | 一个合法的推流地址，支持 rtmp 协议（URL 以 “rtmp://” 打头 ，云平台推流 URL 的获取方法见 [DOC]( http://tce.fsphere.cn/document/product/454/7915 "云平台-推拉流地址Doc") ） |
...
| 参数   | 类型           | 说明                                       |
| ---- | ------------ | ---------------------------------------- |
| url  | const char * | 一个合法的拉流地址，视频播放 URL（URL 以 “rtmp://” 打头 ，云平台拉流 URL 的获取方法见 [DOC]( http://tce.fsphere.cn/document/product/454/7915 "云平台-推拉流地址Doc") ） |
