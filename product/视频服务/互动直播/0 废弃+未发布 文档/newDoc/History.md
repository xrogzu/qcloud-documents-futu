...
* [适应更多旋转裁剪场景](/document/product/268/7647)
* [直播时支持背景音乐](/document/product/268/8297)

## `随心播后台 2.0.0    2017-01-18`

* 独立账户模式的随心播后台终于来了，需要iLive SDK1.2.0配合使用。
* [QuickStart文档](/document/product/268/7603)
* 账号集成采用独立模式
* 支持录制文件的查询
* 支持旁路推流和录制回调
...
腾讯视频云为客户提供了强大的截图和鉴黄功能。具体使用方法请参考[文档](/document/product/268/8109)。
