...
> 观众侧
![](http://zhaoyang21cn.github.io/iLiveSDK_Help/readme_img/audio_member.jpg)

> 主播侧
![](http://zhaoyang21cn.github.io/iLiveSDK_Help/readme_img/audio_host.jpg)
...
1. 主播或上麦观众云平台后台spear角色配置里音频场景要设置为“开播”（开播场景会占用本地录音权限），也可以设置为“观看”这样就不会占用本地音频设备了；
...
![](http://zhaoyang21cn.github.io/iLiveSDK_Help/readme_img/custom_flow.png)
...
int|图像宽度
int|图像高度
int|图像渲染角度。角度可以是0、1、2、3,含义分别为图像需要顺时针旋转0、90、180、270度才能正立
int|图像颜色格式，具体值参考EXTERNAL_FORMAT_I420、EXTERNAL_FORMAT_RGBA等值
...
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/0baaafa05e5549ff30f584ac9424f756/11.png)
...
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/f532b2ba735514ed2faff41cf805a817/image.png)
...
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/5311e0e74ef71db124c291be01f8b5da/image.png)
...
|接口|描述|
|---|---|
|OnVideoPreview:|远程画面回调，接收远程帧数据，再使用ILiveSDK的渲染接口渲染，用户只需要添加一个渲染区域即可。渲染详情请参考[新版随心播](http://github.com/zhaoyang21cn/ILiveSDK_iOS_Demos/tree/master)|
