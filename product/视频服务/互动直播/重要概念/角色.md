...
### 如何配置角色
用户可以在云平台后台，配置角色
![](http://zhaoyang21cn.github.io/iLiveSDK_Help/readme_img/role_config.png)

### 如何定制角色
用户可以根据自己的需求定制自己的角色
![](http://zhaoyang21cn.github.io/iLiveSDK_Help/readme_img/role_detail.png)
...
option.controlRole = @"LiveMaster";//角色字符串来自云平台控制台spear配置
...
用户可以在云平台针对主播，观众分别配置多个角色(高清，标清，流畅)，用户可以检测当前的网络状态，动态调整当前使用的角色，以达到动态修改视频质量的效果

*可以参照[随心播](http://github.com/zhaoyang21cn/iLiveSDK_Android_Suixinbo)*
