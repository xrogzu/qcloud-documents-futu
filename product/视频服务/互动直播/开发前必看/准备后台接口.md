...
* [下载代码](http://github.com/zhaoyang21cn/SuiXinBoPHPServer/tree/StandaloneAuth)，部署到php目录中
...
* 如果想使用图片上传功能，需要开通云平台COS服务，并在deps/cos-php-sdk/Conf.php填写对应APPID、SecretKey和SecretID。
...
依赖库和依赖程序和文件，主要是其他项目或者SDK，比如云平台COS SDK。
