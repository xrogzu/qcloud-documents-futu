...
2. 用户也可以通过点播提供的API进行管理操作，[API手册](http://tce.fsphere.cn/document/product/266/7788)<br/>
3. DescribeVodPlayInfo能根据文件名（开始录制Api中，录制参数所填文件名）获取到录制
文件下载地址。详见[参考文档](http://tce.fsphere.cn/document/product/266/8586)

### 3 价格和计费说明

按照录制月并发最高路数收费，价格：30元/路/月。
此外，录制功能会使用点播服务的能力，在云点播中会产生存储、流量的费用。[计费规则](http://tce.fsphere.cn/doc/product/268/5129#2..E5.BD.95.E5.88.B6.E7.9B.B8.E5.85.B3.E8.AE.A1.E8.B4.B9)：
