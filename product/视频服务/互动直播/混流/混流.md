...
### 如何混流
对于在使用腾讯视频云业务(包括直播、互动直播)的用户，都可以通过[接口](http://tcecqpoc.fsphere.cn/document/product/267/8832)实现在云端混流
...
Post内部为Json格式的混流参数,详见[接口](http://tcecqpoc.fsphere.cn/document/product/267/8832)
