...
**使用旁路直播功能前，请先在控制台开通云平台直播服务，否则将无法使用**。
...
Android旁路直播功能的详细实现见[新随心播](http://github.com/zhaoyang21cn/ILiveSDK_Android_Demos)
...
IOS旁路直播功能的详细实现见[新随心播](http://github.com/zhaoyang21cn/ILiveSDK_iOS_Demos)
...
#### 2.2 腾讯视频云自主开发播放器TcPlayer

TcPlayer是由腾讯视频云自主开发的一款播放器，同时支持RTMP、FLV、HLS。演示地址为http://imgcache.tcecqpoc.fsphere.cn/image/imgcache.qq.com/open/qcloud/video/vcplayer/demo/tcplayer.html 更多详情请参阅官方文档 http://tcecqpoc.fsphere.cn/document/product/267/7479。
...
若需使用TcPlayer广告功能，需在页面引入 Google IMA SDK 
```javascript
