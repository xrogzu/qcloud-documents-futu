微信公众号视频链接发布是云平台视频服务的重要功能之一。目前为了确保微信公众号中消息发布的内容，微信平台当前仅允许特定视频链接可以作为公众号消息内容进行发布。

通过微信公众号视频链接发布功能，您可以方便的将已经存放在云平台中的视频生成可以在公众号消息发布中引用的专用链接，由此实现视频内容的公众号信息发布。使用该功能前，请确保您的账号 [实已名认证](http://tcecqpoc.fsphere.cn/document/product/378/3629) 通过。
...
### 步骤一：确认资质和套餐
使用微信公众号视频链接发布功能，使用前需确认账号已实名认证通过。如未完成，请补充材料以完成实名认证操作，具体操作步骤请参考 [实名认证指引](http://tcecqpoc.fsphere.cn/document/product/378/3629)。
