...
云平台点播服务目前已经完成了从点播1.0到4.0的升级，系统内部进行了脱胎换骨的升级，主要升级内容包括：
...
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/2b4534a1e35c8a0325c04ce3542b80e8/image.png)


进入到点播1.0视频管理页面之后，您可点击“返回点播4.0”按钮来查看点播4.0的视频文件，如下图所示：

![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/a9d09b0be77e8974d0d7222fb9b3627a/image.png)
...
云平台直播、互动直播录制文件会进入点播系统，每个录制文件会有唯一的video_id(简称vid)。在点播1.0时代，视频会看URL可以通过video_id拼接得到。例如，对于如下这个典型的点播1.0视频文件URL：
