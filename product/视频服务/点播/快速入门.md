...
## 统计分析
视频发布完成后，您可以登录云平台 [点播服务控制台](http://console.tcecqpoc.fsphere.cn/video) 使用统计分析功能，通过宽带/流量统计、存储统计、转码统计以及播放情况统计四个维度对统计数据进行分析。详细操作步骤请参阅 [统计分析](http://tcecqpoc.fsphere.cn/document/product/266/14060) 文档。
