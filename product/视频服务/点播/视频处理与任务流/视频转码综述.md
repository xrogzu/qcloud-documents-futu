...
### 使用 AI 鉴黄
AI 鉴黄功能需要集成在[视频处理任务流](/document/product/266/11700#.E4.BB.BB.E5.8A.A1.E6.B5.81)中使用，检查结果通过[事件通知](/document/product/266/7829#.E4.BA.8B.E4.BB.B6.E9.80.9A.E7.9F.A5.E7.AE.80.E4.BB.8B)的方式来通知开发者。
...
启用人工审核时，开发者首先使用任务流 [`QCVB_ProcessUGCFile`](/document/product/266/11700#qcvb_processugcfile) 进行 AI 鉴黄，其中鉴黄模版选择 10。这样当视频涉黄时，任务流就会终止，同时涉黄的截图 URL 会通过[事件通知](/document/product/266/7829#.E4.BA.8B.E4.BB.B6.E9.80.9A.E7.9F.A5.E7.AE.80.E4.BB.8B)的方式通知到开发者。开发者人工审核截图，如果确实涉黄，可以[删除视频](/document/product/266/7838)；如果确认不涉黄，那么可以重新发起任务流来进行转码等处理（此时 `QCVB_ProcessUGCFile` 的 AI 鉴黄模版参数填 0 即可，表示不需鉴黄）。流程图如下：
