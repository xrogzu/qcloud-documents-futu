...
任务流执行完毕之后，转码结果可以从[GetVideoInfo](http://tcecqpoc.fsphere.cn/document/product/266/8586)接口应答包体中的[transcodeInfo](/document/product/266/8586#transcodeinfo.EF.BC.88.E8.A7.86.E9.A2.91.E8.BD.AC.E7.A0.81.E7.BB.93.E6.9E.9C.E4.BF.A1.E6.81.AF.EF.BC.89)对象获取到。
...
| startTime | 否 | Integer | 动图在视频中的开始时间
| endTime | 否 | Integer | 动图在视频中的结束时间

任务流执行完毕之后，转动图结果可以从[GetVideoInfo](/document/product/266/8586)接口应答包体中的[animatedGraphicsInfo](/document/product/266/8586)对象获取到。
