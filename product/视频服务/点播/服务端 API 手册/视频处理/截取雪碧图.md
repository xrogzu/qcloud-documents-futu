...
| definition | 是 | Integer | 雪碧图截图规格，参见[雪碧图截图模板](/document/product/266/11702#.E9.9B.AA.E7.A2.A7.E5.9B.BE.E6.88.AA.E5.9B.BE.E6.A8.A1.E6.9D.BF) |
| COMMON_PARAMS | 是 |  | 参见[公共参数](/document/api/213/6976) |

### 请求示例

```
http://vod.api.qcloud.com/v2/index.php?Action=CreateImageSprite
