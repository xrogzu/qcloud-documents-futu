...
如需开通该功能，可以提交工单或者联系一线同事。为了确保防盗链功能正常使用，请务必详细阅读[云平台URL防盗链功能说明](http://video.qcloud.com/download/docs/QVOD_HotLink_Protection_User_Guide.pdf)，并进行测试。获取URL可参考现有[获取视频信息V2](http://tcecqpoc.fsphere.cn/document/product/266/8586)。
