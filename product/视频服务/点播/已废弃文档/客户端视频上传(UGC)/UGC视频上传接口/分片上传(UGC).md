...
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/03bceeaebef439eb218edd080ef4d7fa/image.png)
...
1. 采用[MD5散列算法](http://zh.wikipedia.org/wiki/MD5)计算整个视频文件的哈希值，得到128位(16字节)的二进制串；
...
```
http://vod2.qcloud.com/v2/index.php?Action=UploadPartEx
