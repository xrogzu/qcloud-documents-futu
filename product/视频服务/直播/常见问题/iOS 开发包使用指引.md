...
4. 美颜滤镜、水印图标、切后台的垫片推流、背景音乐、耳返混响 等等一系列高级功能，推荐大家关注我们的 [官方文档](/document/product/454/7879)。
...
4. 截图、截视频（把视频一部分截取下来压成 MP4）等高级特性，可以参考完整的接入文档 [DOC](/document/product/454/7880#step-9.3A-.E6.88.AA.E6.B5.81.E5.BD.95.E5.88.B6.EF.BC.88.E4.BB.85.E7.9B.B4.E6.92.AD.EF.BC.89)。
...
- **实时通话**
 ...
 + 超级链路的 URL 拼装方式不同于普通的 CDN 播放地址，需要参考 [官方文档](/document/product/454/9849) 进行拼装。

- **多路混流**
 + 可以使用云平台端 [API](/document/product/454/9850) 指定将几条视频流混合起来，API 可以指定混流的各种参数，比如小画面的位置等等。
