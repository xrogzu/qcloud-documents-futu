...
云平台直播服务使用的域名访问地址为：live.api.qcloud.com。
...
</td><td> http://live.api.qcloud.com/v2/index.php<br> 
</td></tr>
<tr>
<td> 公共参数
</td><td> 每个接口都包含的通用参数
...
</td><td> 完整的指令请参见 <a href="http://tcecqpoc.fsphere.cn/document/product/267/5664" title="API概览">API概览</a>
</td></tr>
<tr>
<td> 指令参数
</td><td> 每个特定的指令需要的参数
...
</td><td> 由云平台上申请的标识身份的 SecretId 和 SecretKey, 其中 SecretKey 会用来生成 Signature<br>具体参考 <a href="/doc/api/258/接口鉴权" title="接口鉴权">接口鉴权</a> 页面
</td><td> 是
</td></tr>
<tr>
<td> Signature
