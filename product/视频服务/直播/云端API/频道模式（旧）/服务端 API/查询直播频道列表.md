...
输入1
<pre>
https://domain/v2/index.php?Action=DescribeLVBChannelList&channelStatus=0&ascDesc=1&pageNo=1&pageSize=10&<a href="http://tcecqpoc.fsphere.cn/doc/api/229/6976">公共请求参数</a>
