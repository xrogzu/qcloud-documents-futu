...
用户通过API对直播频道进行录制。详细方法请阅读[直播API介绍](http://tcecqpoc.fsphere.cn/doc/api/258/5664)。
...
用户通过API对直播频道进行截图。详细方法请阅读[直播API介绍](http://tcecqpoc.fsphere.cn/doc/api/258/5664)。
...
注意：
1. 对应COS平台文件操作API参考如下[COS文档API部分](http://tcecqpoc.fsphere.cn/document/product/430)。
