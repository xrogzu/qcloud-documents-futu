...
对应点播平台文件操作API参考如下[点播API使用指南](http://tcecqpoc.fsphere.cn/document/product/266/7788)。
...
**开通方式**
1. 用户可通过API对直播频道进行截图。创建截图任务API使用方式请阅读[创建截图任务](http://tcecqpoc.fsphere.cn/document/product/267/4726)。
   如要及时终止截图任务，可使用终止截图任务API，请参考[终止截图任务](http://tcecqpoc.fsphere.cn/document/product/267/4727)
2. 也可在控制台上开启截图任务（推荐）
