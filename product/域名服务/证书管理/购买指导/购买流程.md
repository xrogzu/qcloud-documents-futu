...
证书购买完成后，需在 [SSL证书管理控制台](http://console.tcecqpoc.fsphere.cn/ssl) 中提交审核材料进行证书申请，CA机构审核通过后将签发证书。详情查看  [付费证书申请流程](http://tcecqpoc.fsphere.cn/document/product/400/10257)
