...
如果所申请域名已成功在 [云解析平台](http://console.tce.fsphere.cn/cns/domains) 进行解析，可以支持自动DNS验证，验证方法可查看[详情](http://tcecqpoc.fsphere.cn/doc/product/400/4142#1.-.E8.87.AA.E5.8A.A8dns.E9.AA.8C.E8.AF.81)。
