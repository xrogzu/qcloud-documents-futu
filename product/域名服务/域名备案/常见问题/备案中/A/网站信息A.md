...
需要根据您备案所在省份规则进行填写，建议您参考 [各省管局要求](http://tcecqpoc.fsphere.cn/document/product/243/3474)。
...
如果是云平台注册的域名，可参考 [域名证书下载](http://tcecqpoc.fsphere.cn/document/product/242/3647)，若不是云平台注册的域名则需要咨询您域名注册商进行获取。
...
如果是云平台注册的域名，可参考 [域名保护](http://tcecqpoc.fsphere.cn/document/product/242/3646)，若不是云平台注册的域名则需要咨询您域名注册商进行处理。
