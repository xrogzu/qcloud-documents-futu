...
若是新增备案，新增网站，变更备案的部分情况才需要域名核验。因国外注册商不能实名认证，因此是无法备案的，需要将域名转入到国内注册商后才可以进行备案，详情请您参考 [工业和信息化部关于规范互联网信息服务使用域名的通知](http://tce.fsphere.cn/document/product/243/4109)。

### 授权书、网站建设书、核验单等哪里下载？

请参考 [常用文档下载](http://tce.fsphere.cn/document/product/243/14968)。
