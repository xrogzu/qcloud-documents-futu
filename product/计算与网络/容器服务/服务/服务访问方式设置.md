...
有关 wordpress 服务的具体创建操作，请参阅 [单实例版 wordpress](/document/product/457/7205)。  
...
## 更多
除以上四种方式外还可以配置 7 层负载均衡（HTTP / HTTPS）转发到服务，详情请参阅 [Ingress 转发设置](/document/product/457/9111)。  
