Docker 软件源地址：`http://mirror.ccs.tencentyun.com`。
...
REGISTRY_MIRROR="--registry-mirror=http://mirror.ccs.tencentyun.com"
```
...
```shell
sudo su echo "EXTRA_ARGS=\"–registry-mirror=http://mirror.ccs.tencentyun.com"">> /var/lib/boot2docker/profile  exit #  重启Boot2Docker
```
