...
### 第一步：创建 NAT 网关
1. 登录 [控制台](http://console.tce.fsphere.cn/)，选择顶部导航栏中的 **云产品**，选择 **云计算与网络** 下的 **私有网络**，进入 [私有网络控制台](http://console.tce.fsphere.cn/vpc/vpc?rid=8)，单击左侧导航栏中的【NAT 网关】。
...
### 第二步：配置相关子网所关联的路由表
1. 登录 [控制台](http://console.tce.fsphere.cn/)，选择顶部导航栏中的 **云产品**，选择 **云计算与网络** 下的 **私有网络**，进入 [私有网络控制台](http://console.tce.fsphere.cn/vpc/vpc?rid=8)，单击左侧导航栏中的【路由表】。
