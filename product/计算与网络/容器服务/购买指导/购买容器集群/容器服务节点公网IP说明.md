如果对业务安全有要求不希望业务直接暴露到公网，同时又希望访问公网，您可以使用 [NAT网关](/doc/product/215/4975)。下文将介绍如何使用 NAT 网关来访问公网。
## 公网 IP
...
### 第一步：创建 NAT 网关
1. 登录 [控制台](https://console.cloud.tencent.com/)，选择顶部导航栏中的 **云产品**，选择 **云计算与网络** 下的 **私有网络**，进入 [私有网络控制台](https://console.cloud.tencent.com/vpc/vpc?rid=8)，单击左侧导航栏中的【NAT 网关】。
...
### 第二步：配置相关子网所关联的路由表
1. 登录 [控制台](https://console.cloud.tencent.com/)，选择顶部导航栏中的 **云产品**，选择 **云计算与网络** 下的 **私有网络**，进入 [私有网络控制台](https://console.cloud.tencent.com/vpc/vpc?rid=8)，单击左侧导航栏中的【路由表】。
