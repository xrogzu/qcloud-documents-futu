...
* [镜像仓库（CCR）全读写访问权限](http://console.tce.fsphere.cn/cam/policy/detail/419082&QcloudCCRFullAccess&2)

    该预设策略配置了容器镜像服务所有权限，如果协作者关联该预设策略后，将与开发商拥有相同的镜像仓库权限。 详情请查看[权限列表](#权限列表)。

* [镜像仓库（CCR）只读访问权限](http://console.tce.fsphere.cn/cam/policy/detail/419084&QcloudCCRReadOnlyAccess&2)
