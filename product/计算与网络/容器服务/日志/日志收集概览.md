...
- [采集容器标准输出日志](/document/product/457/13662)  
- [采集主机文件日志](/document/product/457/13660)  
- [采集容器内文件日志](/document/product/457/13661)  
- [配置所采集日志的消费端](/document/product/457/13659)  

## 最佳实践  

基于日志收集功能，使用 Logstash 和 Elasticsearch 进行集群服务日志的可视化检索。  

为提供日志的可视化能力，建议用户使用 logstash 消费 kafka 的日志数据，并将日志数据发送到 elasticsearch 集群，查看[日志收集最佳实践](/document/product/457/13657)提供 elasticsearch 和 logstash 集群的搭建模板。
