容器服务底层基于Kubernetes编排引擎。在容器服务的应用模板中原生的支持Kubernetes的语法。本文将对Kubernetes的常用的语法做介绍。
...
更多关于Kubernetes编排描述语言的说明，可以参考[API Overview][12]
  ...
  [1]: http://kubernetes.io/docs/concepts/configuration/manage-compute-resources-container/
  [2]: http://tcecqpoc.fsphere.cn/document/product/457/10177
  [3]: http://kubernetes.io/docs/concepts/services-networking/service/
  [4]: http://tcecqpoc.fsphere.cn/document/product/457/9098
  [5]: http://kubernetes.io/docs/concepts/storage/volumes/
  [6]: http://tcecqpoc.fsphere.cn/document/product/457/11958#.E6.89.A9.E5.B1.95.E8.AF.AD.E6.B3.95---cbs.E7.9B.98.E4.BD.BF.E7.94.A8
  [7]: http://tcecqpoc.fsphere.cn/document/product/457/11956#.E8.87.AA.E5.AE.9A.E4.B9.89.E5.8F.98.E9.87.8F--releaseconfig
  [8]: http://tcecqpoc.fsphere.cn/document/product/457/9112
  [9]: http://kubernetes.io/docs/api-reference/v1.7/
  [10]: http://kubernetes.io/docs/api-reference/v1.6/
  [11]: http://kubernetes.io/docs/api-reference/v1.5/
  [12]: http://kubernetes.io/docs/reference/api-overview/