...
## 添加云主机
1. 在集群列表页中，单击右侧 **扩展节点**。
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/630fefe69ca2d2bedd779246417f8c70/image.png)

2. 设置添加云主机的所属 **网络**、**机型** 和 **配置信息**。
   允许将主机创建在同一地域下不同可用区下的不同子网中。
![Alt text](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/e701af9583d1bae708ffd4d748adb3c6/image.png)

3. 新添加的云主机将出现在 **ID/节点名** 列表中。
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/1707fa09977298f255c293aa62b1cc10/image.png)

## 销毁云主机
1. 在集群列表页中点击某集群的 **ID/名称**，进入如下界面，选择需销毁的云主机，单击右侧 **移出** 。
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/cbb99d53f194ec9121fe29d840081ab7/image.png)

2. 弹出提示页面，显示要移出的节点信息，单击【确定】删除节点。
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/e9194e2947562271931fcc429e5788f8/image.png)

## 查看节点信息

1. 在集群列表中集群的 **ID/名称** 。
2. 单击【节点列表】来查看集群节点列表信息。
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/ad5db6f3a9071235e614f856c3ef7083/image.png)

## 登录到节点
当前节点支持云主机，如何登录请查看 [登录到云主机](http://tcecqpoc.fsphere.cn/doc/product/213/5436) 。

## 创建集群 Namespace

1. 在集群列表页中选择某集群的 **ID/名称**。
2. 单击 **Namespace 列表** ，单击【新建 Namespace 】。
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/9e6973758fdeec1a6cf6b5a7d6614ab8/image.png)
3. 填写信息并单击【提交】。
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/c40e34d6235239ae4ef6ab39fbe775f0/image.png)

## 删除集群 Namespace

1. 在集群列表页中选择某集群的 **ID/名称**。
2. 单击 **Namespace 列表** ，选择需删除的 Namespace ，单击右侧【删除】。
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/f327962fd0918f7030d01fa8c6c03735/image.png)
3. 弹出提示页面，显示要删除的 Namespace 信息，单击【确定】删除 Namespace 。
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/b03914a11e8c6bfa5703eafe8017625e/image.png)
>**注意**： 
