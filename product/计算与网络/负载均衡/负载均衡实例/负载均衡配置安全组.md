...
参考[应用型负载均衡快速入门](/document/product/214/8975)，本次创建HTTP: 80监听器，并绑定后端主机，后端主机的服务端口为8080。
...
CLB配置安全组请参考 [待补充](/doc/api/229/1367) 和 [待补充](/doc/api/229/1365)

CVM配置安全组请参考 [ModifySecurityGroupsOfInstance 接口](/doc/api/229/1367) 和 [ModifySecurityGroupPolicy 接口](/doc/api/229/1365)
