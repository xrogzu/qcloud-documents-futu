...
## 4. 如何增加伸缩组最大云服务器数？
弹性伸缩一个伸缩组最多支持`200`台 CVM，同时目前云平台用户每个可用区可拥有的台按量计费类型 CVM 配额，如果希望伸缩组有超过 200 台 CVM 或者是在可用区内想使用超过 30 台按量计费类型的 CVM，请提交工单申请。
...
详见[最佳实践示例 >>](http://tcecqpoc.fsphere.cn/document/product/377/8617#step-5.-.E8.AE.BE.E7.BD.AE.E6.89.A9.E7.BC.A9.E5.AE.B9.E7.AD.96.E7.95.A5.EF.BC.88.E9.87.8D.E7.82.B9.EF.BC.81.EF.BC.89)
...
具体方法请参见：[使用自定义镜像及数据盘快照启动新实例时自动挂载数据盘的方法 >>](http://tcecqpoc.fsphere.cn/doc/product/362/5564)
