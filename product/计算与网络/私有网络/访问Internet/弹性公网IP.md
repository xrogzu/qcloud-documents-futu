...
- 安全策略无效。查看是否有生效的安全策略（ <a href="/doc/product/213/5221" target="_blank">安全组</a> 或 <a href="/doc/product/215/5132" target="_blank">网络 ACL</a> )。如果绑定的云产品实例有安全策略，例如：禁止 `8080` 端口访问，那么弹性公网 IP 的 `8080` 端口也是无法访问的。
