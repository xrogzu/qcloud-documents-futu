...
- **only-vpc**账号仅支持在VPC下创建实例（如CVM、LB等），无法在 [基础网络](http://tce.fsphere.cn/document/product/215/535)内创建实例。
- ** classic**账号可在基础网络 或 VPC下创建实例。

您可以通过接口([DescribeAccountVpcAttributes](http://tce.fsphere.cn/document/api/215/9499))用于查询账号网络属性。
