可以，但是有两个前提条件：
1. 只能在该 VPC 所在地域的可用区下创建。比如，您的 VPC 所属地域是广州，那么您可以创建广州二区和三区的云主机，但是您不可以在该 VPC 中同时创建广州二区和北京一区的云主机，<a href="http://tcecqpoc.fsphere.cn/doc/product/215/4927#.E5.8F.AF.E7.94.A8.E5.8C.BA.EF.BC.88zone.EF.BC.89" target="_blank">点击查看地域和可用区分布详情</a>
