...
> 注：您需要为 VPN 通道占用的公网带宽付费，如果您的混合云互通带宽要求大于 200M，建议您选择情 [专线接入的混合云](/document/product/215/7543) 部署方案。
...
## 操作步骤
在云平台创建的某个私有网络，部署云上数据中心，点击和查看 [操作指南](/document/product/215/4927#.E6.93.8D.E4.BD.9C.E6.8C.87.E5.8D.97)，这里不重复说明。
