云平台 FPGA 云服务器处于内测中。
- 若还未取得购买权限，请点击 [立即申请](/act/apply/fpga) 申请内测资格。
...
| 文档 | 说明 | 
|---------|---------|---------|
| [产品介绍](/document/product/565/10418) | FPGA 云服务器的简介，包括特性和功能。|
| [申请说明](/document/product/565/10448) | 内测阶段，申请使用 FPGA 云服务器的有关说明。|
| 流程说明 | 为开发者和使用服务的用户介绍开发和使用的基本流程。|
|  [API 说明](/document/product/565/8221) |  FPGA 云服务器基于 Alexnet 模型的 API 接口及使用方法说明。 |
| [Demo 使用说明](/document/product/565/8222) | FPGA 入门指引 Demo 的详细使用方法。|
| [性能测试对比](/document/product/565/8223) | FPGA 入门指引 Demo 使用 2012 年 ImageNet 比赛的 Alexnet 网络结构及模型参数文件进行性能测试的结果。|
