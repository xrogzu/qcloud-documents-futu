...
如果使用的是云平台的域名服务，可以在 **[控制台](http://console/tcecqpoc/fsphere/cn/) > 域名与网站 > 域名管理** 查看相应的域名情况。
![](http://mc.qcloudimg.com/static/img/5e95aaa3a25133e087766db94bcd9df0/image.png)
## 五. 域名解析
域名 ping 不通的另外一个原因是域名解析没有正确地配置。如果用户使用的是云平台的域名服务可以在 **[控制台](http://console/tcecqpoc/fsphere/cn/) > 域名与网站 > 域名管理**，单击对应域名的解析按钮，查看域名解析详情。
