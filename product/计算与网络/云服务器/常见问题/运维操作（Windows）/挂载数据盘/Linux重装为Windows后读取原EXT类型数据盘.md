...
![](https://mc.qcloudimg.com/static/img/b964b6d45ceb0fa4d8835ddfa88db246/image.png)
...
登录 [云 CVM 控制台](https://console.cloud.tencent.com/cvm/) ，单击左侧【云硬盘】选项卡，单击原 Linux 数据盘右侧【更多】-【挂载到云主机】按钮。在弹出框中选择重装后的 Windows 云服务器，单击【确定】。

 4. 运行 DiskInternals Linux Reader 软件，即可查看刚挂载的数据盘信息。本例中，`/root/mnt`和`/root/mnt1`分别对应分区 vdb1 和 vdb2 。
![](https://mccdn.qcloud.com/static/img/de1d02ddf0793da5911e0bece70a4993/image.png)

 5. 双击进入`/root/mnt`目录内，右键单击要拷贝的文件，选择【Save】保存文件。
![](https://mc.qcloudimg.com/static/img/b8b520159cf23b8450bc38de377a4e0f/image.png)
