...
- [登录 Linux 实例](/doc/product/213/5436)
- [登录 Windows 实例](/doc/product/213/5435)
...
您也可以选择【自动生成密码】，单击【立即购买】待实例分配成功后在 [站内信](http://console.tce.futunn.com/message) 中即可获取 CVM 实例初始密码。
...
1. 登录 [云服务器控制台](http://console.tce.futunn.com/cvm/) 。
...
1. 在 [控制台](http://console.tce.futunn.com/cvm/securitygroup) 取消或者修改安全组策略。参考：[安全组操作指南](/document/product/213/12450)

2. 在 [控制台](http://console.tce.futunn.com/cvm/sshkey) 取消密钥登录方式，或根据指导正确设置密钥验证登录机器。参考：[SSH 密钥操作指南](/document/product/213/16691)
