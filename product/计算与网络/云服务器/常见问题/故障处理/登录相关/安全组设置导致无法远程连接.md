...
> - 如果已修改过远程连接端口，使用修改后的端口测试。
	...
	![](http://imgcache.tce.fsphere.cn/image/mc.qcloudimg.com/static/img/1fe17b76d99905024d0e5e048000d9f4/image.png)
...
## 步骤二：检查安全组设置
 ...
 3. 单击【安全组】（非左侧导航栏），检查入站规则。以下图为例，检查发现安全组没有开放 3389 端口（系统则检查），只开了 ICMP 协议，所以云服务器是可以 Ping 通，但 Telnet 测试失败。
	![](http://imgcache.tce.fsphere.cn/image/mc.qcloudimg.com/static/img/2fdcf758994c7194f12d2fb627bac4e6/image.png)
...
2. 单击【添加规则】。
	![](http://imgcache.tce.fsphere.cn/image/mc.qcloudimg.com/static/img/f6e3be97451d3a1aa777696e56acf4cc/image.png)
...
3. 输入：
 ...
  - 选择策略：允许。
  - 单击【完成】。
	![](http://imgcache.tce.fsphere.cn/image/mc.qcloudimg.com/static/img/deb951ec299d221e0895656e04b40cbf/image.png)
