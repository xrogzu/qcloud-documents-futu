...
1. 使用系统自带资源管理器查看带宽使用情况。
  直接打开任务管理器，或者在桌面执行【开始】，在搜索框中输入 `taskmgr` 语句。
	![](http://imgcache.tce.fsphere.cn/image/mc.qcloudimg.com/static/img/73e33e7e59e266929791f1836b845476/16.png)
2. 根据消耗带宽的进程来进行判断：
 - 如果是正常业务进程，则需要针对分析。
...
![](http://imgcache.tce.fsphere.cn/image/mc.qcloudimg.com/static/img/fa829adea82ec701049f9c043646625e/4.png)
