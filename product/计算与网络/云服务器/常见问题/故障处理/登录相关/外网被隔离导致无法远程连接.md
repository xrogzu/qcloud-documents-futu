...
详见 [云安全违规事件的等级划分及处罚说明](http://tcecqpoc.fsphere.cn/document/product/301/2003) 。

## 解决办法

 1. 按照站内信或者短信提示处理违规内容。处理好安全隐患，必要时重做系统。

 2. 如果不是您个人行为导致的违规，那么您的服务器有可能已被恶意入侵，解决方案请参考： [主机安全](http://tcecqpoc.fsphere.cn/document/product/296) 。
