...
1. 登录 [云平台服务购买页](https://buy.tcecqpoc.fsphere.cn/cvm?tab=custom&regionId=1&zoneId=0&step=1&bandwidthType=BANDWIDTH_PREPAID) 自定义配置页面。
...
若推荐的配置不能满足您的需求，您可以在 [【更多机型】](https://buy.tcecqpoc.fsphere.cn/cvm?tabIndex=1) 中根据实际需要比较各配置方案。当然您也可以在购买云服务器之后，根据您的需求随时进行 [配置升级](http://tcecqpoc.fsphere.cn/document/product/213/2178#.E9.85.8D.E7.BD.AE.E5.8D.87.E7.BA.A7)  或 [配置降级](http://tcecqpoc.fsphere.cn/document/product/213/2178#.E9.85.8D.E7.BD.AE.E9.99.8D.E7.BA.A7)。
