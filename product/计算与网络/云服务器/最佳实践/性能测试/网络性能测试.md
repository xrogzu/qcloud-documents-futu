...
```
![图2](https://mc.qcloudimg.com/static/img/64414e211229273fc3ccc43022bcda66/image.png)
### 带宽测试
...
iperf -s
```
![图3](https://mc.qcloudimg.com/static/img/f0837a11ef7db3ed6b83b81a45d73a07/image.png)
#### 客户端测试流程
按以下格式输入命令：
```
iperf -c <服务器IP地址> -b 2G -t 300 -P <网卡队列数目>
```
![图4](https://mc.qcloudimg.com/static/img/6513b5185ef86c817e8dbbef0df496cb/image.png)
>**注意：**
...
sar -n DEV 2
```
![图5 TCP-RR测试Server端](https://mc.qcloudimg.com/static/img/032b457a871a0e7d0ce1ec4e6dfbb903/image.png)
...
sar -n DEV 2
```
![图 6 TCP-RR Client端](https://mc.qcloudimg.com/static/img/92b1e39805fa8aabf76d778383efe387/image.png)
如上图所示，填写说明如下：
- 在`-H`后填写服务器的内网 IP 地址；
- 在`-l`后填写测试时间 300s；
- 在`-t`后填写测试方法 TCP_RR；
...
sar -n DEV 2
```
![图 7 TCP-CRR Client端](https://mc.qcloudimg.com/static/img/9990f80f301bbb0ddec3cf6475095100/image.png)
...
2. 下载后解压如图：
![图 9 windows iperf](https://mc.qcloudimg.com/static/img/bddabeb2c4c11d2c1dbc6d3f96f32f86/image.png)
3. 通过 PowerShell 或者 CMD 工具使用 iPerf ，命令使用方法与 Linux 下一致。
![图 10 powershell 使用示例](https://mc.qcloudimg.com/static/img/de9707fdfc4ec4deb2096b6e9950a35f/image.png)
...
![图 11 Netperf windows端](https://mc.qcloudimg.com/static/img/59d302982a1e3bfce1a02dfb6b25ed5b/image.png)
