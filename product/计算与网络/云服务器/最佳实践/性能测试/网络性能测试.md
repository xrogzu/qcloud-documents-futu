...
```
#### 2. 安装 Netperf
2.1 下载 Netperf 压缩包（也可以从 Github 下载最新版本：[Netperf](http://github.com/HewlettPackard/netperf) ）。
```
wget -c http://codeload.github.com/HewlettPackard/netperf/tar.gz/netperf-2.5.0 
```
...
- Netperf 完整使用文档请参考 http://hewlettpackard.github.io/netperf/training/Netperf.html 。
...
### Windows下 iPerf 安装帮助
1. iPerf 安装包下载页面链接：[iPerf 下载页面](http://iperf.fr/iperf-download.php)。本示例下载的是 iPerf 3.1.3 版本。
2. 下载后解压如图：
...
- [WDK](http://developer.microsoft.com/en-us/windows/hardware/windows-driver-kit)

#### 2. 通过 GitHub 下载 Netperf 最新版源码。
[GitHub 链接](http://github.com/HewlettPackard/netperf)
