...
命令：
```
curl http://metadata.tcecqpoc.fsphere.cn/
```
返回值如下：
...
命令：
```
curl http://metadata.tcecqpoc.fsphere.cn/meta-data
```
返回值如下：
...
命令：
```
curl http://metadata.tcecqpoc.fsphere.cn/meta-data/public-ipv4
```
返回值如下：
...
命令：
```
curl http://metadata.tcecqpoc.fsphere.cn/meta-data/uuid
```
返回值如下：
...
命令：
```
curl http://metadata.tcecqpoc.fsphere.cn/meta-data/instance-id
```
返回值如下：
...
命令：
```
curl http://metadata.tcecqpoc.fsphere.cn/meta-data/mac
```
返回值如下：
...
命令：
```
curl http://metadata.tcecqpoc.fsphere.cn/meta-data/placement/region
```
返回值如下：
...
命令：
```
curl http://metadata.tcecqpoc.fsphere.cn/meta-data/placement/zone
```
返回值如下：
...
命令：
```
curl http://metadata.tcecqpoc.fsphere.cn/meta-data/network/
```
返回值如下：
...
命令：
```
curl http://metadata.tcecqpoc.fsphere.cn/meta-data/network/interfaces/macs
```
返回值如下：
...
命令：
```
curl http://metadata.tcecqpoc.fsphere.cn/meta-data/network/interfaces/macs/52:54:00:13:5C:6C/
```
返回值如下：
...
命令：
```
curl http://metadata.tcecqpoc.fsphere.cn/meta-data/network/interfaces/macs/52:54:00:13:5C:6C/local-ipv4s
```
返回值如下：
...
命令：
```
curl http://metadata.tcecqpoc.fsphere.cn/meta-data/network/interfaces/macs/52:54:00:13:5C:6C/mac
```
返回值如下：
...
命令：
```
curl http://metadata.tcecqpoc.fsphere.cn/meta-data/network/interfaces/macs/52:54:00:13:5C:6C/primary-local-ipv4
```
返回值如下：
...
命令：
```
curl http://metadata.tcecqpoc.fsphere.cn/meta-data/network/interfaces/macs/52:54:00:13:5C:6C/public-ipv4s
```
返回值如下：
...
命令：
```
curl http://metadata.tcecqpoc.fsphere.cn/meta-data/network/interfaces/macs/52:54:00:13:5C:6C/local-ipv4s/10.104.187.40/
```
返回值如下：
...
命令：
```
curl http://metadata.tcecqpoc.fsphere.cn/meta-data/network/interfaces/macs/52:54:00:13:5C:6C/local-ipv4s/10.104.187.40/gateway
```
返回值如下：
...
命令：
```
curl http://metadata.tcecqpoc.fsphere.cn/meta-data/network/interfaces/macs/52:54:00:13:5C:6C/local-ipv4s/10.104.187.40/local-ipv4
```
返回值如下：
...
命令：
```
curl http://metadata.tcecqpoc.fsphere.cn/meta-data/network/interfaces/macs/52:54:00:13:5C:6C/local-ipv4s/10.104.187.40/public-ipv4
```
返回值如下：
...
命令：
```
curl http://metadata.tcecqpoc.fsphere.cn/meta-data/network/interfaces/macs/52:54:00:13:5C:6C/local-ipv4s/10.104.187.40/public-ipv4-mode
```
返回值如下：
...
命令：
```
curl http://metadata.tcecqpoc.fsphere.cn/meta-data/network/interfaces/macs/52:54:00:13:5C:6C/local-ipv4s/10.104.187.40/subnet-mask
```
返回值如下:
