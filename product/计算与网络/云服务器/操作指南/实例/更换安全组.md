...
>**注意：**
>如果您要将实例配置新的安全组，请先新建安全组，具体操作，请参考[创建安全组](http://tcecqpoc.fsphere.cn/document/product/213/12450)。


## 操作步骤


- 进入[云主机控制台](http://console.tcecqpoc.fsphere.cn/cvm/index)，选中要被重新分配至新的安全组的云服务器（单台）。
