...
![](http://imgcache.tce.fsphere.cn/image/mccdn.qcloud.com/static/img/92a187945b9f4318981ea70b6532e1d6/image.png)

- 在 Linux 操作系统下，您需要先登录实例，并对需要卸载的弹性云硬盘进行` unmount `操作，命令执行成功后再进入控制台对磁盘进行卸载操作。若未进行unmount操作直接被强制解挂后，关机时和开机时可能会出现以下问题： 
![](http://imgcache.tce.fsphere.cn/image/mccdn.qcloud.com/static/img/9939fccce6e6d9ead64b5703455d4403/image.png)
![](http://imgcache.tce.fsphere.cn/image/mccdn.qcloud.com/static/img/9939fccce6e6d9ead64b5703455d4403/image.png)
