...
![](http://imgcache.tcecqpoc.fsphere.cn/image/mccdn.qcloud.com/static/img/972969e3db92b65311211734690fe763/image.png)
![](http://imgcache.tcecqpoc.fsphere.cn/image/mccdn.qcloud.com/static/img/2c1f4a40279d211a7b81bada7ed38280/image.png)

若结果如下图所示（根据操作系统不同略有不同），则说明云服务器扩容前为MBR分区方式，后续操作请参见MBR分区云硬盘扩容后修改分区指南。
![](http://imgcache.tcecqpoc.fsphere.cn/image/mccdn.qcloud.com/static/img/4d789ec2865a2895305f47f0513d4e2b/image.png)
...
![](http://imgcache.tcecqpoc.fsphere.cn/image/mccdn.qcloud.com/static/img/cf51cda9a12085f76949ab0d5dd0fbfc/image.png)
![](http://imgcache.tcecqpoc.fsphere.cn/image/mccdn.qcloud.com/static/img/01a0a7a8fdfe6f05f2739f0326a74ef9/image.png)
...
mount | grep '磁盘路径' 
```
![](http://imgcache.tcecqpoc.fsphere.cn/image/mccdn.qcloud.com/static/img/edc5bbd6834e1dd929ce0eb00acd53ca/image.png)
...
![](http://imgcache.tcecqpoc.fsphere.cn/image/mccdn.qcloud.com/static/img/a2f6db45a94485785ea15e6ea950bcb8/image.png)
...
![](http://imgcache.tcecqpoc.fsphere.cn/image/mccdn.qcloud.com/static/img/788ce125bba952f204ed6ee36dfb644d/image.png)
...
![](http://imgcache.tcecqpoc.fsphere.cn/image/mccdn.qcloud.com/static/img/fc54fd4c05102ee91c648526d77d1b42/image.png)
...
![](http://imgcache.tcecqpoc.fsphere.cn/image/mccdn.qcloud.com/static/img/67ba54c1d9d63c307d4b8a157b70c722/image.png)
...
![](http://imgcache.tcecqpoc.fsphere.cn/image/mccdn.qcloud.com/static/img/3384eeada87ce75695e0e55125109eff/image.png)

输入`mkpart primary [原分区起始扇区] 100%`新建一个主分区。本例中使用`mkpart primary 2048s 100%`，此主分区从第2048个扇区开始（必须与删除之前的分区一致），100%表示此分区到磁盘的最末尾。

如果出现如图状态请输入Ignore：
![](http://imgcache.tcecqpoc.fsphere.cn/image/mccdn.qcloud.com/static/img/c45966e20dc856817c65fd6b81155e4a/image.png)

再次输入`print`可发现新分区已经新建成功，输入`quit`即可退出parted工具：
![](http://imgcache.tcecqpoc.fsphere.cn/image/mccdn.qcloud.com/static/img/cb1af5adaf6c89d066077c43fd428a38/image.png)
...
![](http://imgcache.tcecqpoc.fsphere.cn/image/mccdn.qcloud.com/static/img/307f7a0c98eea05ca1d4560fe4e96f57/image.png)
...
resize2fs 分区路径
```
![](http://imgcache.tcecqpoc.fsphere.cn/image/mccdn.qcloud.com/static/img/57d66da9b5020324703498dbef0b12f9/image.png)
...
![](http://imgcache.tcecqpoc.fsphere.cn/image/mccdn.qcloud.com/static/img/a2bd04c79e8383745689e19033a0daaa/image.png)
...
![](http://imgcache.tcecqpoc.fsphere.cn/image/mccdn.qcloud.com/static/img/0a450dfaa9cfc7b2c7fdc04861f0e754/image.png)
![](http://imgcache.tcecqpoc.fsphere.cn/image/mccdn.qcloud.com/static/img/594671a1215dee3036b7940892438f62/image.png)
...
![](http://imgcache.tcecqpoc.fsphere.cn/image/mccdn.qcloud.com/static/img/8c35d6f4dfb367e74edc27ce6822c317/image.png)
...
![](http://imgcache.tcecqpoc.fsphere.cn/image/mccdn.qcloud.com/static/img/e04e924d62317bc2c605c8abaac394f5/image.png)
这里新的分区xvdc2已经创建完成。

#### 格式化新分区并创建文件系统
在进行分区格式化时，用户可以自行决定文件系统的格式，如ext2、ext3等。这里以“ext3”为例，使用命令`mkfs.ext3 /dev/xvdc2`对新分区进行格式化。 

![](http://imgcache.tcecqpoc.fsphere.cn/image/mccdn.qcloud.com/static/img/074e23eaa580495f96fb532b688d2d68/image.png)
...
![](http://imgcache.tcecqpoc.fsphere.cn/image/mccdn.qcloud.com/static/img/7b749a4bb6e7c8267c9354e1590c35d4/image.png)
...
![](http://imgcache.tcecqpoc.fsphere.cn/image/mccdn.qcloud.com/static/img/f0b5c14bf08fd3629ddf6d9b1ae01ffc/image.png)
...
![](http://imgcache.tcecqpoc.fsphere.cn/image/mccdn.qcloud.com/static/img/c0acc05057941681627a5fd34979d194/image.jpg)
...
![](http://imgcache.tcecqpoc.fsphere.cn/image/mccdn.qcloud.com/static/img/c7617b90578192d64d19f02325f00ffb/image.jpg)
...
![](http://imgcache.tcecqpoc.fsphere.cn/image/mccdn.qcloud.com/static/img/2367f3e70cd0c3c1bef665cc47c1c3bc/image.jpg)
