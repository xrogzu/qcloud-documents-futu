...
## 前提条件
 ...
 1. 开始自定义配置前，您需完成[【快速入门 Linux 云服务器】](/document/product/213/2936#.E6.AD.A5.E9.AA.A4.E4.B8.80.EF.BC.9A.E5.87.86.E5.A4.87.E4.B8.8E.E9.80.89.E5.9E.8B)文档中的步骤一。
...
![](//mc.qcloudimg.com/static/img/fd40922e47525453a58de73d0ffa266c/image.png)
 1. 选择镜像提供方。
云平台提供公共镜像、自定义镜像、共享镜像、服务市场，您可参考 [镜像类型](/document/product/213/4941) 进行选择。
...
单击 [这里](/document/product/213/2936#.E6.AD.A5.E9.AA.A4.E4.B8.89.EF.BC.9A.E7.99.BB.E5.BD.95-linux-.E4.BA.91.E6.9C.8D.E5.8A.A1.E5.99.A8) ，继续 Linux 云服务器的登录、格式化与分区数据盘等后续配置。
