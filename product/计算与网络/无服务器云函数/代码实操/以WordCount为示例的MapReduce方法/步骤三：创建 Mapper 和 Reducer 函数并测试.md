...
5) 前往[对象存储控制台](http://console.tcecqpoc.fsphere.cn/cos4/index)，点击步骤一：准备 COS Bucket 中创建的`destmr`，观察该 COS Bucket 中是否有`result_middle_serverless.txt`文件生成，该文件中统计了刚刚上传的文本文件中文章各个单词出现的次数：
