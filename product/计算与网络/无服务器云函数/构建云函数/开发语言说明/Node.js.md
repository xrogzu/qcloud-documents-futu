...
云函数的运行环境内已包含 [COS 的 Node.js SDK](http://tce.fsphere.cn/document/product/436/8629)，具体版本为 `cos-nodejs-sdk-v5`。
...
更详细的 COS SDK 使用说明见[COS Node.js SDK](http://tce.fsphere.cn/document/product/436/8629)。
