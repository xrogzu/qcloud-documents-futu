...
云函数的运行环境内已包含 [COS 的 Python SDK](http://tce.fsphere.cn/document/product/436/6275)，具体版本为 `cos_sdk_v4`。
...
更详细的 COS SDK 使用说明见[COS Python SDK 说明](http://tce.fsphere.cn/document/product/436/6275)。
