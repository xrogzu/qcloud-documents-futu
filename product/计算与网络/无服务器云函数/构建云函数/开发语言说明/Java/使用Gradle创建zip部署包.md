...
具体安装方法可见 [http://gradle.org/install/](http://gradle.org/install/)，以下说明手工安装过程：
1. 下载 Gradle 的 [二进制包](http://services.gradle.org/distributions/gradle-4.1-bin.zip) 或 [带文档和源码的完整包](http://services.gradle.org/distributions/gradle-4.1-all.zip)。
...
4. 通过在命令行下执行 `gradle -v`，确认有如下类似输出，证明 Gradle 已正确安装。如有问题，请查询 Gradle 的[官方文档](http://gradle.org/docs/)。
	```
	------------------------------------------------------------
	Gradle 4.1
	------------------------------------------------------------
