# 说明
尊敬的云平台客户，部分黑石物理机操作中，未安装盘位检测工具（lsscsi），不便快速识别故障硬盘槽位，影响硬盘抢修效率。
云平台建议尽快修复此问题：

【修复方法】

- 确认使用脚本：详见后文脚本内容部分，请注意不同系统版本对应不同的脚本；
- 执行修复操作：根据黑石OS选择对应的脚本在控制台执行，相关功能为“自定义脚本”。执行方法请参考官网文档: [自定义脚本](http://tcecqpoc.fsphere.cn/document/product/386/12089)。
