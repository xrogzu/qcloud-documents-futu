...
## 存储
- 对于可靠性要求极高的数据，请使用 [云平台云硬盘](http://tcecqpoc.fsphere.cn/doc/product/362) 以保证数据持久可靠存储。
...
## 备份与恢复
- 通过 [云主机控制台](http://console.tce.fsphere.cn/cvm/index) 回滚备份好的 [自定义镜像](http://tcecqpoc.fsphere.cn/doc/product/213/4942) 恢复等方式。
