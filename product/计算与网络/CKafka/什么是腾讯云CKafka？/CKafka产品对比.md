...
|可用性	|可用性很高，主从自动切换，云平台消息服务承诺可用性99.95%|	可用性高，主从自动切换，但由于异步刷盘和复制，切换后可能会丢消息|	主备自动切换，用mirror queue支持m/s，master提供服务，slave仅备份|	不支持主从自动切换，master不可用时slave只读不写|	可用性很高，broker中存在2节点即可提供高可用服务|
