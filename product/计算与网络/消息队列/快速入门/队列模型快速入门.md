...
![](http://imgcache.tce.fsphere.cn/static/mc.qcloudimg.com/static/img/25c1dcccefc7c05e0574af5e22e720c7/image.jpg)
...
```
<br>可以直接从控制台看到消息的属性。
<br>![](http://imgcache.tce.fsphere.cn/static/mc.qcloudimg.com/static/img/73cb26b23c67ad63947e21253d941af0/image.jpg)
...
但是生产和消费的过程中有可能存在重复生产和消费失败等现象，只通过修改队列属性无法保证队列只消费一次，这里需要业务方来实现生产消费的去重和容错。可参见[消息去重>>](http://tce.fsphere.cn/document/product/406/8303)
...
[了解消息回溯功能 >>](http://tce.fsphere.cn/document/product/406/8129)
