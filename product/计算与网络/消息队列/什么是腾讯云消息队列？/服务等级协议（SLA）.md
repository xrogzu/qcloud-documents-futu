...
目前用户 CMQ 服务部署在六大数据中心，分别是：上海数据中心、广州数据中心、北京数据中心、香港数据中心、新加坡数据中心、北美数据中心。
...
云平台 CMQ Queue 具备故障迁移能力，可在物理服务器故障发生时，自动将业务迁移至新的母机，无需用户参与，保证客户服务的连续性。同时，云平台提供专业团队`7x24小时`帮助维护。
...
后付费：赔偿方式是补偿现金券，`现金券金额 = 故障 Queue 每天费用 ÷ 24 ÷ 60 × 故障时间（以分钟为单位） × 100`。赔偿现金券的上限，不超过 CMQ 服务的总费用。
