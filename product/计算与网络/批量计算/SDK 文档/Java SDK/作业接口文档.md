## 开发准备
- 下载和安装 [Java SDK](http://tce.fsphere.cn/document/sdk/Java) 。
- 首次使用批量计算，参考 [开始前的准备](http://tce.fsphere.cn/document/product/599/10807)。
- 了解更多作业配置参数，参考 [提交作业 API 文档](http://tce.fsphere.cn/document/product/599/12683)。
...
```
更多参数说明及错误信息，详见 [提交作业 API 文档](http://tce.fsphere.cn/document/product/599/12683)。
...
```
更多参数说明及错误信息，详见 [终止作业 API 文档](http://tce.fsphere.cn/document/product/599/12689)。
...
```
更多参数说明及错误信息，详见 [删除作业 API 文档](http://tce.fsphere.cn/document/product/599/12682)。
...
```
更多参数说明及错误信息，详见 [查看作业的提交信息 API 文档](http://tce.fsphere.cn/document/product/599/12687)。
...
```
更多参数说明及错误信息，详见 [查看作业信息 API 文档](http://tce.fsphere.cn/document/product/599/12685)。
...
```
更多参数说明及错误信息，详见 [查看作业列表 API 文档](http://tce.fsphere.cn/document/product/599/12686)。
...
```
更多参数说明及错误信息，详见 [查看任务信息 API 文档](http://tce.fsphere.cn/document/product/599/12684)。
...
```
更多参数说明及错误信息，详见 [终止任务实例 API 文档](http://tce.fsphere.cn/document/product/599/12688)。
