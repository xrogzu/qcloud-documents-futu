...
作业的相关说明，请参考 [名词解释](http://tcecqpoc.fsphere.cn/document/product/599/10396) 中“作业”。您可以通过 [批量计算控制台](http://console.tcecqpoc.fsphere.cn/batch/task) 创建作业。
...
## 终止作业
您可以在特定条件下终止作业的运行。终止相关的说明，请参考 API 文档 [终止任务实例](http://tcecqpoc.fsphere.cn/document/product/599/12688) 。
