...
## 1. 前置准备
请根据 [前置准备](http://tcecqpoc.fsphere.cn/document/product/599/10548) 里的说明完成准备，并了解如何配置自定义信息里的通用部分。
...
* Command：任务启动命令，这里直接调用了软件包里的一个 Python 脚本文件，你可以下载软件包并查看里面的文件结构和内容
...
## 4. 查看状态
参考 [简单开始](http://tcecqpoc.fsphere.cn/document/product/599/10551) 同名章节
