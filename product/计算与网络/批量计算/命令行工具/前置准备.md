...
![Alt text](http://imgcache.tce.fsphere.cn/static/mc.qcloudimg.com/static/img/ab7aea426d53f31f6bb1fc84bd2ce177/1.png)

## 3. 准备 COS 目录
### I. 创建 Bucket 和子文件夹
![](http://imgcache.tce.fsphere.cn/static/mc.qcloudimg.com/static/img/ecb3282f6cf12b371925743d9efa3874/COS_1.png)
创建一个 Bucket，命名随意，在 Bucket 里再创建 3 个文件夹以便后续使用，文件夹名字见上图。

### II. 记好 COS 访问的地址
![](http://imgcache.tce.fsphere.cn/static/mc.qcloudimg.com/static/img/0a0a2a781ed55febaecc2531fbe4f592/COS_2.png)
