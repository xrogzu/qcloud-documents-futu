...
5. 验证卷是否已附加到客户端机器 (启动程序)。使用以下命令。
	...
	```
	启动程序设置完毕后，我们强烈建议您按[在 Linux 客户端上使用卷-优化配置](/document/product/581/12272#.E4.BC.98.E5.8C.96.E9.85.8D.E7.BD.AE)中推荐的设置进行 iSCSI 配置调优。
...
1. 要将已归档磁带取回到磁带网关。您可以在 CSG 控制台，选中 "磁带列表", 找到相应的已归档磁带，点击【取回】，详细操作步骤请参考[磁带取回](/document/product/581/12507#.E7.A3.81.E5.B8.A6.E5.8F.96.E5.9B.9E)。 
