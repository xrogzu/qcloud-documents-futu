COS 中所有的资源都是以独立对象的形式来存储，为了方便用户，可采用Folder形式对对象进行管理。

进入 COS 管理控制台，选择左侧 **Bucket列表** 功能页，进入需要创建Folder的 Bucket，点击 **创建Folder** ：

![](http://imgcache.tce.fsphere.cn/image/mccdn.qcloud.com/static/img/f0262c2794a20a5a9c17eadf95e36694/image.jpg)

输入Folder名称，Folder名称请保持在 20 个字符以内，同时注意不支持保留符号和保留字段：

![](http://imgcache.tce.fsphere.cn/image/mccdn.qcloud.com/static/img/3fca2e02cd8d98aa6cb2e45a4a26ce55/image.png)
