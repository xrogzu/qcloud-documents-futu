...
## Object名称
云平台 COS 中上传的Object需具有合法的名称，它在 Bucket 中唯一地标识该 Object。在控制台Bucket Object 列表中可以遍历 Object 名称。Object 名称是采用 Unicode 字符，虽然可以在名称中使用任何 UTF-8 字符，但是每个应用程序对特殊字符的分析方式可能不同。以下原则有助于最大程度符合 DNS、Web 安全字符、XML 分析器和其他 API 的要求。
...
## Object地址
Object的访问地址都是基于 Bucket 的访问地址和Object名称的，云平台的Object访问地址构成为 `Bucket域名+“/“+Object名称`，有关Bucket的域名可以参考 [Bucket 域名管理](/doc/product/436/6252)。
