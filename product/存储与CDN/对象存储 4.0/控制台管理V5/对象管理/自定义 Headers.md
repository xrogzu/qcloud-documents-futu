...
![设置HTTP头部1](http://imgcache.tce.fsphere.cn/image/mc.qcloudimg.com/static/img/f9fe9cdf0d3535cc4bc93547ab7bd84c/image.png)
3. 单击【添加Header】，选择需要设置的参数类型（自定义内容需输入自定义名称），输入对应的值。单击【保存】即可。
![设置HTTP头部2](http://imgcache.tce.fsphere.cn/image/mc.qcloudimg.com/static/img/e490a107dadd5d477584a8accbc746e9/image.png)
...
添加如下配置：
![设置HTTP头部3](http://imgcache.tce.fsphere.cn/image/mc.qcloudimg.com/static/img/bcba7754ca585143371935a9f4f0228a/image.png)
