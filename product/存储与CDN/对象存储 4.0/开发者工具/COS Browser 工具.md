...
## 软件界面
![cosbrowser](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/8016e3fb792856f8e28b9a35877d1767/image.png)
## 下载与安装
...
用户可使用云 API 密钥 SecretId 和 SecretKey 进行登录，该密钥可在 [访问管理控制台](http://console.tcecqpoc.fsphere.cn/cam/capi) 获取，登录后会保留登录信息。
