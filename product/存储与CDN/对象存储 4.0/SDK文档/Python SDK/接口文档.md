...
| AllowedOrigin |设置允许的访问来源，如 `"http://tcecqpoc.fsphere.cn"`，支持通配符 * |Dict|是|
...
| -------------- | -------------- |---------- |
 ...
 | AllowedOrigin  | 允许的访问来源，如 `"http://tcecqpoc.fsphere.cn"`，支持通配符 *  | Dict | 
...
| -------------- | -------------- |---------- | ----------- |
 ...
 |  Expiration  |  设置 Object 过期规则，可以指定天数 Days 或者指定日期 Date，Date的格式必须是GMT ISO 8601，且带上对应的时区，比如 2018-10-31T00:00:00+08:00| Dict |  否 |
 |  Transition  | 设置 Object 转换存储类型规则，可以指定天数 Days 或者指定日期 Date，Date的格式必须是GMT ISO 8601，且带上对应的时区，比如 2018-10-31T00:00:00+08:00。StorageClass 可选 Standard_IA， Nearline | Dict |  否 | 
