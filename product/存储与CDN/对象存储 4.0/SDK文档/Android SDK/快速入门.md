...
4. 从 [COS v5 控制台](http://console.tcecqpoc.fsphere.cn/cos4/secret) 获取 APPID、SecretId、SecretKey。
...
在使用 SDK 时，SDK 中已提供了签名获取类，只需要继承 BasicLifecycleCredentialProvider 类，并重写 fetchNewCredentials() 方法，从而获取 SecretId，SecretKey， SecretKey Duration；若是使用临时密钥发送请求，则需要获取tempSecretKey, tempSecrekId, sessionToken, expiredTime，关于如何通过CAM获取临时密钥，请参考[快速搭建移动应用传输服务](/document/product/436/9068)。
