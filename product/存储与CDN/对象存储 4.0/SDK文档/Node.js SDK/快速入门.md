...
1. 更多例子请参阅 [XML Node.js SDK Demo](http://github.com/tencentyun/cos-nodejs-sdk-v5/blob/master/demo/) 。
2. 完整接口文档请参阅 [XML Node.js SDK 接口文档](http://tcecqpoc.fsphere.cn/document/product/436/12264)。
