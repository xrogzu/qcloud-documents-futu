...
3. 去您的控制台获取 AppId, SecretId, SecretKey, 地址在 http://console.tcecqpoc.fsphere.cn/capi
...
* **data** —— (Object)： 请求成功时返回的对象，如果请求发生错误，则为空。
  * Buckets —— (Array) ：说明本次返回的Bucket列表的所有信息
    ...
    * Location —— (String) ： Bucket 所在区域。枚举值请见：[Bucket 地域信息](http://tcecqpoc.fsphere.cn/document/product/436/6224)
