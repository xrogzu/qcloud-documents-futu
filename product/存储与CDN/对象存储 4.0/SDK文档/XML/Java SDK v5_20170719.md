...
### 相关资源
v5 版本 COS Java SDK 相关资源地址：[github项目](http://github.com/tencentyun/cos-java-sdk-v5)
...
- **源码安装**
从 [github](http://github.com/tencentyun/cos-java-sdk-v5) 项目资源中下载源码, 通过 maven 导入项目中。比如 eclipse，选择 File->Import->maven->Existing Maven Projects，确认即可。
