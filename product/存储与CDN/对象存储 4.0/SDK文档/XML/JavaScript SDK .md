...
2. 去您的控制台获取 AppId, SecretId, SecretKey, 地址在 `http://console.tce.fsphere.cn/capi`
3. 请您到控制台操作，**针对您要操作的bucket进行跨域（CORS）设置**, 可以按照如下范例，**修改允许的来源 Origin 和 Headers**, 控制台地址在 `http://console.tce.fsphere.cn/cos`，默认可以进行如下配置
