...
下文中出现的 SecretId、SecretKey、Bucket、Region 等名称的含义和获取方式请参考：[COS 术语信息](http://tce.fsphere.cn/document/product/436/7751)
...
| - Region | Bucket 所在区域。枚举值请见：[Bucket 地域信息](http://tce.fsphere.cn/document/product/436/6224) | String |
