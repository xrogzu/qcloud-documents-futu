...
## 使用方法
### 使用 REST API
您可以直接使用 REST API 发起一个删除存储桶请求，可参考 [Delete Bucket 文档说明](http://tcecqpoc.fsphere.cn/document/product/436/7732)。

### 使用 Java SDK

对象存储 COS 的 Java SDK 中提供了此方法，可参考 [Java SDK 接口文档 Delete Bucket 部分](http://tcecqpoc.fsphere.cn/document/product/436/12263#delete-bucket)。
