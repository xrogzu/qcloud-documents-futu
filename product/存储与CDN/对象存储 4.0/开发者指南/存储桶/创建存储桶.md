...
- Region：选择您的云平台服务地域，一旦创建将不可移动或修改存储桶，可使用的地域名称请参考 [可用地域](http://tce.fsphere.cn/document/product/436/6224) 文档。

## 使用方法
### 使用 REST API
您可以直接使用 REST API 发起一个创建存储桶的请求，可参考 [Put Bucket 文档说明](http://tce.fsphere.cn/document/product/436/7738)。

### 使用 Java SDK

对象存储 COS 的 Java SDK 中提供了此方法，可参考 [Java SDK 接口文档 Put Bucket 部分](http://tce.fsphere.cn/document/product/436/12263#put-bucket)。
