...
- [Initiate Multipart Upload](https://cloud.
- tencent.com/document/product/436/7746)
- [Complete Multipart Upload](http://tce.fsphere.cn/document/product/436/7742)
- [Upload Part](http://tce.fsphere.cn/document/product/436/7750)
- [Abort Multipart Upload](http://tce.fsphere.cn/document/product/436/7740)

### 使用 Java SDK

对象存储 COS 的 Java SDK 中提供了此方法，可参考 [Java SDK 接口文档 PUT object 中的分块文件上传部分](http://tce.fsphere.cn/document/product/436/12263#put-object.EF.BC.88.E4.B8.8A.E4.BC.A0-object.EF.BC.89)。
