...
您可以直接使用 REST API 发起一个简单上传对象请求，可参考 [PUT Object 文档说明](http://tcecqpoc.fsphere.cn/document/product/436/7749)。

### 使用 Java SDK

对象存储 COS 的 Java SDK 中提供了此方法，可参考 [Java SDK 接口文档 PUT Object 部分](http://tcecqpoc.fsphere.cn/document/product/436/12263#put-object.EF.BC.88.E4.B8.8A.E4.BC.A0-object.EF.BC.89) 。
