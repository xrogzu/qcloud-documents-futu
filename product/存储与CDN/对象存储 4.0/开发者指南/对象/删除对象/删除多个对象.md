...
您可以直接使用 REST API 发起一个获取对象请求，可参考 [Delete Multiple Object 文档说明](http://tce.fsphere.cn/document/product/436/8289)。

### 使用 Java SDK

对象存储 COS 的 Java SDK 中提供了此方法，可参考 [Java SDK 接口文档 Delete Object 部分](http://tce.fsphere.cn/document/product/436/12263#delete-object)。
