...
具体适用场景参见[签名适用场景](http://tcecqpoc.fsphere.cn/doc/product/227/%E7%AD%BE%E5%90%8D%E7%AE%97%E6%B3%95#4-签名适用场景)。
...
1) 登录 [云对象存储](http://console.tce.fsphere.cn/cos), 进入云对象存储空间；
