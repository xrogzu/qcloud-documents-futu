...
## 设置步骤
1. 登录 [对象存储控制台](http://console.tcecqpoc.fsphere.cn/cos4/index)，进入左侧菜单栏【Bucket 列表】，选择需要设置防盗链的存储桶（如 example），进入存储桶。 
...
![防盗链设置2](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/26a0d84534965325ca6902d7262181a8/image.png)
