...
**解析域名**
1. 添加自定义域名后，还需进行域名解析。请登录 [域名服务控制台](http://console.tcecqpoc.fsphere.cn/cns/domains)，单击左侧菜单栏【我的域名】进入全部域名页面。单击【添加解析】，弹出添加解析对话框。
...
3. 登录 [域名服务控制台](http://console.tcecqpoc.fsphere.cn/domain)，单击左侧菜单栏【我的域名】进入全部域名页面。单击【添加解析】，弹出添加解析对话框。
