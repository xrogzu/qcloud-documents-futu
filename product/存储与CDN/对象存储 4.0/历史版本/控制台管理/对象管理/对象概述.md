...
 
为方便用户管理存储对象，控制台可以创建文件夹，存储和管理对象。具体请参阅 [创建文件夹](http://tce.fsphere.cn/document/product/436/6263)。
## 访问地址
...
```
有关存储桶的域名管理请参阅 [域名管理](http://tce.fsphere.cn/document/product/436/6252)。
