...
![设置HTTP头部1](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/5edf2ba97d32dd82b9c1be1e59379deb/image.png)
3. 单击【+添加参数】，选择需要设置的参数类型（自定义内容需输入自定义名称），输入对应的值。单击【确定】保存即可。
![设置HTTP头部2](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/2a2ee4acd84b10baaa4c27a5b3118ebc/image.png)
...
添加如下配置：
![设置HTTP头部3](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/0d8bb1be135a68204f19f3ea187a75ab/image.png)
