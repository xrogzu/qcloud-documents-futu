...
## 步骤
1. 登录 [对象存储桶控制台](http://console.tce.fsphere.cn/cos4/index)，选择左侧菜单栏【 Bucket 列表】，进入 Bucket 列表页面。单击需要创建文件夹的存储桶（如 example），进入存储桶。
...
![创建文件夹1](http://imgcache.tce.fsphere.cn/static/mc.qcloudimg.com/static/img/9edfa5747741bada149d507994d332ca/image.png)
3. 输入文件夹名称，单击【确定】保存即可。
![创建文件夹2](http://imgcache.tce.fsphere.cn/static/mc.qcloudimg.com/static/img/e3336916b073505b8f170fa484fe8a14/image.png)
