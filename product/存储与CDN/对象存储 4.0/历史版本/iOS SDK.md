...
对于新接入SDK的用户，我们推荐使用最新的V5版本[基于 XML API 封装的 SDK](/document/product/436/11280)。如果因为种种原因确实仍然需要需要使用基于 JSON API 封装的 SDK ,那么推荐使用我们基于历史版本重构后的[基于 JSON API 封装的 SDK](http://github.com/tencentyun/qcloud-sdk-ios/tree/master/QCloudNewCOSV4) 。
