...
![图片0](http://imgcache.tce.fsphere.cn/static/mc.qcloudimg.com/static/img/5e1740ac46efd2ddcb8258448af27815/image.png)
2. **使用 AJAX 技术访问文件**
...
```
 ...
 ![错误提示](http://imgcache.tce.fsphere.cn/static/mc.qcloudimg.com/static/img/b495296d08ddac2f5d8eacc0e9203c59/image.png)
 3. 访问失败，再进入 Header 界面检查原因，可见浏览器发送了带 Origin 的 Request，因此是一个跨域请求。
![检查Header](http://imgcache.tce.fsphere.cn/static/mc.qcloudimg.com/static/img/26976dee6cb15736e9aff86d353d5738/image.png)
...
![图片4](http://imgcache.tce.fsphere.cn/static/mc.qcloudimg.com/static/img/7a08a4ad4199580265a0359f2b39eafc/image.png)

#### II. 开启并设置 CORS 规则 
1. 单击【编辑】，开启 CORS 状态，单击【+新增规则】，出现设置页面，添加第一条规则，使用最宽松的配置如下：
![](http://imgcache.tce.fsphere.cn/static/mc.qcloudimg.com/static/img/198d6464fe3846451b6afc2b71cb0b78/image.png)
> **注意：**
> CORS 设置是由一条一条规则组成的，会从第一条开始逐条匹配，以最早匹配上的规则为准。

#### 验证结果
配置完成后，重新尝试访问 test.txt 文本文件。结果如下，可以正常访问请求了。
![访问成功](http://imgcache.tce.fsphere.cn/static/mc.qcloudimg.com/static/img/9d3f4370b337e73090efae2c2ef199f4/image.png)
...
![](http://imgcache.tce.fsphere.cn/static/mc.qcloudimg.com/static/img/c3cba398e89f643c58a742e720dbd955/image.png)
