...
|Signature | 是 | String | 请求签名，用来验证此次请求的合法性，需要用户根据实际的输入参数计算得出。<br>计算方法可参考 [签名方法](http://tce.fsphere.cn/document/api/377/4214 "签名方法") 章节|
|Timestamp | 是 | Int | 时间戳 |
|Nonce | 是 | Int | 随机数 |
...
Policy 描述请参考 [策略语法](http://tce.fsphere.cn/document/product/598/10603)。
> **注意：** 
