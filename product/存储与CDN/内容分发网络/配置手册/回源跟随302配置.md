...
![](http://imgcache.tce.fsphere.cn/image/mc.qcloudimg.com/static/img/91e36432a50b741b58b73c28db60b1ef/302-config-1.png)

默认情况下，回源跟随 302 配置为关闭状态。

## 配置案例

域名 ```www.test.com``` 302 配置如下：![](http://imgcache.tce.fsphere.cn/image/mc.qcloudimg.com/static/img/91e36432a50b741b58b73c28db60b1ef/302-config-1.png)
...
域名 ```www.test.com``` 302 配置如下：![](http://imgcache.tce.fsphere.cn/image/mc.qcloudimg.com/static/img/efb7f294d8d8a55b55166df011dce492/302-config-2.png)
