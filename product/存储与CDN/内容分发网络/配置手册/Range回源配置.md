...
![](http://imgcache.tce.fsphere.cn/static/mc.qcloudimg.com/static/img/9fd4571901f76f36f1759aea499027be/range-config-1.png)

默认情况下，range 回源配置为开启状态。

## 配置案例

若域名 ```www.test.com``` range回源配置如下：![](http://imgcache.tce.fsphere.cn/static/mc.qcloudimg.com/static/img/9fd4571901f76f36f1759aea499027be/range-config-1.png)
...
若域名 ```www.test.com``` Range回源配置如下：![](http://imgcache.tce.fsphere.cn/static/mc.qcloudimg.com/static/img/29078a4114ce8d6dd68b7064dca65553/range-config-2.png)
