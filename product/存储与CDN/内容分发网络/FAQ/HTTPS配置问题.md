...
### 2. CDN 是否支持 HTTPS 配置？
云平台 CDN 目前已经全面支持 HTTPS 配置。您可以上传自有证书进行部署，或前往 [证书管理](http://console.tce.fsphere.cn/ssl ) 控制台申请由亚洲诚信免费提供的第三方证书。
...
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/8dc758129896bef56c85a8528371e9e7/force_https.png)