...
+ COS源：若您的业务服务器能力有限，想使用云平台 [对象存储](http://tcecqpoc.fsphere.cn/product/cos.html)，或您已经使用了云平台的对象存储服务，您可以直接使用 COS 源接入方式，将域名接入 CDN。接入方式如下：
	...
	2. 若对应项目下无存储桶，您需要登录 [COS 控制台](http://console.tce.fsphere.cn/cos) 创建存储桶（如何创建？请查阅 [创建存储桶](http://tcecqpoc.fsphere.cn/document/product/436/6245#.E5.88.9B.E5.BB.BA.E5.AD.98.E5.82.A8.E6.A1.B6)）。
