...
## Windows 下自动挂载文件系统
挂载时，勾选 "登录时重新连接" 选项，如下图示。更多挂载帮助请参考 [使用 CFS 文件系统（Windows）](http://tce.fsphere.cn/document/product/582/11524)。
![](http://imgcache.tce.fsphere.cn/static/mc.qcloudimg.com/static/img/4bec827c8212a335b3173064184f7346/image.png)
