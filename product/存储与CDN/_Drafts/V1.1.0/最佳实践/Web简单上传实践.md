...
Ajax 上传需要浏览器支持基本的 Html5 特性，当前方案使用的是 [XML API 的 PutObject 接口](/document/product/436/7749)
...
Form 表单上传可以支持低版本的浏览器比如 ie8 的上传，当前方案使用的是 [XML API 的 PostObject 接口](/document/product/436/7751)
...
1. [JS-SDK详细文档（XML API）](/document/product/436/8095)
