## 开发准备
### SDK 获取
对象存储服务的 iOS SDK 地址：[XML iOS SDK](http://github.com/tencentyun/qcloud-sdk-ios.git)    。
需要下载打包好的 Framework 格式的 SDK 可以从 realease 中选择需要的版本进行下载。

更多示例可参考 Demo：[ XML iOS  SDK Demo](http://github.com/tencentyun/qcloud-sdk-ios-samples.git)    。
