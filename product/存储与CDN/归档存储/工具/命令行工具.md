...
optional arguments:
  ...
  --appid APPID         appid, please refer to http://console.tce.fsphere.cn/capi
...
| APPID       | 每个开发者访问 CAS 服务时拥有的唯一用户标识。在申请到 CAS 后由系统自动生成。[APPID获取地址](http://console.tce.fsphere.cn/developer) |
| SECRETID    | 开发者拥有的密钥ID。[SECRETID获取地址](http://console.tce.fsphere.cn/capi) |
| SECRETKEY   | 开发者拥有的签名密钥值。 [SECRETKEY获取地址](http://console.tce.fsphere.cn/capi) |
