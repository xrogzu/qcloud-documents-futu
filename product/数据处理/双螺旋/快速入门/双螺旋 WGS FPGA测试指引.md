...
有一定Python操作基础的用户，建议使用COSCMD工具。点击下载[COSCMD工具](http://github.com/tencentyun/coscmd)，工具的使用指引点此了解[COSCMD工具使用说明](/document/product/436/10976)
。其中重点配置信息说明如下：
...
其他用户建议通过云平台COS本地同步工具上传。点此下载[本地同步工具](http://github.com/tencentyun/cos_sync_tools_v5 "COS同步工具")
，本地同步工具的使用指引点此了解[工具使用说明](/document/product/436/7133 "本地同步工具使用说明")。其中重点配置信息说明如下：
