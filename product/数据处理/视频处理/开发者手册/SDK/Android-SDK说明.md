...
## 5 文件SDK
### 5.1 初始化
见[3.1初始化](/doc/product/314/Android-SDK%E8%AF%B4%E6%98%8E#3.1-.E5.88.9D.E5.A7.8B.E5.8C.96)章节
-   示例
...
### 5.7 暂停、恢复、取消上传
见[3.3暂停、恢复、取消上传](/doc/product/314/Android-SDK%E8%AF%B4%E6%98%8E#3.3-暂停、恢复、取消上传)章节
### 5.8 对象查询
