...
（1）如果需要使用PHP语言客户端，则推荐使用memcache扩展2.2.6：([memcache-2.2.6](http://imgcache.tce.fsphere.cn/image/qzonestyle.gtimg.cn/qzone/vas/opensns/res/doc/memcache-2.2.6.zip))，已证实这个扩展是使用同步I/O模型实现的。

（2）如果需要使用Java语言客户端，则推荐使用如下客户端：[memcached-java-2.5.1](http://imgcache.tce.fsphere.cn/image/qzonestyle.gtimg.cn/qzone/vas/opensns/res/doc/memcached-java-2.5.1.zip)。
...
![](http://imgcache.tce.fsphere.cn/image/qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/Nosql_access_2.png)
