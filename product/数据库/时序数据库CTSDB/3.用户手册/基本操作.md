...
登录 [ CTSDB 控制台](http://console.tcecqpoc.fsphere.cn/ctsdb)，单击 [新建](https://buy.tce.fsphere.cn/ctsdb) 进入购买界面。点击【立即购买】即可创建实例。内测阶段，每个创建者账号只能申请一个实例，该实例免费。为避免浪费，如果连续15天内无读写操作，云平台有权销毁该实例。
