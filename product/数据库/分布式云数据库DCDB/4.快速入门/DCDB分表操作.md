以下为连接 DCDB 后一些简单的数据库操作介绍，这里以分表为例。
### 建表
- 分表、单表、广播表的区别详情请参考 [相关表详情文档](http://tcecqpoc.fsphere.cn/document/product/557/8764#.E5.88.86.E8.A1.A8.EF.BC.9A.E5.8F.82.E8.80.83.26lt.3B.E5.88.86.E8.A1.A8.26gt.3B)。
- 分表键 (shardkey) 选择的限制请参考 [分表键详情文档](http://tcecqpoc.fsphere.cn/document/product/557/8767#shardkey.E9.80.89.E6.8B.A9.E7.9A.84.E9.99.90.E5.88.B6)
