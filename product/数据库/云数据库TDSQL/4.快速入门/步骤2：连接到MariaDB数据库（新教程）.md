...
- 内网访问：使用云平台中一台与MariaDB数据库实例网络相通的CVM来访问MariaDB数据库实例的内网地址。（注意：此台CVM需要与数据库处于某个VPC下的同一个子网中，关于VPC的更多信息请查看<a href="http://tcecqpoc.fsphere.cn/document/product/215/535" target="_blank">VPC概述</a>。）
