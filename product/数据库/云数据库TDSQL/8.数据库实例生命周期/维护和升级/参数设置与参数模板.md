...
目前，参数模板支持以下功能，用户可登录[云平台控制台]，点击导航条【关系型数据库】，进入【云数据库控制台>MariaDB】，左侧边栏【参数模板】查看和修改：
...
MariaDB系统变量说明：
- 分类索引：[http://mariadb.com/kb/en/mariadb/system-variables](http://mariadb.com/kb/en/mariadb/system-variables)
- 全部变量索引：
[http://mariadb.com/kb/en/mariadb/full-list-of-mariadb-options-system-and-status-variables](http://mariadb.com/kb/en/mariadb/full-list-of-mariadb-options-system-and-status-variables)
