...
![](http://imgcache.tce.fsphere.cn/static/mccdn.qcloud.com/static/img/c3d9a2815d8039c37af9dd31ff7c0853/image.png)
...
```
解压完后，目录和文件情况大概如下:
 ![](http://imgcache.tce.fsphere.cn/static/mccdn.qcloud.com/static/img/6f1d1aaf1ce9061cba0e09e4e47c271d/image.png)
- 3）应用日志
使用innobackupex应用日志
```
...
![](http://imgcache.tce.fsphere.cn/static/mccdn.qcloud.com/static/img/4f43de6b03bf4456975105a8567d81a9/image.png)
...
成功后，显示Complete OK!, 信息展示如下:
 ![](http://imgcache.tce.fsphere.cn/static/mccdn.qcloud.com/static/img/f109ca176fe161dc145863fa4808d93f/image.png)
- 7）启动数据库
```
