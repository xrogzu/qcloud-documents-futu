## 1. 控制台导出
1.<span></span> 使用云数据库数据控制台导出功能（详见：[下载备份文件](http://tcecqpoc.fsphere.cn/document/product/236/7274)），下载备份文件。  
...
CVM 主机访问数据库请参见[访问MySQL数据库](http://tcecqpoc.fsphere.cn/document/product/236/3130)。
...
更多字符集编码问题，请参考[使用限制](http://tcecqpoc.fsphere.cn/document/product/236/7259#document_charset_6)，字符集说明。
