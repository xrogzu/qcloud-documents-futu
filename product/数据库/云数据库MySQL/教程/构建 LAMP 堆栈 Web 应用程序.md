...
yum install mysql -y
```
![](http://imgcache.tce.fsphere.cn/static/mc.qcloudimg.com/static/img/8b952d6d7d767413a6558e82df092d44/image.png)
2. 安装完成后，连接到云平台数据库实例：
```
mysql -h hostname -u username -p
```
![](http://imgcache.tce.fsphere.cn/static/mc.qcloudimg.com/static/img/297856a53959582220b9bba6f06ce9f6/image.png)
...
yum install httpd -y
```
![](http://imgcache.tce.fsphere.cn/static/mc.qcloudimg.com/static/img/dc142f813e8e8474a5994e2e841828f2/image.png)
2. 启动 Apache 服务：
```
service httpd start
```
...
yum install php -y
```
![](http://imgcache.tce.fsphere.cn/static/mc.qcloudimg.com/static/img/61a0864ddbb70e65c63ad5093e8165d4/image.png)
