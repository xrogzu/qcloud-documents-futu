...
下载文件成功后，如下图：
![](http://imgcache.tce.fsphere.cn/image/mc.qcloudimg.com/static/img/be90d08eb5f13f886f6d3ac6bcd1d674/image.png)

#### 2 解压备份文件
对该文件用` tar xf `解压即可得到备份文件目录，目录格式：cdb 实例 ID _备份文件时间戳，查询解压后生成的文件，其中蓝色字体的目录文件为备份生成时 CDB 存在的数据库，如下图：
![](http://imgcache.tce.fsphere.cn/image/mc.qcloudimg.com/static/img/74d08e1dd19054231e19ba975213bf75/image.png)
