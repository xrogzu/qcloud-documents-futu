...
1. 登录 [云平台控制台](http://console.tcecqpoc.fsphere.cn/)，在 **使用中的云产品** 栏目单击【云服务器】，进入云服务器管理页面。在左侧导航栏中，单击【安全组】，进入安全组管理页面。
...
进入 [云数据库控制台](http://console.tcecqpoc.fsphere.cn/cdb)，在实例列表选中需要配置安全组的实例，单击【管理】，选择【安全组】标签页 > 单击【配置安全组】，选择需要绑定的安全组，即可完成安全组绑定云数据库的操作。 
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/2331e6b96fa1af3c9754cac0f8fe3854/image.png)

### 删除安全组

1. 打开云服务器 CVM 控制台 [安全组页面](http://console.tcecqpoc.fsphere.cn/cvm/securitygroup)，单击列表中安全组项后面的【删除】按钮。
...
1. 打开云服务器 CVM 控制台 [安全组页面](http://console.tcecqpoc.fsphere.cn/cvm/securitygroup)，单击列表中安全组项后面的【克隆】按钮。
...
1. 打开云服务器 CVM 控制台 [安全组页面](http://console.tcecqpoc.fsphere.cn/cvm/securitygroup)，选择需要更新的安全组，点击安全组 ID。详细信息窗格内会显示此安全组的详细信息，以及可供您使用入站规则和出站规则的选项卡。
