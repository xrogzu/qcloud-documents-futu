...
| vpcId | 否 | Int | vpc网络ID, 如果是基础网络， vpcId=0,  vpc网络下，取值以查询[私有网络列表](http://tce.fsphere.cn/doc/api/245/1372) 返回的vpcid为准|
| subnetId | 否 | Int | 基础网络下， subnetId无效， vpc子网下，取值以查询[私有网络列表](http://tce.fsphere.cn/doc/api/245/1372) 返回的subnetid为准|
