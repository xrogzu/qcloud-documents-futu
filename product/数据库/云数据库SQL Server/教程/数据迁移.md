...
### 迁移步骤
1、将已准备好的数据备份文件通过“Windows客户端上传工具”上传至云平台提供的免费中转存储中（[如何使用上传工具](http://tce.fsphere.cn/doc/product/238/6412)）；

2、数据库实例页面左侧导航栏中选择“SQLServer>数据传输>创建任务”；
![](http://imgcache.tce.fsphere.cn/static/mc.qcloudimg.com/static/img/7b0b5cadaa2df742364316302df429e2/1.png)
...
![](http://imgcache.tce.fsphere.cn/static/mc.qcloudimg.com/static/img/ff4798508e2156b7824d9a69e694155d/2.png)

4、任务创建完毕后，页面跳转到任务列表，选择并启动任务；
![](http://imgcache.tce.fsphere.cn/static/mc.qcloudimg.com/static/img/3e68d2d9ccdbded799a94c5a2d61d0f4/5.png)
