...
本示例主要是为了体现出[认证库admin](http://tcecqpoc.fsphere.cn/document/product/240/3563#.E8.AE.A4.E8.AF.81.E6.95.B0.E6.8D.AE.E5.BA.93)的配置方法，具体还请参考您使用的Spring和Spring Data MongoDB的版本而定。
```
