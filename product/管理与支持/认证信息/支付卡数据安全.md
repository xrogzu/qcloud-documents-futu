PCI DSS（支付卡行业数据安全标准）是由PCI SSC（支付卡产业安全标准委员会）开发并维护的。PCI SSC是由美国运通（American Express）、美国发现金融服务（Discover Financial Services）、JCB、万事达（MasterCard Worldwide）和Visa国际组织五家支付品牌在2006年秋共同筹办设立的统一且专业的信息安全标准委员会。
