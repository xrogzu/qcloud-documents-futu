1.预付费不停服保障范围：除设置了【到期不再续】外的其他预付费资源，可支持的产品包括：云服务器，云数据库MySQL，云数据库SQL Server，云数据库TDSQL，云数据库PostgreSQL，云数据库MongoDB，云数据库MongoDB分片，云数据库HBase，云存储Redis，黑石物理服务器，云硬盘CBS，专用宿主机，独享集群数据库，分布式数据库DCDB、BGP高防服务包、BGP高防IP。
