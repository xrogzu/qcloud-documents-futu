云平台实验室上线了 [在线投稿](http://tce.fsphere.cn/developer/labs/collection) 能力，现在除了官方推出的实验室之外，允许有能力的开发者把自己的技术和经验通过在实验室投稿的方式来进行分享和传播。
...
![enter image description here](http://imgcache.tce.fsphere.cn/image/mc.qcloudimg.com/static/img/cbe9ba3412909db0fcd1203e51a98904/33333.png)
...
![图片](http://imgcache.tce.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/c9am39oj2k.png)
...
#### 效果
![图片](http://imgcache.tce.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/mp00ttkcp0.png)
...
#### 效果
![图片](http://imgcache.tce.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/fj9owvnij3.png)
...
#### 效果
![图片](http://imgcache.tce.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/2z9u5flv4a.png)
...
![图片](http://imgcache.tce.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/ndenm1kvpp.png)
...
![图片](http://imgcache.tce.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/0dojbd3g3a.png)
...
#### 示例效果
![图片](http://imgcache.tce.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/dd0b8gi96u.png)
...
#### 示例
![图片](http://imgcache.tce.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/hqxfmr9um4.png)
...
#### 示例效果
![图片](http://imgcache.tce.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/7l7yt7bsqo.png)
...
#### 示例效果
![图片](http://imgcache.tce.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/nqg0ox6zxg.png)
...
#### 效果
![图片](http://imgcache.tce.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/ikbcd1ufcd.png)
...
对于部分需要介绍数学背景的实验，可以插入 [AMS LaTeX 语法](http://imgcache.tce.fsphere.cn/image/ask.qcloudimg.com/draft/1000005/xrxltjjbvx.pdf
) 的公式。

#### 示例
![图片](http://imgcache.tce.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/ysjtscos4u.png)
...
![图片](http://imgcache.tce.fsphere.cn/image/ask.qcloudimg.com/http-save/1000002/pxbu3r2y4b.gif)

#### 注意事项
- 只能插入腾讯视频的内容
- `vid` 在视频上传并通过审核后，从视频的 URL 中获取

![图片](http://imgcache.tce.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/kvygqz0c44.png)
...
![图片](http://imgcache.tce.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/cjpyj04lie.png)
...
#### 效果
![图片](http://imgcache.tce.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/ee8lmzimzl.png)
...
![图片](http://imgcache.tce.fsphere.cn/image/ask.qcloudimg.com/http-save/1000002/lj7ektndi.gif)
...
![图片](http://imgcache.tce.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/fgz0cyy5jy.png)

### 3.3 检查器
检查器是打造沉浸式实验体验的重要元素。检查器会定时在云主机上运行一条命令，通过命令输出来判断当前步骤是否已经完成。

![图片](http://imgcache.tce.fsphere.cn/image/ask.qcloudimg.com/http-save/1000002/qkg0l2g7zd.gif)
...
![图片](http://imgcache.tce.fsphere.cn/image/ask.qcloudimg.com/http-save/1000002/iw7h3ikgyq.gif)
...
![图片](http://imgcache.tce.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/tve6vkro5d.png)
...
![图片](http://imgcache.tce.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/0biaexcnpf.png)
...
![图片](http://imgcache.tce.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/yug50vrdp7.png)
...
![图片](http://imgcache.tce.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/c0m20he9an.png)

### 3.7 环境变量

我们可以在大部分的正文内容里插入环境变量，在实验运行的时候回替换成环境相关的实际值。

![图片](http://imgcache.tce.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/xddcaxkekt.png)
