云平台实验室上线了 [在线投稿](http://tcecqpoc.fsphere.cn/developer/labs/collection) 能力，现在除了官方推出的实验室之外，允许有能力的开发者把自己的技术和经验通过在实验室投稿的方式来进行分享和传播。
...
举个例子，下图是 [搭建 FTP 文件服务](http://tcecqpoc.fsphere.cn/developer/labs/lab/10002) 实验的截图。
![enter image description here](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/cbe9ba3412909db0fcd1203e51a98904/33333.png)
...
![图片](http://imgcache.tcecqpoc.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/c9am39oj2k.png)
...
#### 效果
![图片](http://imgcache.tcecqpoc.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/mp00ttkcp0.png)
...
#### 效果
![图片](http://imgcache.tcecqpoc.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/fj9owvnij3.png)
...
#### 效果
![图片](http://imgcache.tcecqpoc.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/2z9u5flv4a.png)
...
![图片](http://imgcache.tcecqpoc.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/ndenm1kvpp.png)
...
![图片](http://imgcache.tcecqpoc.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/0dojbd3g3a.png)
...
#### 示例效果
![图片](http://imgcache.tcecqpoc.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/dd0b8gi96u.png)
...
#### 示例
![图片](http://imgcache.tcecqpoc.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/hqxfmr9um4.png)
...
下面几种方式都可以在实验室插入超链接：
```
1. 如有疑问，可到[云平台问答社区](http://tcecqpoc.fsphere.cn/developer/ask)提问
2. 如有疑问，可到[云平台问答社区][http://tcecqpoc.fsphere.cn/developer/ask]提问
3. 如有疑问，可到 [http://tcecqpoc.fsphere.cn/developer/ask][] 提问
4. 如有疑问，可到 <http://tcecqpoc.fsphere.cn/developer/ask> 提问
5. 如有疑问，可到[云平台问答社区][community]提问

> <link for="community" href="http://tcecqpoc.fsphere.cn/developer/ask" />
```

#### 示例效果
![图片](http://imgcache.tcecqpoc.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/7l7yt7bsqo.png)

#### 注意事项
- 超链接**必须**以 `http://`、`http://` 或 `ftp://` 开头，并统一在新窗口打开
...
#### 语法
`![图片说明](http://url.totheimage.com)`

#### 示例效果
![图片](http://imgcache.tcecqpoc.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/nqg0ox6zxg.png)
...
#### 效果
![图片](http://imgcache.tcecqpoc.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/ikbcd1ufcd.png)
...
对于部分需要介绍数学背景的实验，可以插入 [AMS LaTeX 语法](http://imgcache.tcecqpoc.fsphere.cn/image/ask.qcloudimg.com/draft/1000005/xrxltjjbvx.pdf
) 的公式。

#### 示例
![图片](http://imgcache.tcecqpoc.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/ysjtscos4u.png)
...
### 2.12 插入视频
必要时，可以插入视频内容来辅助实验。目前实验室只支持插入[腾讯视频](http://v.qq.com)的内容。需要在实验室插入视频的，需要先在腾讯视频注册并且上传视频，审核成功后方可插入。
...
![图片](http://imgcache.tcecqpoc.fsphere.cn/image/ask.qcloudimg.com/http-save/1000002/pxbu3r2y4b.gif)

#### 注意事项
- 只能插入腾讯视频的内容
- `vid` 在视频上传并通过审核后，从视频的 URL 中获取

![图片](http://imgcache.tcecqpoc.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/kvygqz0c44.png)
...
> <webpage for="mp-doc" url="http://mp.weixin.qq.com/debug/wxadoc/dev/index.html"></webpage>
```

#### 示例效果

用户点击交互连接之后，会在工作区打开一个网页。
![图片](http://imgcache.tcecqpoc.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/cjpyj04lie.png)
...
#### 效果
![图片](http://imgcache.tcecqpoc.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/ee8lmzimzl.png)
...
> <link for="github" href="http://github.com" />
```
...
![图片](http://imgcache.tcecqpoc.fsphere.cn/image/ask.qcloudimg.com/http-save/1000002/lj7ektndi.gif)
...
![图片](http://imgcache.tcecqpoc.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/fgz0cyy5jy.png)

### 3.3 检查器
检查器是打造沉浸式实验体验的重要元素。检查器会定时在云主机上运行一条命令，通过命令输出来判断当前步骤是否已经完成。

![图片](http://imgcache.tcecqpoc.fsphere.cn/image/ask.qcloudimg.com/http-save/1000002/qkg0l2g7zd.gif)
...
![图片](http://imgcache.tcecqpoc.fsphere.cn/image/ask.qcloudimg.com/http-save/1000002/iw7h3ikgyq.gif)
...
![图片](http://imgcache.tcecqpoc.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/tve6vkro5d.png)
...
![图片](http://imgcache.tcecqpoc.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/0biaexcnpf.png)
...
![图片](http://imgcache.tcecqpoc.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/yug50vrdp7.png)
...
![图片](http://imgcache.tcecqpoc.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/c0m20he9an.png)

### 3.7 环境变量

我们可以在大部分的正文内容里插入环境变量，在实验运行的时候回替换成环境相关的实际值。

![图片](http://imgcache.tcecqpoc.fsphere.cn/image/ask.qcloudimg.com/draft/1000002/xddcaxkekt.png)
...
如果在投稿过程中遇到问题，可以在[开发者问答社区](http://tcecqpoc.fsphere.cn/developer/ask)进行提问，或者发送邮件到 `DevLabs@tencent.com` 反馈内容。
