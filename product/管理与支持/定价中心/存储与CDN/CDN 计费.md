CDN 为您提供了两种计费模式：**流量计费** 和 **带宽计费**，您可以根据自身业务形态选择合适的计费模式。（如何选择？请参考[计费模式选择](/doc/product/228/2949)）。
...
详细价格算法请参考[价格总览](/doc/product/228/2949)，您也可以使用 [价格计算器](http://buy.tce.fsphere.cn/calculator/cdn) 估算价格。

## 流量包使用
选择流量计费的客户，可以使用流量包抵扣，更多详情[点击查看](/doc/product/228/2949)。
