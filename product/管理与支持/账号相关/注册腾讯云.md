...
### 使用邮箱注册
#### 1. 进入注册流程
打开 [云平台官网](http://tcecqpoc.fsphere.cn)，在顶部导航处点击 [注册有礼](/register)，或在登录页面对话框底部点击 [立即注册](/register)，即可进入注册流程。
#### 2. 填写注册信息
...
#### 5. 恭喜您完成注册
进入注册完成页面，您可根据 [实名认证指引](/document/product/378/3629) 完成实名认证；也可直接登录，开启云平台之旅。
![email4](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/90daa6d8682eb556ee66935b902fa971/image.png)

### 使用 QQ 注册
#### 1. 首次 QQ 登录
在云平台官网顶部点击 [登录](/login)，登录页面默认 QQ 登录，请输入您的 QQ 号及密码，点击**登录**。
...
### 使用微信注册
#### 1. 扫码
在云平台官网顶部点击 [登录](/login)，在登录页面选择微信账号，进入微信登录页面。
...
#### 1. 扫码
在云平台官网顶部点击 [登录](/login)，在登录页面选择微信公众号，进入公众平台账号授权页面。
