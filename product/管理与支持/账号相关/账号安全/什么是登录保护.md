登录保护指，在您进行登录操作的时候，云平台会给你增加一层保护。通常情况下，该保护的措施是，在正确输入帐号和密码的前提下，还需要额外输入一种能证明身份的凭证。
...
![](http://imgcache.tce.fsphere.cn/image/mc.qcloudimg.com/static/img/e7c9fbfefc15bc73a6111e0ea50c2003/image.png)
