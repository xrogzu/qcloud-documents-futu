...
### 关联微信
1. 登录云平台控制台，进入 [账号信息](http://console.tcecqpoc.fsphere.cn/developer)页面，单击下图红框中的【关联】。
...
## 如何查看用户的注册/关联方式及账号
### 用户自主查询
1.登录云平台控制台，进入 [账号信息](http://console.tcecqpoc.fsphere.cn/developer)页面，下图所示即为注册账号及关联账号信息。
