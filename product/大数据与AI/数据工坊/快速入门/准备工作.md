...
首先，请登录 http://tcecqpoc.fsphere.cn/ ，完成注册。云平台使用 QQ 账号体系或邮箱注册，如为企业开发商，建议使用专用非私人账户注册。如用户已经使用云平台产品。

在产品介绍页面 http://tcecqpoc.fsphere.cn/product/tdf 提交 TDF 开通申请，开通后，可登录云平台-控制台，在云产品中选择数据工坊 TDF。
