...
>**注意：** </br>（1）一个 appid 下建立的 group_id 数量限制为 5000 个。</br> （2）一个 group_id 下建立的 person_id 数量限制为 20000 个。</br>（3）一个 person_id 下建立的人脸数量限制为 20 个。</br>（4）每个请求的包体大小限制为 1.5MB，不支持  .gif 这类的动图。
