...
>（1）如果您使用的是 125 开头的 APPID，请使用 [API 密钥](http://console.tcecqpoc.fsphere.cn/capi) ；
>（2）如果您使用的是 100、101 等开头的 项目 ID，请使用 [项目密钥](http://console.tcecqpoc.fsphere.cn/capi/project)。
 
###  拼接签名串
拼接多次有效签名串：
