...
小微平台提供两位形式的 App 端管理方式：** 小微自有 App-- 云平台小微 ** 和 ** 设备生产商自有 App**。其中，下文会对 ** 小微自有 App-- 云平台小微 ** 的绑定进行详细说明；** 设备生产商自有 App** 的接入，请参考文档 [第三方 App 绑定](/document/product/645/14226)。
...
** 说明 **：关于设备配网的概念和具体流程，请参考 [设备配网](/document/product/645/14230)。
