云平台小微技能套件使您能够通过构建基于云的服务为云平台小微提供新的功能。 此服务可以是Web服务。 本文档详细介绍了云平台小微语音服务和Web服务之间的协议接口。 云平台小微通过使用HTTP over SSL / TLS的请求响应机制与您的服务进行通信。 当用户与云平台小微技能交互时，您的服务会收到包含JSON主体的POST请求。 请求体包含服务执行逻辑所需的参数，并生成JSON格式的响应。
