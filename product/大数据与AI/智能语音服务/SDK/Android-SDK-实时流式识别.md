## 开发准备
### SDK 下载
智能语音服务实时流式识别 Android SDK 及 Demo 下载地址：[Android SDK](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/archive/6600e4e3ed5d41a5b9bfd649a4f7a3aa/aai-android-sdk-v2.x.zip)

### 开发前
1. 开发者使用实时流式识别功能前，需要先在云平台- [控制台](http://console.tcecqpoc.fsphere.cn/) 注册账号，并获得 APPID、SecretId 和 SecretKey 等；
...
##### 引入 jar 包
- aai-2.1.2.jar：云平台智能语音 SDK
- okhttp-3.2.0.jar
- okio-1.6.0.jar
- slf4j-android-1.6.1-RC1.jar

云平台智能语音服务 SDK 支持本地构建或者远程构建两种方式：
#### 本地构建
