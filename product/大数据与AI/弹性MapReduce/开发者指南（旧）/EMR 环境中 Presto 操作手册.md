### 1. 登录 Master 机器
您可以通过访问 [云平台控制台>云主机列表](http://console.tcecqpoc.fsphere.cn/cvm/index)，找到以 emr-master.1 开头的云主机（也就是带外网 IP 的那一台云主机）登录到 Master 节点。
...
### 4. 更多连接器
您可以通过访问 [Presto 官方文档](http://prestodb.io/docs/current/connector.html) 获取更多连接器的设置方法。
