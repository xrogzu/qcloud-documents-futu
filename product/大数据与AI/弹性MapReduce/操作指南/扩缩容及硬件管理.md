当前版本的 EMR（V1.1.3）的集群硬件管理路径为[【弹性 MapReduce 控制台】](http://console.tcecqpoc.fsphere.cn/emr)>【集群列表】>【详情】>【节点信息】。
...
对于使用黑石物理机搭建的 EMR 集群，请通过 [工单](http://console.tcecqpoc.fsphere.cn/workorder/category) 联系我们。
