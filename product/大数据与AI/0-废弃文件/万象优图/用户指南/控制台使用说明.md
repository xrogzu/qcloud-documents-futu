...
![](https://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/appv2-icon.png) ：V2版本图标

![](https://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/appV1-icon.png) ：V1版本图标
...
![](https://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/tupiankongjian-1.png)

### 2.1 添加空间

点击“添加按钮”，来添加新的空间。如下面添加空间图所示，创建一个名称为“tencentyun”的空间，点击“完成”按钮完成空间的添加。

![](https://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/kongzhitaishiyongshuoming-2.png)

创建完成后，图片空间下就会多出刚才创建的“tencentyun”空间，如下图所示。

![](https://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/kongzhitaishiyongshuoming-3.png)
...
![](https://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/kongzhitaishiyongshuoming-7.png)
...
![](https://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/kongzhitaishiyongshuoming-8.png)
...
![](https://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/yangshifengefu.png)
...
![](https://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/yangshixiazaibieming1.png)
...
![](https://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/kongzhitaishiyongshuominghuidiaourl.png)
...
![](https://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/kongzhitaishiyongshuoming-12.png)
...
![](https://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/kongzhitaishiyongshuoming-13.png)


点击“添加”按钮来创建样式，如下图所示，输入样式名称，这里创建名称为“yunstyle”的样式，点击“完成”。

![](https://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/kongzhitaishiyongshuoming-14.png)
...
![](https://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/kongzhitaishiyongshuoming-16.png)
...
![](https://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/kongzhitaishiyongshuoming-17.png)
...
![](https://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/kongzhitaishiyongshuoming-18.png)
...
![](https://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/kongzhitaishiyongshuoming-19.png)

3. 限定宽高的最大值

如下图，限定宽为600，高为600。这样如果上传的图片宽\*高为 1200\*900，则处理后的图片为600\*450；如果上传的图片宽和高都<600,则不会进行处理，比如上传的图片宽\*高为50\*50，则保存的缩略图还是50\*50。

![](https://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/kongzhitaishiyongshuoming-20.png)

4. 限定宽高的最小值

如下图，限定宽为600，高为600。这样如果上传的图片宽\*高为 1200\*900，则处理后的图片为800\*600；如果上传的图片宽和高都<600,则不会进行处理，比如上传的图片宽\*高为50\*50，则保存的缩略图还是50\*50。

![](https://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/kongzhitaishiyongshuoming-20-2.png)
...
![](https://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/kongzhitaishiyongshuoming-21.png)

![](https://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/kongzhitaishiyongshuoming-22.png)

**2.3.2.2	图片水印**

图片水印能够按照您设置的图片，由九宫格确定水印位置，在目标图片上设置水印。如选择右下，横向边距和纵向边距为10，上传图片水印，得到的缩略图如下

![](https://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/kongzhitaishiyongshuoming-23.png)

#### 2.3.3 输出效果

开发者可设置样式图的输出格式和输出质量，如下图所示。

![](https://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/kongzhitaishiyongshuoming-24.png)

### 2.4 图片识别
打开需要开通鉴黄服务的图片空间，进入空间识别页面，开启图片鉴黄
![](https://mccdn.qcloud.com/static/img/69bbe7901c17e892203f0fa6c307e0c1/image.png)
#### 2.4.1 回调阈值设置
1. 回调阈值为分值区间
...
如下图所示，输入回调URL，点击“保存”。回调URL预计30分钟后生效。
 ![](https://mccdn.qcloud.com/static/img/351b2dcd49bc2520742f0dc04ab2c25c/image.png)
...
2. 万象优图提供30天之内图片上传、下载、删除、查询的操作日志。选择您需要查询的时间，在列表里下载即可。
   ![](https://mccdn.qcloud.com/static/img/74000e0b602fde63581f6a593250f967/image.png)
...
![](https://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/kongzhitaishiyongshuoming-25.png)

**添加密钥：**

![](https://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/kongzhitaishiyongshuoming-26.png)

**禁用密钥：**

![](https://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/kongzhitaishiyongshuoming-27.png)
