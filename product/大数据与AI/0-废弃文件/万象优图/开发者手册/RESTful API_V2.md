...
概念|	解释
---------|---------
appid|	接入万象优图创建空间时,系统生成的唯一项目ID, 用于唯一标识接入项目, 申请链接: [图片空间](http://console.tce.fsphere.cn/image/bucket)；如果空间名称前面有“APP”字样的小图标，表明是V1版本的，只能使用V1版本接口
...
参数名称|	参数含义|	说明
---------|---------|---------
appid|	开发者创建[图片空间](http://console.tce.fsphere.cn/image/bucket)时，系统返回的项目ID|	可在图片空间中查看；如果空间名称签名有“APP”字样小图标的，表明是V1版本的，只能使用V1版本接口
