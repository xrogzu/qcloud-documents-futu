...
开发者使用人脸识别功能之前，需要先注册云平台账号，并创建图片空间，添加密钥，具体操作步骤如下：

 1)	前往[云平台·万象优图控制台](http://console.tcecqpoc.fsphere.cn/image/imgguide)控制台注册账号；如果已经注册账号，请跳过此步骤；
...
3)	在[云平台·万象优图控制台](http://console.tcecqpoc.fsphere.cn/image/imgguide)项目设置中添加密钥，获取SecretID和SecretKey；如果已经添加过密钥，请跳过此步骤。
