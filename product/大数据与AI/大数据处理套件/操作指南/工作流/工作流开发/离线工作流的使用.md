...
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/0207d1ed6b33ce9a4afb76dc2161aa3f/image.png)
...
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/7d0ef40b50d24ae41f84324d98f6f0ce/image.png)
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/3f9206b307b9ee60c016e1420b8d1a2f/image.png)
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/e44604148060275c1a781036fe82b4a5/image.png)
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/aed90c8d865636bd5a07527ae9fdf826/image.png)
详细说明：
（1）任务名称：任务标识名称。
（2）任务类型：数据导入集群的方式。
...
目前离线数据导入的方式支持如下图所示：
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/7feedeacc277df18a442f7310fec4e21/image.png)

## 数据计算 ##
### 数据计算示例说明
本示例以 HIVESQL 进行数据计算，首先新建一个 HIVE SQL脚本 任务。
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/52ab9a39310128f8e8ed2ad32e741a17/image.png)
右键单击【编辑】之后，根据详细说明填写相关参数信息。
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/6502e6b70167d85c0ace48442c5245be/image.png)
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/1fa9cc6184a57a523775d07387e99a2f/image.png)
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/78da694e638db78598b929b4e2f1c117/image.png)
详细说明：
...
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/06802f422b9a529d1229d661e9963e9b/image.png) 
差异在于 Spark 和 JStorm 上传脚本时，可以自定义参数，同时 JStorm 需要指定 Topology 类和名称，如下图所示：
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/724ab046809172a211edd59c71e0e3aa/image.png)

## 数据导出 ##
### 数据导出示例说明
本示例中，到目前为止，数据经过计算已经将结果存入到 HIVE 表，即 HDFS 的文件中，导出即选择从 HDFS 导出到 MySQL 永久存储。
首先新建一个 HDFS 导出 MYSQL 任务。
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/606f762467ef383e5ed5d0c67bcb6a47/image.png)   
右键单击【编辑】，填写相关配置信息。
配置说明：
...
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/bfe81466a57e816053f4e4c54709372a/image.png)
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/ae709bc64aa6d01acd7322d20ac5f0e9/image.png)
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/6a5aca0d2bf4c362595778eb01aebff7/image.png)

### 其他数据导出方法说明
目前支持的数据导出方法如下图所示：
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/9dc3500970611cebe80b402b51cc644d/image.png)  
任务基本信息的设置均一致，差异如下：
数据导出到 HBase，列的对应信息填写准确即可。（其余均为导出到类 SQL 数据库）
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/c7eec2c42dbe4c5806be4822f398c8cc/image.png)
