...
云平台搜体验版，专业版，极速版三个版本，每个版本综合考虑应用的[文档量] , [每秒搜索请求峰值(QPS)]进行计费。
...
1、云平台搜付费方式为预付费，用户需要按月支付费用并享受搜索服务。

2、付费首月，将按照实际剩余天数来收取费用。

### 2.2 续费

1、自动续费：如您选择了自动续费，则每月1号，云搜将直接从您的云平台账户中扣除当月的费用。费用根据扣费时您选择的云搜版本及服务计算。
