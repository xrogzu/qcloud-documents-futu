...
![ID](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/af8930cfb9f5afcef34f73edaf9ab61b/Buckety+ID.png)
2) 如当前项目无Bucket，可添加后，获取项目ID（appid），空间名称（bucket）

3) 进入密钥管理页面，获取密钥：

![密钥](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/282f9231ea43d1590256f6583099208a/image.png)
