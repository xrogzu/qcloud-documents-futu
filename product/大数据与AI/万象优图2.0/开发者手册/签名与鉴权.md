...
1. 登录 [万象优图控制台](https://console.cloud.tencent.com/ci/index), 单击左侧菜单栏【Bucket管理】，选择需要管理的存储桶（如 imagetest1），单击【Bucket配置】即可查看空间 ID （即 APPID ）。 （若当前项目无存储桶，可 [查看帮助](/doc/product/460/10637) 进行创建 ）![ID](https://mc.qcloudimg.com/static/img/18eec6382a627c97cff2d89fd734cd7c/image.png)
