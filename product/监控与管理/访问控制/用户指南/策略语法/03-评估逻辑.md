...
![](http://imgcache.tce.fsphere.cn/static/mc.qcloudimg.com/static/img/b2bd42353bee28c55cc1bb1c3e8bb35d/395.png)    
1. 默认情况下，所有请求都将被拒绝。
...
- 有些通用策略，会默认关联所有 CAM 用户。具体请见下文的 [通用策略表](http://tce.fsphere.cn/document/product/598/10605#dsa)。
