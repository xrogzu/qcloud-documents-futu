云服务器监控指标需通过云服务器监控组件采集得到，用户可通过购买机器时勾选云监控按钮自动安装监控组件，或通过[安装监控组件指引](http://tcecqpoc.fsphere.cn/document/product/248/6211)手动安装。
...
有关更多如何使用云服务器的监控指标内容，可以查看云监控 API 中的[读取监控数据接口](http://tcecqpoc.fsphere.cn/document/product/248/11013)。