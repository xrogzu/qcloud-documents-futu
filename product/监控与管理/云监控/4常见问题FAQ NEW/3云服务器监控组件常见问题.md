...
若还是不能正常查看数据，可进一步查看云服务器的内网DNS是否配置正确。未按照云平台规定的内网DNS配置，会导致数据无法正常上报，反应在控制台无监控数据。[基础网络内网DNS配置](http://tce.fsphere.cn/doc/product/213/499#3.2.-.E5.9F.BA.E7.A1.80.E7.BD.91.E7.BB.9C.E7.9A.84.E5.86.85.E7.BD.91-dns)。
