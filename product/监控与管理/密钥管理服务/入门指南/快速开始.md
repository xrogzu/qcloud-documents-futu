...
打开 [控制台](http://console.tcecqpoc.fsphere.cn/kms)，为了和后续Demo的代码对应，区域最好选择广州，
...
Python 2.7.10
```
正常返回版本信息则代表支持，如果没有请参照 [Python安装指引>>](/document/product/440/6181)
...
endpoint = "http://kms-gz.api.qcloud.com"
...
* secreteId和secretKey需要使用你创建密钥的帐号所绑定的云API密钥，你可以在这里找到你的 [云API密钥](http://console.tcecqpoc.fsphere.cn/capi)
*  endpoint需要和密钥创建时选择的区域对应，Demo使用的是广州区域对应的URL，详情见 [地域说明](/document/product/573/8922)
