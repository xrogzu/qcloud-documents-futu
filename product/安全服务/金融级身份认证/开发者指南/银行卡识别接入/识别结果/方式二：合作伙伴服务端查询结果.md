...
| warnCode           | string         | 银行卡警告码，在银行卡日期失效或者过期会提示；当 frontCode 为 0 时才会出现告警码，告警码的含义请参考【[通用响应码列表](/document/product/655/13819) 】>【银行卡 OCR 识别响应码】 |
...
>- 对于银行卡 OCR 识别有日期失效或者过期的情况，请参考 frontWarnCode 和 backWarnCode 告警码。（参考【[通用响应码列表](/document/product/655/13819) 】>【银行卡 OCR 识别响应码】）
