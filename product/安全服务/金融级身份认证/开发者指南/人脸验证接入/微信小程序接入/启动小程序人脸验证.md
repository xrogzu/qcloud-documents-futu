...
此方法是微信小程序提供的 API，详细信息请参考 [微信小程序官方文档](http://mp.weixin.qq.com/debug/wxadoc/dev/api/navigateToMiniProgram.html) 。

** 请求参数：**

| 参数          | 说明                                       | 类型     | 长度（字节）    | 是否必填 |
| ----------- | ---------------------------------------- | ------ | --------- | ---- |
| appId       | 人脸验证小程序 App Id，固定值为：wx7ccfa42a2a641035 </br>  ** 注意：** 调用前需要先关联人脸验证小程序，关联方法见 [关联人脸验证小程序](/document/product/655/13808) | String | 20        | 是    |
...
[上一步：合作方后台上送身份信息](/document/product/655/13831)

[下一步：小程序人脸验证结果跳转](/document/product/655/13833)
