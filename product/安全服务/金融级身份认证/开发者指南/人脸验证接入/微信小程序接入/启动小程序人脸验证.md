## 1. 生成签名
### 准备步骤
- **前置条件：请合作方确保 NONCE ticket 已经正常获取，获取方式见 [NONCE ticket 获取](http://tce.fsphere.cn/document/product/655/13816) 。**
...
| api ticket  | 合作伙伴服务端缓存的 tikcet，注意是 NONCE 类型 | 获取方式见 [NONCE ticket 获取](http://tce.fsphere.cn/document/product/655/13816) |
...
| 参数          | 说明                                       | 类型     | 长度（字节）    | 是否必填 |
| ----------- | ---------------------------------------- | ------ | --------- | ---- |
| appId       | 人脸验证小程序 App Id，固定值为：wx7ccfa42a2a641035 </br>  ** 注意：** 调用前需要先关联人脸验证小程序，关联方法见 [关联人脸验证小程序](http://tce.fsphere.cn/document/product/655/13808) | String | 20        | 是    |
...
[上一步：合作方后台上送身份信息](http://tce.fsphere.cn/document/product/655/13831)

[下一步：小程序人脸验证结果跳转](http://tce.fsphere.cn/document/product/655/13833)
