...
**请求 URL：**
```
http://ida.webank.com/api/web/login
```
**请求方法：**GET
**请求参数：**
...
[上一步：合作方后台上送身份信息](http://tcecqpoc.fsphere.cn/document/product/655/14369)

[下一步：H5 人脸验证结果跳转](http://tcecqpoc.fsphere.cn/document/product/655/14368)
