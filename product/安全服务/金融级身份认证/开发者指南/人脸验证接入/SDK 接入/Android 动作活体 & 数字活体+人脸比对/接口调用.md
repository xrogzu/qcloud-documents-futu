...
**关于接口调用的示例可参考 [接入示例](http://tce.fsphere.cn/document/product/655/14076)**
...
更多相关内容可参考：
[错误码描述](http://tce.fsphere.cn/document/product/655/14079)
[接入示例](http://tce.fsphere.cn/document/product/655/14076)
