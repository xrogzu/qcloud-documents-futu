...
以下请求参数列表仅列出了接口请求参数，正式调用时需要加上公共请求参数，详情请参见 [公共请求参数](/document/product/295/7279) 页面。其中，此接口的 Action 字段为 AntiFraud。
...
| 参数名称 | 类型 | 描述 |
| ----- | ----- | ----- |
| code | Int | 公共错误码；</br>0 表示成功，其他值表示失败；</br>详见 [错误码](/document/product/295/7285) 页面中的“公共错误码”相关内容。 |
