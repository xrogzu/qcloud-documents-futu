1. **前置条件：**必须按照 [Access Token获取](/document/product/295/10118) 获取 NONCE ticket。
...
<td >ticket </td>
<td >
合作伙伴服务端缓存的 tikcet。注意是 NONCE 类型，具体见<a href="/document/product/295/10118"> Access Token 获取</a>以获取规则。
</td>
</tr>
<tr>
<td >nonceStr</td>
