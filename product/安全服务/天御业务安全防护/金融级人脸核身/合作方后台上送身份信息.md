### 1.生成签名 
1.1 **前置条件**：必须按照[SIGN ticket获取](http://tcecqpoc.fsphere.cn/document/product/295/10120?!preview&lang=cn).
...
| version | 1.0.0 | 
| api ticket | 合作伙伴服务端缓存的tikcet,注意是SIGN 类型，具体参考[SIGN ticket获取](http://tcecqpoc.fsphere.cn/document/product/295/10120?!preview&lang=cn)| 
