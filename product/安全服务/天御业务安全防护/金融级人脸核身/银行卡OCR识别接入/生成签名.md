1. **前置条件：**首先需要按照 [Access Token获取](http://tce.fsphere.cn/document/product/295/10118) 获取 NONCE ticket。
...
<tr>
<td >ticket </td>
<td >合作伙伴服务端缓存的 tikcet。注意是 NONCE 类型，具体见<a href="http://tce.fsphere.cn/document/product/295/10118"> Access Token 获取</a>以获取规则。
</td>
</tr>
<tr>
<td >nonceStr</td>
...
6. 签名算法，示例如下（请参考[签名算法说明](http://tce.fsphere.cn/document/product/295/10137)）：
请求参数：
```
appId = TIDA0001
