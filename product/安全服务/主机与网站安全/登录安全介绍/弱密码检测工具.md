...
表1 参数说明表
![](https://mccdn.qcloud.com/img56c635604f16c.png)
3.弱密码字典文件可以用户添加，每行一个弱密码。
演示截图如图图1，图2，图3所示：
图1 测试开始时演示图
![](https://mccdn.qcloud.com/img56c635765255b.png)
图2 测试结束时演示图
![](https://mccdn.qcloud.com/img56c63594ba228.png)
图3 弱密码信息演示图
![](https://mccdn.qcloud.com/img56c635a806bb0.png)