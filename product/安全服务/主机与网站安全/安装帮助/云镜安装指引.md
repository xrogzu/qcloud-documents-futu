...
![Windows进程](http://imgcache.tce.fsphere.cn/image/mc.qcloudimg.com/static/img/cb809b0f1e6a61d548a24f4bd4b57a61/image.jpg)
...
- 外网下载地址：
```
wget --no-check-certificate http://imgcache.tce.fsphere.cn/image/imgcache.qq.com/qcloud/csec/yunjing/static/yunjinginstall.sh && sh ./yunjinginstall.sh
```
