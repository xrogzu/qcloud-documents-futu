...
从[github](http://tcecqpoc.fsphere.cn/doc/product/227/3387)下载源码
...
| enableSavePoint |     boolean     |        true         |   set方法    | 是否开启断点文件，开启断点文件后，会在本地记录一个断点, 如果上传失败，则会跳过已经上传过的片. 看起断点文件会牺牲一部分上传速度。 |
