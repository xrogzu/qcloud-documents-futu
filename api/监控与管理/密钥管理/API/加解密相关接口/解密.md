...
> 本接口会检查
kms请求域名接口和说明可参考[地域和域名说明](http://tcecqpoc.fsphere.cn/document/product/573/8922)。
...
以下请求参数列表仅列出了接口请求参数，其它参数见[公共请求参数](http://tcecqpoc.fsphere.cn/document/product/573/8913)页面。
...
注意：上表所列错误码是接口特有错误码，如果您要查找的错误码不在其中，可能在[公共错误码](http://tcecqpoc.fsphere.cn/document/product/573/8919)中。
...
<pre>
 http://kms-gz.api.tencentyun.com/v2/index.php?Action=Decrypt
