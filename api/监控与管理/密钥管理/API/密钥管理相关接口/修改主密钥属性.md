...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| code | Int | 0：表示成功，其他返回值的含义可以参考 [错误码](http://tcecqpoc.fsphere.cn/document/product/573/8919)。|
...
<pre>
 http://kms-sh.api.tencentyun.com/v2/index.php?Action=SetKeyAttributes
 &keyId=kms-345sdfk
 &alias=kms-test-1
