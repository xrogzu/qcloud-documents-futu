欢迎使用密钥管理服务KMS。
KMS产品介绍请参考[产品介绍](/document/product/573/8780)


支持的全部操作可参见[API概览页](/document/product/573/8899)。
...
用户可以通过[KMS SDK](/document/product/573/8908) （推荐，目前提供多个语言版本），或直接调用云API（较为麻烦，建议SDK语言之外的用户使用）使用KMS的服务：
