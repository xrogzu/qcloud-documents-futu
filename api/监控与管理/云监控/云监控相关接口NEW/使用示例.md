...
查询云服务器指标dimensions.n.name固定为instanceId，dimensions.n.value的取值是调用<a href=http://tcecqpoc.fsphere.cn/document/product/213/831>查看实例列表</a>(DescribeInstances)接口查询得到的。
