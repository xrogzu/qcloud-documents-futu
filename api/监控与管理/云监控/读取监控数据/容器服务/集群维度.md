...
| 英文               | 中文含义                                     |
| ---------------- | ---------------------------------------- |
| docker_clusterid | 请填写[查询集群列表](http://tcecqpoc.fsphere.cn/document/api/457/9448)接口中返回的clusterId(集群的Id)字段 |
...
| dimensions.0.value | 是    | String   | 具体的集群ID          | 输入具体docker_clusterid                     |
