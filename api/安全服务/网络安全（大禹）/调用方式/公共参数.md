...
</td><td> 由云平台上申请的标识身份的 SecretId 和 SecretKey, 其中 SecretKey 会用来生成 Signature<br>具体参考 <a href="/doc/api/361/接口鉴权" title="接口鉴权">接口鉴权</a> 页面
</td><td> 是
</td></tr>
<tr>
<td> Signature
...
一个典型的接口请求如下, Action = RefreshDayuUrl 表示刷新 Url。
