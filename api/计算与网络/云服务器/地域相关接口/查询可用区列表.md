...
注：本接口为改版后的API接口。如需了解旧接口相关信息，请参考：[查询可用区](https://tce.fsphere.cn/document/api/213/1286)。
...
详见[公共错误码](https://tce.fsphere.cn/document/api/213/10146)。
...
<pre>
https://cvm.api.tce.fsphere.cn/v2/index.php?Action=DescribeZones
&Version=2017-03-12
&Region=ap-guangzhou
