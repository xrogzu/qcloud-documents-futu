...
注：本页展示的是改版后接口的错误码。如需查看旧接口对应的错误码，请参考[公共错误码](http://tcecqpoc.fsphere.cn/document/api/213/6982)信息。
...
</td><td> 身份认证失败，一般是由于签名计算错误导致的，请参考文档中<a href="http://tcecqpoc.fsphere.cn/document/api/213/6984" title="签名方法">签名方法</a>部分。
</td></tr>
<tr>
<td> AuthFailure
</td><td> 未授权访问接口
