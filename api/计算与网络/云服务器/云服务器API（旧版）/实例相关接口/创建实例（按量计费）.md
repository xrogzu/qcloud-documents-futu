...
| bandwidthType| 否| String|带宽的类型。`PayByHour`：按带宽使用时长计费；PayByTraffic：按流量计费。 默认为按使用时长计费。网络计费模式的区别可以参看[购买网络带宽](http://tcecqpoc.fsphere.cn/doc/product/213/509)。|
...
| needSecurityAgent| 否| Int|开启[云安全服务](http://tcecqpoc.fsphere.cn/doc/product/296/2222)。0：不开通，1：开通。默认开通。|
| needMonitorAgent| 否| Int|开启[云监控服务](http://tcecqpoc.fsphere.cn/doc/product/248/967)。0：不开通，1：开通。默认开通。|
...
<pre>
  http://cvm.api.qcloud.com/v2/index.php?Action=RunInstancesHour
