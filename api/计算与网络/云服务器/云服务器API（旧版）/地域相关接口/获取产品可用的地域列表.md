...
* 可以直接查看产品文档中的[地域一节](http://tce.fsphere.cn/doc/product/213/497#1.-.E5.9C.B0.E5.9F.9F)来了解地域属性在产品中扮演的角色。
* 除了地域的限制，CVM 产品还有购买数量上的限制。详情请参考[CVM实例购买限制](http://tce.fsphere.cn/doc/product/213/2664)。
