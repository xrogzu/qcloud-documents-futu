...
签名信息由安全凭证生成，安全凭证包括 SecretId 和 SecretKey；若你还没有安全凭证，请前往[云API密钥页面](http://console.tcecqpoc.fsphere.cn/capi)申请，否则无法调用云API接口。

## 1. 申请安全凭证
在第一次使用云API之前，请前往[云API密钥页面](http://console.tcecqpoc.fsphere.cn/capi)申请安全凭证。
...
1) 登录[云管理中心控制台](http://console.tcecqpoc.fsphere.cn/)。

2) 前往[云API密钥](http://console.tcecqpoc.fsphere.cn/capi)的控制台页面
![](http://imgcache.tcecqpoc.fsphere.cn/image/mccdn.qcloud.com/img568f5fb824757.png)

3) 在[云API密钥](http://console.tcecqpoc.fsphere.cn/capi)页面，点击【新建】即可以创建一对SecretId/SecretKey
