...
/*DescribeInstances 接口的 URL地址为 cvm.api.tce.fsphere.cn，可从对应的接口说明 “1.接口描述” 章节获取该接口的地址*/
$HttpUrl="cvm.api.tce.fsphere.cn";
...
/*需要填写你的密钥，可从  https://console.tce.fsphere.cn/capi 获取 SecretId 及 $secretKey*/
...
function CreateRequest($HttpUrl,$HttpMethod,$COMMON_PARAMS,$secretKey, $PRIVATE_PARAMS, $isHttps)
{
     ...
     * GETcvm.api.tce.fsphere.cn/v2/index.php?Action=DescribeInstances&Nonce=345122&Region=gz
