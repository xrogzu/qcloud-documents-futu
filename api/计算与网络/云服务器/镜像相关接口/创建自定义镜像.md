...
| InstanceId |  String |是 | 用于制作镜像的实例ID 。实例ID可以通过以下方式获取:<br><li>通过[DescribeInstances](/document/api/213/9388)接口返回的`InstanceId`获取。<br><li>通过[实例控制台](https://console.tce.fsphere.cn/cvm/index)获取。
...
请求参数
<pre>
https://image.api.tce.fsphere.cn/v2/index.php?Action=CreateImage
&Version=2017-03-12
