...
2. 云硬盘必须处于非挂载状态，且状态为`normal`。云硬盘挂载状态可以通过[DescribeCbsStorages（查询云硬盘信息）](/doc/api/364/2519)接口查询，见输出参数中`storageStatus`、`attached`字段解释。<br>
3. 云主机已挂载弹性云盘数量可以通过[DescribeInstancesCbsNum（查询云主机已挂载弹性云盘数量）](/doc/api/364/2528)接口查询，见输出参数中`maxAttachNum`、`count`字段解释。
...
| detail | Array[object] | 详见[批量异步任务接口返回格式](/doc/api/364/%E5%BC%82%E6%AD%A5%E4%BB%BB%E5%8A%A1%E6%8E%A5%E5%8F%A3%E8%BF%94%E5%9B%9E%E6%A0%BC%E5%BC%8F) |
