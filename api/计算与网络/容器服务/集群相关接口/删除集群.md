...
|nodeDeleteMode|  集群节点删除方式，<br>RemoveOnly（仅移除）<br>Return（退还）<br> | String|否|
...
| message | 模块错误信息描述，与接口相关。详见 [错误返回结果](/document/api/457/9469)|String | 
| requestId| 任务 ID | Int |

## 4. 示例
输入
```
  http://domain/v2/index.php?Action=DeleteCluster
