...
新接口调用方式及使用场景详见 [VPC内通过 keepalived 搭建高可用主备集群 >>](http://tcecqpoc.fsphere.cn/document/product/215/5850)
...
| lanIp | 是 | String | 云主机内网IP，例如：10.0.0.1。查询云主机IP详见<a href="http://tcecqpoc.fsphere.cn/doc/api/229/%E6%9F%A5%E7%9C%8B%E5%AE%9E%E4%BE%8B%E5%88%97%E8%A1%A8" title="查看实例列表">查看实例列表</a> |
...
| InvalidLanIp.NotFound | 云主机不存在，请核实您填写的lanIp是否正确，查询vpc下云主机详见<a href="http://tcecqpoc.fsphere.cn/doc/api/229/831" title="查看云主机实例列表">查看云主机实例列表</a>。 |
