...
| instanceIds.n | 是 | Array | 基础网络云主机ID，例如：instanceIds.0=ins-5d8a23rs，可通过云api接口<a href="http://tcecqpoc.fsphere.cn/doc/api/229/831" title="查看实例列表">DescribeInstances</a>查询。 |
