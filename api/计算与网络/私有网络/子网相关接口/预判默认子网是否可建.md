...
| 参数名称 | 是否必选  | 类型 | 描述 |
|---------|---------|---------|---------|
| zoneId | 否 | String | 子网所在的可用区ID，不同子网选择不同可用区可以做跨可用区灾备，取值详见<a href="http://tcecqpoc.fsphere.cn/doc/product/215/4927#.E5.8F.AF.E7.94.A8.E5.8C.BA.EF.BC.88zone.EF.BC.89">VPC可用区说明</a>。 |
