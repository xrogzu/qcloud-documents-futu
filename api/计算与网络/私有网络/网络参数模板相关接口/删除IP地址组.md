...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| code | Int | 数字错误码, 0表示成功，其他值表示失败。详见错误码页面的<a href='http://tcecqpoc.fsphere.cn/document/api/215/4781' title='公共错误码'>公共错误码</a>。|
...
输入
<pre>
http://vpc.api.qcloud.com/v2/index.php?Action=DeleteAddressGroup
