...
以下请求参数列表仅列出了接口请求参数，正式调用时需要加上公共请求参数，见 <a href="/doc/api/372/4153" title="公共请求参数">公共请求参数</a> 页面。其中，此接口的 Action 字段为 ModifyAddressGroupAttribute。
...
输入
<pre>
https://vpc.api.qcloud.com/v2/index.php?Action=ModifyAddressGroupAttribute
