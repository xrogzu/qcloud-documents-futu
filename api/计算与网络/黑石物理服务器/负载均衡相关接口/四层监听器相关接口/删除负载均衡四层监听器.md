...
DeleteBmListeners 提供了删除黑石负载均衡四层监听器功能。
...
### 请求示例
```
GET http://bmlb.api.qcloud.com/v2/index.php?Action=DeleteBmListeners
	&<公共请求参数>
	&loadBalancerId=<负载均衡实例ID>
	&listenerIds.0=<四层监听器ID>
```
...
| listenerIds.n | 是 | Array | 负载均衡四层监听器ID列表，可通过接口[DescribeBmListeners](/document/product/386/9296)查询。|
