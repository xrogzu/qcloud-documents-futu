...
```
GET http://bmlb.api.qcloud.com/v2/index.php?Action=UploadBmCert
	&<公共请求参数>
	&certType=<证书类型>
	&cert=<证书内容>
	&key=<私钥内容>
...
以下请求参数列表仅列出了接口请求参数，正式调用时需要加上公共请求参数，见[公共请求参数页面](/document/product/386/6718)。其中，此接口的Action字段为 UploadBmCert。
