...
本接口 (RewindQueue)用于消息回溯功能，具体功能参见[消息回溯功能](/document/product/406/8129)。
...
| startConsumeTime| 是| Unix时间戳| 设定该时间，则（Batch）receiveMessage接口，会按照生产消息的先后顺序消费该时间戳以后的消息。|
...
<pre>
 http://domain/v2/index.php?Action=RewindQueue
