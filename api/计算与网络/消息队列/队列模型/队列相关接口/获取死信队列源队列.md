...
本接口 (ListDeadLetterSourceQueues) 用于用户获取死信队列的源队列列表。
...
| 参数名称 | 是否必选  | 类型 | 描述 |
|---------|---------|---------|---------|
| deadLetterQueueName| 是| String| 死信队列名称。|
...
<pre>
 https://domain/v2/index.php?Action=ListDeadLetterSourceQueues
 &deadLetterQueueName=test-queue-123
