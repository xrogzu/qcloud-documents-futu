...
CMQ支持客户端使用SHA1和SHA256两种签名方式，用户可以通过参数 SignatureMethod 指定签名方法，如果该参数值为HmacSHA256则使用SHA256签名。 若该参数不传，或者值不等于HmacSHA256则统一使用SHA1计算签名。
...
```
Action=DescribeInstances&Nonce=11886&Region=gz&SecretId=AKIDz8krbsJ5yKBZQpn74WFkmLPx3gnPhESA&SignatureMethod=HmacSHA1&Timestamp=1465185768&instanceIds.0=ins-09dx96dg&limit=20&offset=0
```
...
```
GETcvm.api.qcloud.com/v2/index.php?Action=DescribeInstances&Nonce=11886&Region=gz&SecretId=AKIDz8krbsJ5yKBZQpn74WFkmLPx3gnPhESA&SignatureMethod=HmacSHA1&Timestamp=1465185768&instanceIds.0=ins-09dx96dg&limit=20&offset=0
```
...
```
$secretKey = 'Gu5t9xGARNpq86cd98joQYCN3Cozk1qA';
$srcStr = 'GETcvm.api.qcloud.com/v2/index.php?Action=DescribeInstances&Nonce=11886&Region=gz&SecretId=AKIDz8krbsJ5yKBZQpn74WFkmLPx3gnPhESA&SignatureMethod=HmacSHA1&Timestamp=1465185768&instanceIds.0=ins-09dx96dg&limit=20&offset=0';
