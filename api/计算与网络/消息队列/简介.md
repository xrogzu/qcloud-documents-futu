...
请确保在使用这些接口前，已充分了解了[CMQ产品说明](/doc/product/406)。
...
用户可以通过[CMQ SDK](/product/cmq#sdk) （推荐，目前提供多个语言版本），或直接调用云API（较为麻烦，建议SDK语言之外的用户使用）使用CMQ的服务：
