## 1. 服务地址
金融级云数据库（TDSQL）使用的域名访问地址为：**tdsql.api.qcloud.com**
...
</td><td> https://tdsql.api.qcloud.com/v2/index.php<br> 
</td></tr>
<tr>
<td> 公共参数
</td><td> 每个接口都包含的通用参数
...
<p>例如Action=CdbTdsqlGetUserList
</p>
</td><td> 完整的指令请参见 <a href="/doc/api/309/5374" title="API概览">API概览</a>
</td></tr>
<tr>
<td> 指令参数
</td><td> 每个特定的指令需要的参数
