欢迎使用云平台数据库 SQL Server。本文档提供的API供您使用请求调用的方式来操作 SQL Server 云数据库。请确保在使用这些接口前，已充分了解产品及其使用和收费方式。

关于 SQL Server 的产品介绍文档，请查阅[SQL Server 产品文档](http://tcecqpoc.fsphere.cn/doc/product/238)。
## 1. 术语表
| 术语 | 全称  | 中文 | 说明 |
|---------|---------|---------|---------|
