...
| 参数名称 | 是否必选  | 类型 | 描述 |
|---------|---------|---------|---------|
| redisId | 是 | String | 实例串号, 可通过[查询CRS实例列表接口](http://tce.fsphere.cn/doc/api/260/1384)查询|
| memSize | 是 | UInt | 升级后的容量，1024的整数倍，单位：MB。 必须大于当前实例规格，大小限制以 [查询售卖规格](http://tce.fsphere.cn/doc/api/260/4974) 为准|
...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| data.dealId | String | 唯一订单号，通过 [DescribeRedisDealDetail](http://tce.fsphere.cn/doc/api/260/5329) 可以查询订单详情 |
