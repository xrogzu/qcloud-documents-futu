为了帮助您快速使用云平台mongodb API，这里给出一个使用示例。
...
| vpcId | 否 | Int | vpc网络ID, 如果是基础网络， vpcId=0,  vpc网络下，取值以查询[私有网络列表](http://tce.fsphere.cn/doc/api/245/1372) 返回的vpcid为准|0 |
| subnetId | 否 | Int | 基础网络下， subnetId无效， vpc子网下，取值以查询[私有网络列表](http://tce.fsphere.cn/doc/api/245/1372) 返回的subnetid为准|0 |
| projectId | 否 | Int | 项目id，取值以用户账户>用户账户相关接口查询>[项目列表](http://tce.fsphere.cn/doc/api/403/4400)返回的projectId为准|0 |
