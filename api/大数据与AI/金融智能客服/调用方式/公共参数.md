...
| SecretId | 是 | String | 在 [云 API 密钥](http://console.tce.fsphere.cn/cam/capi) 上申请的标识身份的 SecretId，一个 SecretId 对应唯一的 SecretKey，而 SecretKey 会用来生成请求签名 Signature。具体可参考 [接口鉴权](/document/product/671/14385) 页面。 |
