...
签名信息由安全凭证生成，安全凭证包括 SecretId 和 SecretKey；若你还没有安全凭证，请前往 [云 API 密钥页面](http://console.tcecqpoc.fsphere.cn/cam/capi) 申请，否则无法调用云 API 接口。

## 申请安全凭证
在第一次使用云 API 之前，请前往 [云 API 密钥页面](http://console.tcecqpoc.fsphere.cn/cam/capi) 申请安全凭证。
...
申请安全凭证的具体步骤如下：
1、登录 [云平台管理中心控制台](http://tcecqpoc.fsphere.cn/login?s_url=https%3A%2F%2Fconsole.tce.fsphere.c%2F)
2、前往 [云 API 密钥](http://console.tcecqpoc.fsphere.cn/cam/capi) 的控制台页面
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/faaa1169e1851df12df81186f30a67b0/image.png)

3、在 [云 API 密钥](http://console.tcecqpoc.fsphere.cn/cam/capi) 页面，点击【新建】即可创建一对 SecretId/SecretKey
> 注意：
