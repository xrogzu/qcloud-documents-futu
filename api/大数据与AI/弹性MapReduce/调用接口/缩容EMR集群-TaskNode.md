...
本接口(EmrDestroyTaskNode)用于下线EMR集群中的指定TaskNode。

接口请求域名：<font style="color:red">emr.api.qcloud.com</font>

1) 用户指定下线一个或多个TaskNode
2) TaskNode下线后，部署在被下线TaskNode上的软件会被删除，节点从对应的软件集群中下线
...
输入
<pre>
  http://emr.api.qcloud.com/v2/index.php?Action=EmrDestroyTaskNode
