...
以[云服务器-查看实例列表](/doc/api/229/查看实例列表 )(DescribeInstances)请求为例，当用户调用这一接口时，其请求参数可能如下:
...
**注意：调用机器翻译服务接口时，请求携带的参数与上表有所插件，但生成签名串的方法是相同的！**
...
```
GET cvm.api.qcloud.com/v2/index.php?Action=DescribeInstances&Nonce=11886&Region=gz&SecretId=AKIDz8krbsJ5yKBZQpn74WFkmLPx3gnPhESA&Timestamp=1465185768&instanceIds.0=ins-09dx96dg&limit=20&offset=0
```
