...
腾讯机器翻译服务使用的域名访问地址为：tmt.api.qcloud.com。
...
</td><td> https://tmt.api.qcloud.com/v2/index.php<br> 
</td></tr>
<tr>
<td> 公共参数
</td><td> 每个接口都包含的通用参数
</td><td> 详见<a href="/document/product/551/7384" title="公共参数">公共参数</a>页面
</td></tr>
<tr>
<td> 指令名称
</td><td> API要执行的指令的名称，这里使用Action指定，<br>
<p>例如Action=TextTranslate
</p>
</td><td> 完整的指令列表请参见<a href="/document/product/551/7377" title="API概览">API概览</a>
</td></tr>
<tr>
<td> 指令参数
</td><td> 每个特定的指令需要的参数
