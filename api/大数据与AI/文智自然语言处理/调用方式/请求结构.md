...
云平台文智服务使用的域名访问地址为：wenzhi.api.qcloud.com。
...
</td><td> http://wenzhi.api.qcloud.com/v2/index.php<br> 
</td></tr>
<tr>
<td> 公共参数
</td><td> 每个接口都包含的通用参数
</td><td> 详见 <a href="http://tcecqpoc.fsphere.cn/document/product/271/2054" title="公共参数">公共参数</a> 页面
</td></tr>
<tr>
<td> 指令名称
...
</td><td> 完整的指令请参见 <a href="http://tcecqpoc.fsphere.cn/document/product/271/2050" title="API概览">API概览</a>
</td></tr>
<tr>
<td> 指令参数
</td><td> 每个特定的指令需要的参数
