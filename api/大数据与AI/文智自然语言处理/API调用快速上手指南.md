...
### 2.1 通信协议和规则
  ...
  详见[《云平台通信协议和规则》](http://tcecqpoc.fsphere.cn/doc/api/307/%E8%AF%B7%E6%B1%82%E7%BB%93%E6%9E%84)
...
<table style="width:771px">
	<tbody>
		...
		<tr>
			...
			<td style="text-align: center; width: 75px;">String</td>
			<td style="text-align: center; width: 509px;">区域参数，用来标识希望操作哪个区域的实例。可选: gz:广州; sh:上海;hk:香港;等部分云产品并非每个区域都有提供, 获取产品对应的地域列表可以使用<a href="http://tcecqpoc.fsphere.cn/wiki/v2/DescribeProductRegionList" target="_blank">/v2/DescribeProductRegionList</a></td>
			<td style="text-align: center; width: 76px;">是</td>
		</tr>
		<tr>
		...
		<tr>
			...
			具体参考<a href="http://tcecqpoc.fsphere.cn/wiki/%E6%8E%A5%E5%8F%A3%E9%89%B4%E6%9D%83" target="_blank">接口鉴权</a>页面</td>
			<td style="text-align: center; width: 76px;">是</td>
		</tr>
		<tr>
  ...
  公共参数详见[《云平台公共参数》](http://tcecqpoc.fsphere.cn/wiki/%E5%85%AC%E5%85%B1%E5%8F%82%E6%95%B0)
	
### 2.3 接口鉴权

接口鉴权方法详见[《接口鉴权》](http://tcecqpoc.fsphere.cn/doc/api/307/%E6%8E%A5%E5%8F%A3%E9%89%B4%E6%9D%83)
>注意：在生成签名的过程中，需要将加密字符串中包含的“_”改写成“.”，从而加密产生签名。

### 2.4 异步任务接口返回格式

  详见[《云平台异步任务接口返回格式》](http://tcecqpoc.fsphere.cn/doc/api/307/%E5%BC%82%E6%AD%A5%E4%BB%BB%E5%8A%A1%E6%8E%A5%E5%8F%A3%E8%BF%94%E5%9B%9E%E6%A0%BC%E5%BC%8F)
	
### 2.5 错误码

  详见[《调用方式-返回值-错误码》](http://tcecqpoc.fsphere.cn/doc/api/307/%E9%94%99%E8%AF%AF%E7%A0%81)
...
- [从 github 获取最新版本SDK >> ](http://github.com/QcloudApi/qcloudapi-sdk-php)（推荐）
- [点击此处下载 SDK >>](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/archive/cd1857b4d9a9aeb0179e72a59f235c41/qcloudapi-sdk-php-master.zip)
...
$a = $wenzhi->TextSentiment($package); 
  ...
  http://tcecqpoc.fsphere.cn/wiki/v2/API
