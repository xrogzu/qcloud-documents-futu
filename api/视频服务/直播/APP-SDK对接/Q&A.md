...
![live_video_protocol](http://imgcache.tcecqpoc.fsphere.cn/image/qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/live_video_protocol.jpg)
...
![vod_video_protocol](http://imgcache.tcecqpoc.fsphere.cn/image/qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/vod_video_protocol.jpg)
...
![tx_live_service_lag](http://imgcache.tcecqpoc.fsphere.cn/image/qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/tx_live_service_lag.jpg)
...
>
>如果VLC播放器或者FLASH播放器播放正常，但是云平台的[终端DEMO](/doc/product/267/4821)播放不正常，那么就说明播放端兼容性做的不好，可以把问题反馈给我们。
>
...
>
>您可以打开我们的[终端DEMO](/doc/product/267/4821)，扫描您的推流地址测试推流，这个时候记得打开log面板，然后观察**SPD**（网络上行速度） 和 **VBR**（视频码率，即视频编码器每秒产生多少视频数据）
...
>
- **5. 检查推流端**：
>目前最流行的推流软件是[OBS](http://obsproject.com/)，您可以用OBS推流看看是否有异常，不过目前为止还没有遇到多少推流端数据有问题的案例，因为目前推流SDK的所有协议都遵循了标准定义。相比之下，倒是下面两个问题非常常见：
>
>**重复推流**
...
![](http://imgcache.tcecqpoc.fsphere.cn/image/mccdn.qcloud.com/static/img/3d507395719b716d6efd379f7022d862/image.png)
