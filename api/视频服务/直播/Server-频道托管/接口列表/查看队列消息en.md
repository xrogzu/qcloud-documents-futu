...
The screenshot files are stored on COS for long-term storage. You need to activate the service before you can use this feature, and you will be charged a fee (for the storage and etc.) based on the billing mode for COS. See the [Relevant Document](http://tcecqpoc.fsphere.cn/product/cos.html) for details.
...
Input 1
<pre>
http://domain/v2/index.php?Action=DescribeQueueLog&bid=100&count=5&<a href="http://tcecqpoc.fsphere.cn/doc/api/229/6976">Public Request Parameters</a>
...
For details on the access method, refer to the COS [Relevant Documents](http://tcecqpoc.fsphere.cn/document/product/430).
