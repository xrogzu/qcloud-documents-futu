...
- **方案一：消息通知**
您可以使用云平台的**[事件通知服务](http://tcecqpoc.fsphere.cn/doc/api/258/5957)**：您的服务器注册一个自己的**回调URL**给云平台，云平台会在一个新的录制文件生成时通过这个URL通知给您。
...
- [Android平台参考文档](http://tcecqpoc.fsphere.cn/doc/api/258/4739)
- [Web平台参考文档](http://tcecqpoc.fsphere.cn/doc/api/258/5706)
