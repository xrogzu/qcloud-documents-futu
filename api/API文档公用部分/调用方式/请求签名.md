...
## 申请安全凭证
在第一次使用云平台 API 之前，用户需要在【云平台控制台】> 【[API 密钥管理](http://console.tcecqpoc.fsphere.cn/cam/capi) 】上申请安全凭证。安全凭证包括 SecretId 和 SecretKey，其中：
...
![](http://imgcache.tcecqpoc.fsphere.cn/image/mc.qcloudimg.com/static/img/3a3a616ba175bb95be68123d86715e77/image.png)
...
以云平台 CVM 为例，当用户调用云平台 CVM 的 [查看实例列表](/document/product/213/9388) (DescribeInstances)接口时，其请求参数为：
...
| 4101 | 未被开发商授权访问本接口 | 该子用户未被授权调用此接口。请联系开发商授权，详情请查阅 [授权策略](/document/product/598/10601)。|
| 4102 | 未被开发商授权访问本接口中所操作的资源 | 请问的资源参数中，存在未被开发商授权授权访问的资源，请在 message 字段中查看无权查看的资源 ID。</br>请联系开发商授权，详情请查阅 [授权策略](/document/product/598/10601)。|
