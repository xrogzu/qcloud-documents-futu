...
## 2. 输入参数
以下请求参数列表仅列出了接口请求参数，正式调用时需要加上公共请求参数，见[公共请求参数](/doc/api/231/4473)页面。其中，此接口的Action字段为GetCdnOverseaPv。
...
| app_id         | String | 云平台服务账号[点击查看](http://console.tcecqpoc.fsphere.cn/cloudAccount)，与UIN对应 |
| host           | String | 指定查询的域名                                  |
