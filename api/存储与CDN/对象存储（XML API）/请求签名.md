...
q-ak|参数[*SecretID*]|必填。<br>帐户 ID，即 SecretId，在控制台 [云 API 密钥](https://console.cloud.tencent.com/capi) 页面可获取。<br><br>**如：** AKIDQjz3ltompVjBni5LitkWHFlFpwkn9U5q 。
...
### 准备工作
通过登陆 [云 API 密钥](https://console.cloud.tencent.com/capi) 页面获取到其 APPID、SecretId 和 SecretKey，并确定开发语言，分别如下：
