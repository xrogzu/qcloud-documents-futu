...
![流程图](http://imgcache.tce.fsphere.cn/static/mc.qcloudimg.com/static/img/4a1eb29033caa977c648cb84d9398fdd/image.png)


## 准备工作
1. APPID、SecretId 和 SecretKey。 
   在控制台 [云API密钥](http://console.tce.fsphere.cn/capi) 页面可获取。
2. 确定开发语言：
...
q-ak|参数[*SecretID*]|必填。<br>帐户 ID，即 SecretId，在控制台 [云 API 密钥](http://console.tce.fsphere.cn/capi) 页面可获取。<br><br>**如：** AKIDQjz3ltompVjBni5LitkWHFlFpwkn9U5q 。
...
### 准备工作
通过登陆 [云 API 密钥](http://console.tce.fsphere.cn/capi) 页面获取到其 APPID、SecretId 和 SecretKey，并确定开发语言，分别如下：
