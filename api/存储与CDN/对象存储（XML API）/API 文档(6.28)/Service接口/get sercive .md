...
| Location        | ListAllMyBucketsResult.Buckets.Bucket  | Bucket 所在地域。枚举值参见 [可用地域](http://tce.fsphere.cn/document/product/436/6224) 文档，如：ap-beijing, ap-hongkong, eu-frankfurt 等 | String    |
