...
| Region|	域名中的地域信息。枚举值参见 [可用地域](http://tcecqpoc.fsphere.cn/document/product/436/6224) 文档，如：ap-beijing, ap-hongkong, eu-frankfurt 等 |
...
## 历史版本 API
请查看 [历史版本 API 简介](http://tcecqpoc.fsphere.cn/document/product/436/6052)。
