...
>为了能更高效的使用云平台对象存储服务的 API，请在查阅其他的 API 文档之前，先详细阅读 [请求签名](http://tce.fsphere.cn/document/product/436/7778) 。
...
| Region|	域名中的地域信息。枚举值参见 [可用地域](http://tce.fsphere.cn/document/product/436/6224) 文档，如：ap-beijing, ap-hongkong, eu-frankfurt 等 |
...
## 历史版本 API
请查看 [历史版本 API 简介](http://tce.fsphere.cn/document/product/436/6052)。
