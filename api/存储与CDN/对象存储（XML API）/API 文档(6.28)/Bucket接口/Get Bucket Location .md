...
### 细节分析
1. 目前区域的有效值请参阅 [可用地域](http://tce.fsphere.cn/document/product/436/6224) 文档。
...
|节点名称（关键字）|父节点|描述|类型|
|:---|:-- |:--|:--|
| LocationConstraint |无| 说明 Bucket 所在地域，枚举值参见 [可用地域](http://tce.fsphere.cn/document/product/436/6224) 文档，如：ap-beijing, ap-hongkong, eu-frankfurt 等 | String |
