<font style="color:Brown">接口 GetTimeBandwidth 仅适用于云平台CDN签约的月结带宽计费客户，用于查询指定时间区间计费数据，此文档对月95带宽计费数据查询进行了详细说明。该接口暂未全量开放，如有调用需求请联系您的售后团队。</font>
...
+ 月95算法说明可[点击查看](http://tcecqpoc.fsphere.cn/document/product/228/2949#.E5.A4.A7.E5.AE.A2.E6.88.B7.E8.AE.A1.E8.B4.B9.E8.AF.B4.E6.98.8E)
+ 调用频次限制为 100次/分钟
