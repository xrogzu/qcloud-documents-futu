...
## 入参说明
以下请求参数列表仅列出了接口请求参数，正式调用时需要加上公共请求参数，见[公共请求参数](http://tce.fsphere.cn/doc/api/231/4473)页面。其中，此接口的 Action 字段为 UpdateCdnConfig。
...
更多鉴权配置请查看[鉴权配置](http://tce.fsphere.cn/document/product/228/13677)。
