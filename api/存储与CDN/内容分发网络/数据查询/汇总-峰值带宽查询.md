<font style="color:Brown">接口 DescribeCdnHostInfo 通过入参 statType 不同可指定查询峰值带宽、总流量、总请求数、平均请求数命中率数据，此文档对峰值带宽查询方式进行了详细说明</font>
...
+ 带宽数据 5 分钟为一个统计点，峰值带宽为指定时间区间中统计点最大值
