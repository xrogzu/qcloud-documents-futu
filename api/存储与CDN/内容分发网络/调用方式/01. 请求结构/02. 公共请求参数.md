...
| SecretId  | String | 在 [云API密钥](http://console.tce.fsphere.cn/capi) 上申请的标识身份的 SecretId，一个 SecretId 对应唯一的 SecretKey , 而 SecretKey 会用来生成请求签名 Signature。具体可参考 [签名方法](http://tcecqpoc.fsphere.cn/doc/api/231/1725) 页面。 | 是    |
