...
云平台解析使用的域名访问地址为：cns.api.qcloud.com。
...
</td><td> 详见 <a href="/doc/api/262/公共参数" title="公共参数">公共参数</a> 页面
</td></tr>
<tr>
<td> 指令名称
</td><td> API要执行的指令的名称，这里使用Action指定，<br>
<p>例如Action=DescribeDomains
</p>
</td><td> 完整的指令请参见 <a href="/doc/api/262/API概览" title="API概览">API概览</a>
</td></tr>
<tr>
<td> 指令参数
</td><td> 每个特定的指令需要的参数
